...
var RhythmEngine = (() => {
  ...
  var require_lunar = __commonJS({
    "engine/vendor/lunar.js"(exports, module) {
  ...
  // engine/paipan.js
  var require_paipan = __commonJS({
    "engine/paipan.js"(exports, module) {
      "use strict";
      var { Solar } = require_lunar();
      function equationOfTime(year, month, day) {
        const dayOfYear = Math.floor(
          (Date.UTC(year, month - 1, day) - Date.UTC(year, 0, 0)) / 864e5
        );
        const B = 2 * Math.PI * (dayOfYear - 81) / 364;
        return 9.87 * Math.sin(2 * B) - 7.53 * Math.cos(B) - 1.5 * Math.sin(B);
      }
      function trueSolarCorrection(year, month, day, longitude) {
        const lonCorr = (longitude - 120) * 4;
      ...
      function paipan(o) {
        ...
        let corr = 0;
        let totalMin = hourUnknown ? 12 * 60 : hour * 60 + minute;
        if (trueSolar && !hourUnknown) {
          corr = trueSolarCorrection(year, month, day, longitude);
          totalMin += corr;
        }
        const base = new Date(Date.UTC(year, month - 1, day, 0, 0, 0));
        const shifted = new Date(base.getTime() + Math.round(totalMin) * 6e4);
        ...
        const gans4 = [ec.getYearGan(), ec.getMonthGan(), ec.getDayGan(), ec.getTimeGan()];
        const zhis4 = [ec.getYearZhi(), ec.getMonthZhi(), ec.getDayZhi(), ec.getTimeZhi()];
        const gans = hourUnknown ? gans4.slice(0, 3) : gans4;
        const zhis = hourUnknown ? zhis4.slice(0, 3) : zhis4;
        return {
          input: o,
          hourUnknown,
          correctionMin: Math.round(corr * 10) / 10,
          trueSolarClock: hourUnknown ? "\u672A\u77E5" : `${String(th).padStart(2, "0")}:${String(tmin).padStart(2, "0")}`,
          lunarText: lunar.toString(),
          pillars: {
            year: ec.getYear(),
            month: ec.getMonth(),
            day: ec.getDay(),
            time: hourUnknown ? null : ec.getTime()
          },
          gans,
          zhis,
          dayGan: ec.getDayGan(),
      ...
      module.exports = { paipan, equationOfTime, trueSolarCorrection };
    }
  });

  // engine/analyze.js
  var require_analyze = __commonJS({
    "engine/analyze.js"(exports, module) {
      "use strict";
      var GAN_WX = { \u7532: "\u6728", \u4E59: "\u6728", \u4E19: "\u706B", \u4E01: "\u706B", \u620A: "\u571F", \u5DF1: "\u571F", \u5E9A: "\u91D1", \u8F9B: "\u91D1", \u58EC: "\u6C34", \u7678: "\u6C34" };
      var GAN_YIN = { \u7532: 1, \u4E19: 1, \u620A: 1, \u5E9A: 1, \u58EC: 1, \u4E59: 0, \u4E01: 0, \u5DF1: 0, \u8F9B: 0, \u7678: 0 };
      ...
      var ME_SHENG = { \u6728: "\u706B", \u706B: "\u571F", \u571F: "\u91D1", \u91D1: "\u6C34", \u6C34: "\u6728" };
      ...
      var WX_COLOR = {
        \u6728: { name: "\u7EFF\u8272", hex: "#6E8F73" },
        \u706B: { name: "\u7EA2\u8272", hex: "#B5715F" },
        \u571F: { name: "\u9EC4\u8272", hex: "#C0A06A" },
        \u91D1: { name: "\u767D\u8272", hex: "#D7D4CB" },
        \u6C34: { name: "\u84DD\u8272", hex: "#5B6B7A" }
      };
      var WX_ALL = ["\u6728", "\u706B", "\u571F", "\u91D1", "\u6C34"];
      var STR_CENTER = 0.8;
      var STR_SPAN = 3.5;
      function strengthToT(score) {
        return Math.max(-1, Math.min(1, (score - STR_CENTER) / STR_SPAN));
      }
      var FUYI_STRONG = { \u6BD4: -1, \u5370: -0.8, \u98DF: 0.7, \u8D22: 1, \u5B98: 0.4 };
      var FUYI_WEAK = { \u6BD4: 0.9, \u5370: 1, \u98DF: -0.7, \u8D22: -0.9, \u5B98: -1 };
      function fuyiFav(god, t) {
        return t >= 0 ? (FUYI_STRONG[god] ?? 0) * t : (FUYI_WEAK[god] ?? 0) * -t;
      }
      var WINTER_SEV = { \u4EA5: 0.7, \u5B50: 1, \u4E11: 0.6 };
      var SUMMER_SEV = { \u5DF3: 0.7, \u5348: 1, \u672A: 0.6 };
      ...
      var XI_TH = 0.12;
      var JI_TH = -0.12;
      function deriveFromFav(fav) {
        const sorted = WX_ALL.slice().sort((a, b) => fav[b] - fav[a]);
        const xiYong = sorted.filter((wx) => fav[wx] >= XI_TH);
        const jiShen = WX_ALL.filter((wx) => fav[wx] <= JI_TH);
        const xiYongWeight = {};
        xiYong.forEach((wx) => {
          xiYongWeight[wx] = Math.max(0.2, Math.min(1, fav[wx]));
        });
        return { xiYong, jiShen, xiYongWeight, primaryXi: xiYong[0] || sorted[0] };
      }
      function analyze(chart) {
        ...
        const dryNote = isDry ? "\u5C40\u71E5\u65E0\u6E7F\u571F\uFF0C\u71E5\u571F\u751F\u91D1/\u6666\u706B\u4E4F\u529B\uFF0C\u571F\u4F5C\u95F2\u795E\u4E0D\u53D6" : "";
        return {
          ...
          // 连续喜用向量:五行→[-1,1],单一真相源
          xiYong,
          xiYongWeight: xiWeight,
          jiShen,
          tiaohouNote,
          tiaohouGod,
          tiaohouWx,
          xiColor: WX_COLOR[primaryXi],
          primaryXi,
          summary: buildSummary({ dayGan, dayWx, monthZhi, season, strength, xiYong, jiShen, tiaohouNote })
        };
      }
      function fuyiXiYong(strength, dayWx) {
        const isStrong = strength === "\u8EAB\u5F3A" || strength === "\u504F\u5F3A";
        const isWeak = strength === "\u8EAB\u5F31" || strength === "\u504F\u5F31";
        const xiWeight = {};
        let xiYong = [], jiShen = [];
        const set = (pairs) => pairs.forEach(([wx, w]) => {
          if (wx && !(wx in xiWeight)) {
            xiYong.push(wx);
            xiWeight[wx] = w;
          }
        });
        if (isStrong) {
          set([[ME_KE[dayWx], 1], [ME_SHENG[dayWx], 0.7], [KE_ME[dayWx], 0.4]]);
          jiShen = [dayWx, SHENG_ME[dayWx]];
        } else if (isWeak) {
          set([[SHENG_ME[dayWx], 1], [dayWx, 0.9]]);
          jiShen = [ME_KE[dayWx], KE_ME[dayWx], ME_SHENG[dayWx]];
        } else {
          set([[ME_SHENG[dayWx], 0.8], [ME_KE[dayWx], 0.6]]);
          jiShen = [KE_ME[dayWx]];
        }
        jiShen = jiShen.filter((w) => !xiYong.includes(w));
      ...
      function dynamicXiYong(mj, chart, year) {
        const base = {
          xiYong: mj.xiYong,
          jiShen: mj.jiShen,
          xiYongWeight: mj.xiYongWeight,
          favVec: mj.favVec,
          primaryXi: mj.primaryXi,
        ...
        const shifted = polarity(dynStrength) !== polarity(bucketStrength(effBase));
        return {
          xiYong,
          jiShen,
          xiYongWeight,
          favVec: fav,
          primaryXi,
          strength: dynStrength,
          shifted,
          dynScore: Math.round((mj.strengthScore + delta) * 10) / 10,
          dy,
          t: Math.round(t * 100) / 100
        };
      }
      function dominantWx(gans, zhis, dayWx, types) {
        const tally = {};
        const add = (wx, w) => {
          const t = tenGodType(dayWx, wx);
          if (types.includes(t))
  ...
  var require_profile = __commonJS({
    "engine/profile.js"(exports, module) {
      "use strict";
      var A = require_analyze();
      var GAN_WX = { \u7532: "\u6728", \u4E59: "\u6728", \u4E19: "\u706B", \u4E01: "\u706B", \u620A: "\u571F", \u5DF1: "\u571F", \u5E9A: "\u91D1", \u8F9B: "\u91D1", \u58EC: "\u6C34", \u7678: "\u6C34" };
      var ZHI_WX = { \u5B50: "\u6C34", \u4E11: "\u571F", \u5BC5: "\u6728", \u536F: "\u6728", \u8FB0: "\u571F", \u5DF3: "\u706B", \u5348: "\u706B", \u672A: "\u571F", \u7533: "\u91D1", \u9149: "\u91D1", \u620C: "\u571F", \u4EA5: "\u6C34" };
      var SHENG_ME = { \u6728: "\u6C34", \u706B: "\u6728", \u571F: "\u706B", \u91D1: "\u571F", \u6C34: "\u91D1" };
      var WX5 = ["\u6728", "\u706B", "\u571F", "\u91D1", "\u6C34"];
      ...
      function balThreshold() {
        const o = typeof globalThis !== "undefined" && globalThis.__SHIHE_BAL || {};
        return { diff: o.diff ?? 5, top: o.top ?? 30 };
      }
      function expressiveOf(chart, dayWx, social, dominant, domJi) {
        const shiTouGan = (chart.gans || []).some((g, i) => i !== 2 && tenGodType(dayWx, GAN_WX[g]) === "\u98DF");
        const star = TAOHUA_STAR[(chart.zhis || [])[0]];
        const xianChi = (chart.zhis || []).filter((z) => z === star).length;
        const guanYa = dominant === "\u5B98" && !!domJi;
        return { expressive: (shiTouGan || social >= 52 || xianChi >= 1) && !guanYa, guanYa, xianChi, shiTouGan };
      }
      function personaSignals(mj, chart) {
        const dayGan = chart.dayGan;
        const dayWx = GAN_WX[dayGan];
        const pol = polarityOf(mj.strength);
        const season = mj.season;
        const daySuppressed = !!(mj.isYinHeavyWeak || mj.dayRootless && pol === "\u5F31");
        const w = mj.weights || {};
        ...
        const ex = expressiveOf(chart, dayWx, social, dominant, domJi);
        const yinWx = SHENG_ME[dayWx];
        const yinPctRaw = Math.round(Math.max(0, w[yinWx] || 0) / total * 100);
        const toneYin = (mj.xiYong || []).includes(yinWx) ? "\u987A" : (mj.jiShen || []).includes(yinWx) ? "\u614E" : "\u5E73";
        const yinStrongJi = toneYin === "\u614E" && (yinPctRaw >= 28 || tenGodType(dayWx, ZHI_WX[mj.monthZhi]) === "\u5370");
        const tStudy = yinStrongJi ? "\u5E73" : toneYin;
        const sb = mj.strength === "\u8EAB\u5F3A" || mj.strength === "\u504F\u5F3A" ? "S" : mj.strength === "\u8EAB\u5F31" || mj.strength === "\u504F\u5F31" || mj.strength === "\u4ECE\u5F31" ? "W" : "M";
        const sitStill = !mj.isYinHeavyWeak && (yinStrongJi || tStudy === "\u987A" && sb === "S" || tStudy === "\u5E73" && sb !== "W");
        const gender = chart.input && chart.input.gender || "";
        const KE_ME = { \u6728: "\u91D1", \u706B: "\u6C34", \u571F: "\u6728", \u91D1: "\u706B", \u6C34: "\u571F" }, ME_KE = { \u6728: "\u571F", \u706B: "\u91D1", \u571F: "\u6C34", \u91D1: "\u6728", \u6C34: "\u706B" };
        const ZHI_HIDE = { \u5B50: ["\u7678"], \u4E11: ["\u5DF1", "\u7678", "\u8F9B"], \u5BC5: ["\u7532", "\u4E19", "\u620A"], \u536F: ["\u4E59"], \u8FB0: ["\u620A", "\u4E59", "\u7678"], \u5DF3: ["\u4E19", "\u5E9A", "\u620A"], \u5348: ["\u4E01", "\u5DF1"], \u672A: ["\u5DF1", "\u4E01", "\u4E59"], \u7533: ["\u5E9A", "\u58EC", "\u620A"], \u9149: ["\u8F9B"], \u620C: ["\u620A", "\u8F9B", "\u4E01"], \u4EA5: ["\u58EC", "\u7532"] };
        let spouse = null;
        if (gender === "\u5973" || gender === "\u7537") {
          const starWx = gender === "\u5973" ? KE_ME[dayWx] : ME_KE[dayWx];
          const gans = chart.gans || [], zhis = chart.zhis || [];
          const touGan = gans.some((g, i) => i !== 2 && GAN_WX[g] === starWx);
          const zuoGong = GAN_WX[(ZHI_HIDE[zhis[2]] || [])[0]] === starWx;
          const cang = zhis.some((z) => (ZHI_HIDE[z] || []).some((g) => GAN_WX[g] === starWx));
          const state = touGan || zuoGong ? "\u663E" : cang ? "\u85CF" : "\u65E0";
          const v = (mj.favVec || {})[starWx] ?? 0;
          const fav = v >= 0.12 ? "\u559C" : v <= -0.12 ? "\u5FCC" : "\u5E73";
          spouse = { gender, starWx, state, fav };
        }
        return {
          dayGan,
          dayWx,
      ...
      module.exports = { personaSignals, expressiveOf, polarityOf, balThreshold, TAOHUA_STAR };
    }
  });
  ...
  var require_liuri = __commonJS({
    "engine/liuri.js"(exports, module) {
      "use strict";
      var { Solar } = require_lunar();
      var { isXing, ZHI_HARM, SAN_HE } = require_relations();
      ...
      var GAN_HE = { \u7532: "\u5DF1", \u5DF1: "\u7532", \u4E59: "\u5E9A", \u5E9A: "\u4E59", \u4E19: "\u8F9B", \u8F9B: "\u4E19", \u4E01: "\u58EC", \u58EC: "\u4E01", \u620A: "\u7678", \u7678: "\u620A" };
      var POLE_SIDE = { \u6BD4: "\u84C4", \u5370: "\u84C4", \u98DF: "\u51B3", \u8D22: "\u51B3", \u5B98: "\u51B3" };
      var THEME = {
        \u6BD4: { yi: ["\u534F\u4F5C\u7ED3\u4F34", "\u8FD0\u52A8\u5065\u8EAB", "\u51FA\u884C\u8D70\u52A8"], huan: ["\u5408\u4F19\u8D26\u76EE", "\u51B2\u52A8\u6D88\u8D39"] },
        \u5370: { yi: ["\u5B66\u4E60\u8FDB\u4FEE", "\u9759\u517B\u84C4\u529B", "\u529E\u6587\u4E66", "\u6C42\u52A9\u8D35\u4EBA"], huan: ["\u4E45\u62D6\u4E0D\u51B3", "\u8FC7\u5EA6\u5185\u8017"] },
        \u98DF: { yi: ["\u8868\u8FBE\u521B\u4F5C", "\u793E\u4EA4\u5206\u4EAB", "\u8C0B\u5212\u5E03\u5C40"], huan: ["\u8A00\u591A\u53E3\u89D2", "\u5206\u5FC3\u6563\u6F2B"] },
        \u8D22: { yi: ["\u63A8\u8FDB\u8981\u4E8B", "\u62D3\u5C55\u4EBA\u8109", "\u6D88\u8D39\u51B3\u7B56"], huan: ["\u51B2\u52A8\u6295\u8D44", "\u501F\u8D37\u62C5\u4FDD"] },
        \u5B98: { yi: ["\u505A\u51B3\u5B9A", "\u62C5\u8D23\u4EFB", "\u5B9A\u89C4\u77E9", "\u4E89\u53D6\u673A\u4F1A"], huan: ["\u6B63\u9762\u5BF9\u6297", "\u786C\u78B0\u786C"] }
      };
      var CUE = {
        \u8D22: {
        ...
        \u98DF: {
          favHi: { tag: "\u5C3D\u7BA1\u8BF4", kw: "\u7075\u601D\u8212\u5C55", line: "\u9002\u5408\u8868\u8FBE\u3001\u5C55\u793A\uFF0C\u4E5F\u9002\u5408\u52A8\u624B\u521B\u4F5C\u3002" },
          favLo: { tag: "\u5148\u6512\u7740", kw: "\u539A\u79EF\u8584\u53D1", line: "\u7075\u611F\u5148\u8BB0\u4E0B\u6765\uFF0C\u8349\u7A3F\u6253\u597D\u518D\u8BF4\u3002" },
          jiHi: { tag: "\u5C11\u63A5\u8BDD", kw: "\u8A00\u800C\u6709\u8282", line: "\u5BB9\u6613\u8BF4\u9519\u8BDD\uFF0C\u5C11\u8BF4\u591A\u542C\u3002" },
          jiLo: { tag: "\u7BA1\u4F4F\u5634", kw: "\u5B88\u53E3\u614E\u8A00", line: "\u5BB9\u6613\u8A00\u591A\u6709\u5931\uFF0C\u5C11\u53D1\u7262\u9A9A\u3002" }
        },
        \u6BD4: {
          favHi: { tag: "\u627E\u4EBA\u642D", kw: "\u643A\u624B\u540C\u884C", line: "\u9002\u5408\u7ED3\u4F34\u505A\u4E8B\uFF0C\u627E\u4EBA\u642D\u628A\u624B\u3002" },
          favLo: { tag: "\u5206\u7740\u625B", kw: "\u5B88\u671B\u76F8\u52A9", line: "\u4E00\u4E2A\u4EBA\u8D39\u52B2\uFF0C\u627E\u4FE1\u5F97\u8FC7\u7684\u4EBA\u642D\u624B\u3002" },
          jiHi: { tag: "\u8D26\u8BF4\u6E05", kw: "\u5766\u8BDA\u76F8\u5F85", line: "\u5408\u4F19\u7684\u8D26\u5BB9\u6613\u6709\u7EA0\u7EB7\uFF0C\u5148\u8BF4\u6E05\u3002" },
          jiLo: { tag: "\u5212\u6E05\u754C", kw: "\u4EB2\u758F\u6709\u5EA6", line: "\u5BB9\u6613\u66FF\u4EBA\u625B\u4E8B\u5403\u4E8F\uFF0C\u754C\u9650\u8BF4\u6E05\u3002" }
        }
      };
      var CUE_VOLATILE = { tag: "\u7A33\u4F4F\u70B9", kw: "\u5B88\u9759\u89C2\u53D8", line: "\u4E8B\u60C5\u5BB9\u6613\u53CD\u590D\uFF0C\u8981\u7D27\u7684\u4E8B\u5F80\u540E\u653E\u3002" };
      var CUE_HE = { tag: "\u804A\u5F97\u6765", kw: "\u6C34\u5230\u6E20\u6210", line: "\u8DDF\u4EBA\u5408\u5F97\u6765\uFF0C\u9002\u5408\u8C08\u4E8B\u3001\u6258\u4EBA\u529E\u4E8B\u3002" };
      var CUE_REST = { tag: "\u65E9\u70B9\u6B47", kw: "\u4F11\u517B\u751F\u606F", line: "\u9002\u5408\u6536\u5C3E\u3001\u6E05\u6742\u4E8B\uFF0C\u65E9\u70B9\u6B47\u3002" };
      var CUE_FLOW = { tag: "\u529E\u4E00\u4E24\u4EF6", kw: "\u5E73\u7A33\u6709\u5E8F", line: "\u5148\u529E\u8981\u7D27\u7684\u4E00\u4E24\u4EF6\uFF0C\u5176\u4F59\u987A\u624B\u5E26\u8FC7\u3002" };
      var DIM = {
        \u8D22: {
          label: "\u94B1\u8D22",
          fav: "\u9002\u5408\u8C08\u94B1\u3001\u63A8\u8FDB\u8981\u4E8B\u3002",
      ...
      var LOVE_POOL = {
        \u5211: {
          u: ["\u611F\u60C5\u7684\u4E8B\u5148\u5F80\u540E\u653E\uFF0C\u4E0D\u5FC5\u6025\u7740\u7406\u6E05\u3002", "\u4E0D\u4E89\u5BF9\u9519\uFF0C\u5148\u7F13\u4E00\u7F13\u3002"],
          s: ["\u611F\u60C5\u7684\u4E8B\u5148\u5F80\u540E\u653E\uFF0C\u4E0D\u5FC5\u6025\u7740\u7406\u6E05\u3002", "\u7F18\u5206\u672A\u5B9A\uFF0C\u4E0D\u5FC5\u5F3A\u6C42\u3002"],
          p: ["\u4E0D\u7FFB\u65E7\u8D26\uFF0C\u4E0D\u4E89\u5BF9\u9519\u3002", "\u5B9C\u5404\u81EA\u51B7\u9759\uFF0C\u4E0D\u8D77\u4E89\u6267\u3002"]
        },
        \u5BB3: {
          u: ["\u95F2\u8BDD\u4E0D\u4F20\u3001\u4E0D\u63A5\u3002", "\u542C\u6765\u7684\u8BDD\u672A\u5FC5\u5C5E\u5B9E\u3002"],
          s: ["\u542C\u6765\u7684\u8BDD\u672A\u5FC5\u5C5E\u5B9E\uFF0C\u4E0D\u5FC5\u5F53\u771F\u3002", "\u95F2\u8BDD\u4E0D\u4F20\u3001\u4E0D\u63A5\u3002"],
          p: ["\u95F2\u8BDD\u6311\u62E8\u4E0D\u5FC5\u7406\u4F1A\uFF0C\u591A\u4E9B\u4FE1\u4EFB\u3002", "\u5C0F\u8BEF\u4F1A\u4E0D\u5FC5\u653E\u5927\u3002"]
        },
        \u593A: {
          u: ["\u611F\u60C5\u7684\u4E8B\u5B9C\u5B88\uFF0C\u4E0D\u5FC5\u591A\u8BAE\u3002", "\u5B9C\u7A33\u4F4F\u5FC3\u795E\uFF0C\u4E0D\u53D7\u5916\u6270\u3002"],
          s: ["\u611F\u60C5\u7684\u4E8B\u5B9C\u4F4E\u8C03\uFF0C\u4E0D\u6025\u4E8E\u63A8\u8FDB\u3002", "\u611F\u60C5\u5B9C\u5B88\uFF0C\u4E0D\u5FC5\u5F3A\u6C42\u3002"],
          p: ["\u4E0D\u56E0\u5916\u4EBA\u7F6E\u6C14\uFF0C\u5BB6\u548C\u4E3A\u91CD\u3002", "\u5916\u9762\u7684\u4E8B\uFF0C\u4E0D\u5E26\u8FDB\u5BB6\u91CC\u3002"]
        },
        \u7F18\u6270: {
          u: ["\u4EBA\u7F18\u867D\u65FA\uFF0C\u662F\u975E\u4E5F\u591A\uFF0C\u5B9C\u81EA\u6301\u3002", "\u7F18\u5206\u6742\uFF0C\u4E0D\u8F7B\u4FE1\u3002"],
          s: ["\u65B0\u8BA4\u8BC6\u7684\u4EBA\u5B9C\u591A\u89C2\u5BDF\uFF0C\u4E0D\u6025\u7740\u8D70\u8FD1\u3002", "\u9047\u5230\u7684\u672A\u5FC5\u5408\u9002\uFF0C\u5B9C\u591A\u89C2\u5BDF\u3002"],
          p: ["\u65E0\u5173\u7684\u7F18\u5206\u5B9C\u4FDD\u6301\u8DDD\u79BB\u3002", "\u5B88\u597D\u73B0\u6709\u611F\u60C5\uFF0C\u4E0D\u8282\u5916\u751F\u679D\u3002"]
        },
        \u5F3A\u7F18: {
          u: ["\u6765\u5F97\u6025\u7684\u7F18\u5206\uFF0C\u5B9C\u5148\u770B\u6E05\u3002", "\u7F18\u5206\u6025\uFF0C\u5B9C\u7F13\u4E00\u6B65\u5E94\u5BF9\u3002"],
          s: ["\u6765\u5F97\u6025\u7684\u7F18\u5206\uFF0C\u5B9C\u5148\u770B\u6E05\u518D\u56DE\u5E94\u3002", "\u4E0D\u5FC5\u6025\u7740\u7B54\u590D\uFF0C\u770B\u6E05\u4E3A\u5148\u3002"],
          p: ["\u5916\u6765\u538B\u529B\u4E0D\u5E26\u8FDB\u5BB6\uFF0C\u4E24\u4EBA\u540C\u5FC3\u3002", "\u5BB6\u548C\u4E3A\u5148\uFF0C\u5916\u4E8B\u7F13\u4E00\u6B65\u3002"]
        },
        \u614E: {
          u: ["\u5B9C\u591A\u542C\u5C11\u8BF4\uFF0C\u91CD\u8981\u7684\u8BDD\u5148\u7F13\u4E00\u7F13\u3002", "\u628A\u8BDD\u8BF4\u8F6F\u4E9B\uFF0C\u4E0D\u4E89\u6267\u3002", "\u8981\u7D27\u8BDD\u6539\u65E5\u518D\u8BF4\u3002"],
          s: ["\u91CD\u8981\u7684\u8BDD\u5148\u7F13\u4E00\u7F13\u3002", "\u4E0D\u5B9C\u8868\u767D\u3001\u644A\u724C\u3002", "\u62FF\u4E0D\u51C6\u7684\u4E8B\u5F80\u540E\u653E\u3002"],
          p: ["\u5B9C\u591A\u542C\u5C11\u8BF4\uFF0C\u4E0D\u4E89\u5BF9\u9519\u3002", "\u65E7\u4E8B\u4E0D\u63D0\uFF0C\u628A\u8BDD\u8BF4\u8F6F\u4E9B\u3002", "\u610F\u89C1\u4E0D\u5408\uFF0C\u5148\u5F80\u540E\u653E\u3002"]
        },
        \u5408\u7F13: {
          u: ["\u7B80\u5355\u966A\u4F34\uFF0C\u8BDD\u4E0D\u7528\u591A\u3002", "\u5B89\u9759\u76F8\u5904\u5373\u53EF\u3002", "\u5982\u5E38\u76F8\u5904\u5373\u53EF\u3002"],
          s: ["\u5982\u5E38\u8054\u7CFB\u5373\u53EF\u3002", "\u4E0D\u6025\u4E8E\u76F8\u7EA6\uFF0C\u6539\u65E5\u5373\u53EF\u3002"],
          p: ["\u5B89\u9759\u966A\u4F34\u5373\u53EF\u3002", "\u8BDD\u4E0D\u5FC5\u591A\uFF0C\u4EBA\u5728\u5373\u53EF\u3002"]
        },
        \u987A: {
          u: ["\u8DDF\u4EBA\u5408\u5F97\u6765\uFF0C\u5B9C\u4E3B\u52A8\u76F8\u7EA6\u3001\u5148\u5F00\u53E3\u3002", "\u5B9C\u4F1A\u53CB\u76F8\u805A\uFF0C\u591A\u8D70\u52A8\u3002", "\u4EBA\u4E8B\u548C\u987A\uFF0C\u5B9C\u591A\u6765\u5F80\u3002"],
          s: ["\u4EBA\u7F18\u6B63\u987A\uFF0C\u5B9C\u7ED3\u8BC6\u3001\u8D74\u7EA6\u3002", "\u5B9C\u8D74\u7EA6\u3001\u4F1A\u53CB\u3002", "\u5B9C\u4E3B\u52A8\u5F00\u53E3\u3002"],
        ...
        \u504F\u663E: {
          u: ["\u5916\u7F18\u6B63\u52A8\uFF0C\u5B9C\u591A\u8D70\u52A8\u3002", "\u5B9C\u51FA\u95E8\u8D70\u52A8\uFF0C\u591A\u7ED3\u8BC6\u3002"],
          s: ["\u5916\u7F18\u6B63\u52A8\uFF0C\u5B9C\u591A\u8D70\u52A8\u3001\u7ED3\u8BC6\u3002", "\u5B9C\u591A\u51FA\u95E8\uFF0C\u591A\u8BA4\u8BC6\u4EBA\u3002"],
          p: ["\u5916\u7F18\u867D\u52A8\uFF0C\u5B9C\u5B88\u73B0\u6709\u611F\u60C5\u3002", "\u5B9C\u591A\u966A\u4F34\uFF0C\u4E0D\u5206\u5FC3\u3002"]
        },
        \u5B88\u663E: {
          u: ["\u7F18\u5206\u867D\u52A8\uFF0C\u5B9C\u5148\u89C2\u5BDF\u3002", "\u4E0D\u6025\u4E8E\u8D70\u8FD1\u3002"],
          s: ["\u7F18\u5206\u867D\u52A8\uFF0C\u5B9C\u5148\u89C2\u5BDF\u3002", "\u4E0D\u6025\u4E8E\u8D70\u8FD1\uFF0C\u591A\u89C2\u5BDF\u3002"],
          p: ["\u5BB6\u4E8B\u4EE5\u7A33\u4E3A\u5148\uFF0C\u4E0D\u5FC5\u5206\u5FC3\u3002", "\u7167\u5E38\u76F8\u5904\u5373\u53EF\u3002"]
        },
        \u7F18: {
          u: ["\u4EBA\u7F18\u6B63\u65FA\uFF0C\u5B9C\u591A\u6765\u5F80\u3002", "\u5B9C\u8D70\u52A8\u3001\u4F1A\u53CB\u3002"],
          s: ["\u4EBA\u7F18\u6B63\u65FA\uFF0C\u5B9C\u8D74\u7EA6\u3001\u7ED3\u8BC6\u3002", "\u5B9C\u591A\u89C1\u4EBA\u3001\u591A\u8D70\u52A8\u3002"],
          p: ["\u5B9C\u7ED3\u4F34\u51FA\u95E8\u3001\u4F1A\u53CB\u3002", "\u5B9C\u540C\u884C\u8D70\u52A8\u3002"]
        },
        \u5E73: {
          u: ["\u591A\u503E\u542C\uFF0C\u4E3B\u52A8\u966A\u4F34\u3002", "\u5982\u5E38\u6765\u5F80\u3002", "\u5E73\u5E38\u5FC3\u76F8\u5904\u3002"],
          s: ["\u4FDD\u6301\u6765\u5F80\u5373\u53EF\u3002", "\u5E73\u5E38\u5FC3\u76F8\u5904\uFF0C\u4E0D\u5FC5\u5F3A\u6C42\u3002", "\u5B9C\u591A\u8D70\u52A8\u3002"],
          p: ["\u591A\u503E\u542C\uFF0C\u4E3B\u52A8\u966A\u4F34\u3002", "\u7167\u5E38\u76F8\u5904\u5373\u53EF\u3002", "\u7559\u4E9B\u65F6\u95F4\u7ED9\u5BB6\u4EBA\u3002"]
        }
      };
      ...
      function dailyFortune(favTypes, jiTypes, he, volatile_, hwx, xiYong, jiShen, xiW, energy, seed, loveSig) {
        ...
        const money = function() {
          ...
          if (S.cueJi !== "\u8D22") {
            ...
            if (S.hitPC && S.caiXi)
              return { tone: "\u987A", line: "\u80FD\u8FDB\u70B9\u6D3B\u94B1\uFF0C\u89C1\u597D\u5C31\u6536\u3002" };
            if (S.luShen)
              return { tone: "\u987A", line: "\u6709\u8FDB\u8D26\uFF0C\u9002\u5408\u6536\u6B3E\u3002" };
          }
          if (S.yiMa)
        ...
        const pk = loveSig && loveSig.inward ? pickSoft : pickV;
      ...
      function stateLine(energy, axis) {
        ...
        const band = energy < 48 ? "\u4E4F" : energy < 56 ? "\u7F13" : energy < 66 ? "\u5E73" : energy < 78 ? "\u8DB3" : "\u76DB";
        const T = {
          \u4E4F: { \u51B3: "\u4F53\u529B\u504F\u4E4F\uFF0C\u8981\u7D27\u7684\u4E00\u4EF6\u529E\u5B8C\u5C31\u6536\u3002", \u84C4: "\u4F53\u529B\u504F\u4E4F\uFF0C\u5B9C\u6536\u5C3E\u65E9\u7761\u3002", \u5E73: "\u4F53\u529B\u504F\u4E4F\uFF0C\u6742\u4E8B\u5F80\u540E\u653E\uFF0C\u65E9\u70B9\u4F11\u606F\u3002" },
          \u7F13: { \u51B3: "\u52B2\u5934\u4E00\u822C\uFF0C\u5148\u529E\u5B9A\u4E0B\u6765\u7684\uFF0C\u522B\u5F00\u65B0\u5934\u3002", \u84C4: "\u52B2\u5934\u4E00\u822C\uFF0C\u6162\u6162\u6765\uFF0C\u4E0D\u5FC5\u8D76\u3002", \u5E73: "\u52B2\u5934\u4E00\u822C\uFF0C\u7167\u5E38\u5B89\u6392\uFF0C\u7559\u4E9B\u4F59\u91CF\u3002" },
          \u5E73: { \u51B3: "\u72B6\u6001\u5E73\u7A33\uFF0C\u80FD\u5B9A\u7684\u4E8B\u4ECA\u5929\u5B9A\u3002", \u84C4: "\u72B6\u6001\u5E73\u7A33\uFF0C\u7406\u6E05\u5934\u7EEA\u518D\u52A8\u624B\u3002", \u5E73: "\u5E73\u7A33\uFF0C\u5148\u529E\u8981\u7D27\u7684\u4E00\u4E24\u4EF6\uFF0C\u6742\u4E8B\u4E0D\u5FC5\u8D76\u3002" },
          \u8DB3: { \u51B3: "\u5934\u8111\u6E05\u9192\uFF0C\u8981\u62CD\u677F\u7684\u4E8B\u522B\u518D\u5F80\u540E\u62D6\u3002", \u84C4: "\u72B6\u6001\u4E0D\u9519\uFF0C\u7A33\u6B65\u63A8\u8FDB\uFF0C\u5FCC\u56FE\u5FEB\u3002", \u5E73: "\u6E05\u723D\u6709\u52B2\uFF0C\u8BE5\u505A\u7684\u4E8B\u987A\u624B\u63A8\u8FDB\u3002" },
          \u76DB: { \u51B3: "\u7CBE\u795E\u8DB3\u3001\u5224\u65AD\u51C6\uFF0C\u5927\u4E8B\u4ECA\u5929\u62CD\u677F\u3002", \u84C4: "\u7CBE\u795E\u5F88\u8DB3\uFF0C\u6536\u7740\u7528\uFF0C\u4E00\u5929\u522B\u6392\u592A\u6EE1\u3002", \u5E73: "\u7CBE\u795E\u5F88\u8DB3\uFF0C\u8D81\u52BF\u628A\u62D6\u7740\u7684\u4E8B\u6E05\u6389\u3002" }
        };
        return T[band][side];
      }
      ...
      var _dynCache = /* @__PURE__ */ new WeakMap();
      function dynFor(mingju, chart, year) {
        let ym = _dynCache.get(mingju);
        if (!ym) {
          ym = /* @__PURE__ */ new Map();
          _dynCache.set(mingju, ym);
        }
        let d = ym.get(year);
        if (d === void 0) {
          d = dynamicXiYong(mingju, chart, year);
          ym.set(year, d);
        }
        return d;
      }
      function rawFor(mingju, chart, year, month, day) {
        ...
        const xiYong = dyn.xiYong, jiShen = dyn.jiShen;
        ...
        if (dy) {
          contribute(GAN_WX[dy.gan], 0.4, false);
          contribute(ZHI_WX[dy.zhi], 0.5, false);
        }
        contribute(GAN_WX[yGan], 0.35, false);
        contribute(ZHI_WX[yZhi], 0.35, false);
        contribute(ZHI_WX[mZhi], 0.8, false);
        contribute(GAN_WX[gan], 1, true);
        ZHI_HIDE[zhi].forEach((g, i) => contribute(GAN_WX[g], i === 0 ? 1 : i === 1 ? 0.4 : 0.2, true));
        const riZhi = chart.zhis[2];
        const riGan = chart.dayGan;
        let volatile_ = false, he_ = false, note = "";
        if (ZHI_CHONG[zhi] === riZhi) {
          raw -= 1.2;
          volatile_ = true;
          note = "\u4EBA\u4E8B\u591A\u6709\u53CD\u590D\uFF0C\u91CD\u8981\u7684\u4E8B\u5F80\u540E\u653E";
        } else if (ZHI_HE[zhi] === riZhi) {
          raw += 0.4;
          he_ = true;
          note = "\u4ECA\u65E5\u4EBA\u4E8B\u8F83\u987A\uFF0C\u5408\u4F5C\u6613\u6210";
        }
      ...
      function liuri(mingju, chart, { year, month, day }) {
        ...
        const WENCHANG_C = { \u7532: "\u5DF3", \u4E59: "\u5348", \u4E19: "\u7533", \u4E01: "\u9149", \u620A: "\u7533", \u5DF1: "\u9149", \u5E9A: "\u4EA5", \u8F9B: "\u5B50", \u58EC: "\u5BC5", \u7678: "\u536F" };
        const wenChangDay = WENCHANG_C[chart.dayGan] === zhi;
        const cueJiCand = wenChangDay && topJi && topJi.t === "\u5370" ? jiGods[1] || null : topJi;
        const _favStrC = topFav ? topFav.weight * (topFav.favW || 1) : 0, _jiStrC = cueJiCand ? cueJiCand.weight : 0;
        ...
        let state = stateLine(energy, axis);
        {
          ...
          const mv = (mingju.favVec || {})[GAN_WX[mGan]] ?? 0;
          const monthTone = mv >= 0.12 ? "\u559C" : mv <= -0.12 ? "\u5FCC" : "\u5E73";
        ...
        return {
          ...
          fortune: dailyFortune(favGods.map((s) => s.t), jiGods.map((s) => s.t), he_, volatile_, GAN_WX[gan], xiYong, jiShen, xiW, energy, month * 31 + day, function() {
            ...
            const hideGan = (ZHI_HIDE[zhi] || [])[0];
            const fullHide = hideGan && tenGodFull ? tenGodFull(chart.dayGan, hideGan) : "";
            const hit = (f) => full === f || fullHide === f;
            const zheng = gender === "\u7537" && hit("\u6B63\u8D22") || gender === "\u5973" && hit("\u6B63\u5B98");
            const pian = gender === "\u7537" && hit("\u504F\u8D22");
            ...
            const GANS10 = "\u7532\u4E59\u4E19\u4E01\u620A\u5DF1\u5E9A\u8F9B\u58EC\u7678", ZHIS12 = "\u5B50\u4E11\u5BC5\u536F\u8FB0\u5DF3\u5348\u672A\u7533\u9149\u620C\u4EA5";
            const gi = GANS10.indexOf(chart.gans[2]), zi = ZHIS12.indexOf(dayZhi);
            let jz = -1;
            for (let k = 0; k < 6; k++) {
              const n = gi + 10 * k;
              if (n % 12 === zi) {
            ...
            const xunShou = jz >= 0 ? jz - jz % 10 : -1;
            const kongZhis = xunShou >= 0 ? [ZHIS12[(xunShou + 10) % 12], ZHIS12[(xunShou + 11) % 12]] : [];
            const kongWang = kongZhis.includes(zhi);
            ...
            const luShen = LU[chart.dayGan] === zhi;
            const jiangXing = JIANG[chart.zhis[0]] === zhi;
            const hl = HONGLUAN[chart.zhis[0]];
            const luanXi = zhi === hl || ZHI_CHONG[zhi] === hl;
            const monthZhi = chart.zhis[1];
            const heYueZhi = ZHI_HE[zhi] === monthZhi || zhi !== monthZhi && SAN_HE.some((g) => g.trio.includes(zhi) && g.trio.includes(monthZhi));
            const xingYue = zhi !== monthZhi && isXing(zhi, monthZhi);
            const haiYue = ZHI_HARM[zhi] === monthZhi;
            const CHANGSHENG = { \u7532: "\u4EA5", \u4E59: "\u5348", \u4E19: "\u5BC5", \u4E01: "\u9149", \u620A: "\u5BC5", \u5DF1: "\u9149", \u5E9A: "\u5DF3", \u8F9B: "\u5B50", \u58EC: "\u7533", \u7678: "\u536F" };
            const xueTang = CHANGSHENG[chart.dayGan] === zhi;
            const tianKeDiChong = KE[GAN_WX[gan]] === dayGanWx && ZHI_CHONG[zhi] === dayZhi;
            const natalZ = chart.zhis || [];
            const sanHeJu = SAN_HE.some((g) => g.trio.includes(zhi) && g.trio.filter((t) => t !== zhi).every((t) => natalZ.includes(t)));
            return {
              kongWang,
              luShen,
              jiangXing,
              ...
              // 人格边界:无外放证据(内敛/慢热/官压身)者,顺日不选「主动开口/表心意」类变体,改取同档里的温和变体
              inward: !personaSignals(mingju, chart).expressive,
              cueJi,
              // 提示语主导忌神(官/印/财/食/比 或 null)
          ...
          volatile: volatile_,
          note,
          // 当日「得用/受克」的十神大类(按权重降序去重),供择日按事项归类
          favTypes: favGods.map((s) => s.t),
          jiTypes: jiGods.map((s) => s.t)
        };
      }
      function liuyue(mingju, chart, { year, month }) {
        const days = new Date(year, month, 0).getDate();
        const list = [];
        for (let d = 1; d <= days; d++) {
          list.push(liuri(mingju, chart, { year, month, day: d }));
        }
        const avg = Math.round(list.reduce((s, x) => s + x.energy, 0) / list.length);
        const n = Math.max(3, Math.round(days * 0.2));
        const high = [...list].sort((a, b) => b.energy - a.energy).slice(0, n).sort((a, b) => a.date.localeCompare(b.date));
        return { year, month, days, avg, list, high };
      }
      function liunian(mingju, chart, year) {
        const months = [];
        for (let m = 1; m <= 12; m++) {
          const { avg } = liuyue(mingju, chart, { year, month: m });
          months.push({ month: m, avg });
        }
        const best = [...months].sort((a, b) => b.avg - a.avg)[0];
        return { year, months, bestMonth: best.month, bestAvg: best.avg };
      }
      function uniq(a) {
        return [...new Set(a)];
      }
      ...
      module.exports = { liuri, liuyue, liunian, dayGanZhi, activeDaYun };
    }
  });
    ...
    "engine/liunian2.js"(exports, module) {
      ...
      var YEAR_TYPE = {
        ...
        \u4E03\u6740: {
          ...
          \u5FCC: ["\u538B\u529B\u4E4B\u5E74", "\u62C5\u5B50\u91CD\u3001\u7ADE\u4E89\u72E0\uFF0C\u5BB9\u6613\u88AB\u4E8B\u60C5\u63A8\u7740\u8D70\u3002\u53D8\u52A8\u5927\u591A\u4E0D\u7531\u4F60\u9009\uFF0C\u5148\u7A33\u4F4F\u624B\u91CC\u7684\uFF0C\u518D\u770B\u65B0\u7684\u3002"],
          \u5E73: ["\u625B\u4E8B\u4E4B\u5E74", "\u62C5\u5B50\u6709\uFF0C\u4F46\u538B\u5F97\u4F4F\u3002\u6311\u4E00\u4E24\u4EF6\u8981\u7D27\u7684\u625B\u4E0B\u6765\uFF0C\u5176\u4F59\u4E0D\u5FC5\u786C\u63A5\u3002"]
        },
        \u6B63\u5370: {
          \u559C: ["\u8D35\u4EBA\u6587\u4E66\u4E4B\u5E74", "\u6587\u4E66\u3001\u5B66\u4E1A\u3001\u957F\u8F88\u76F8\u52A9\uFF0C\u8FD9\u7C7B\u4E8B\u8FD9\u5E74\u5F88\u987A\uFF0C\u5229\u4E8E\u8FDB\u4FEE\u957F\u672C\u4E8B\u3002\u8BE5\u5B66\u7684\u5B66\u3001\u8BE5\u529E\u7684\u529E\uFF0C\u591A\u8D70\u52A8\u957F\u8F88\u8D35\u4EBA\u3002"],
          \u5FCC: ["\u6587\u4E66\u8D39\u5FC3\u4E4B\u5E74", "\u6587\u4E66\u3001\u624B\u7EED\u4E0A\u7684\u4E8B\u4E0D\u5C11\uFF0C\u8FC7\u7A0B\u62D6\u3001\u8D39\u5FC3\u3002\u6587\u4EF6\u591A\u770B\u4E24\u904D\uFF0C\u522B\u5ACC\u9EBB\u70E6\u3002"],
          \u5E73: ["\u79EF\u7D2F\u4E4B\u5E74", "\u6587\u4E66\u3001\u5B66\u4E1A\u3001\u957F\u8F88\u7684\u4E8B\u5E73\u987A\uFF0C\u6CA1\u6709\u5927\u8D77\u843D\u3002\u8BE5\u5B66\u7684\u5B66\u3001\u8BE5\u529E\u7684\u529E\uFF0C\u8FDB\u5EA6\u6162\u4E5F\u7B97\u6570\u3002"]
        },
        \u504F\u5370: {
          \u559C: ["\u6DF1\u8015\u4E4B\u5E74", "\u5F88\u9002\u5408\u4E00\u4E2A\u4EBA\u94BB\u7814\u3001\u4FEE\u5B66\u95EE\u6280\u80FD\u3002\u6C89\u4E0B\u53BB\u5B66\u7684\u4E1C\u897F\uFF0C\u5F80\u540E\u90FD\u7528\u5F97\u4E0A\u3002"],
          \u5FCC: ["\u95F7\u5B66\u4E4B\u5E74", "\u5B66\u7684\u548C\u7528\u7684\u5BF9\u4E0D\u4E0A\uFF0C\u88AB\u5B89\u6392\u7684\u4E8B\u591A\uFF0C\u5FC3\u91CC\u95F7\u3002\u95F7\u7684\u65F6\u5019\u627E\u4EBA\u8BF4\u8BF4\uFF0C\u522B\u4E00\u4E2A\u4EBA\u625B\u3002"],
          \u5E73: ["\u9759\u4FEE\u4E4B\u5E74", "\u4E00\u4E2A\u4EBA\u94BB\u7814\u7684\u65F6\u95F4\u591A\uFF0C\u5916\u5934\u52A8\u9759\u5C11\u3002\u6C89\u4F4F\u6C14\u628A\u624B\u4E0A\u7684\u6280\u827A\u78E8\u7EC6\uFF0C\u4E0D\u6025\u7740\u62FF\u51FA\u53BB\u3002"]
        },
        \u6B63\u8D22: {
      ...
      var YEAR_YIJI = {
        ...
        \u6BD4\u559C: { yi: ["\u7ED3\u4F34\u642D\u4F19\u3001\u4E3B\u52A8\u5F00\u53E3", "\u628A\u5206\u5185\u4E8B\u505A\u5B9E"], ji: ["\u4E00\u4E2A\u4EBA\u625B\u4E8B"] },
        \u6BD4\u5FCC: { yi: ["\u8D26\u76EE\u767D\u7EB8\u9ED1\u5B57", "\u754C\u9650\u8BF4\u6E05"], ji: ["\u66FF\u4EBA\u62C5\u4FDD\u625B\u4E8B"] }
      };
      var YIJI_KEY = { \u6B63\u5B98: "\u5B98", \u4E03\u6740: "\u5B98", \u6B63\u5370: "\u5370", \u504F\u5370: "\u5370", \u6B63\u8D22: "\u8D22", \u504F\u8D22: "\u8D22", \u98DF\u795E: "\u98DF", \u4F24\u5B98: "\u4F24", \u6BD4\u80A9: "\u6BD4", \u52AB\u8D22: "\u6BD4" };
      var YJ_SIGNAL = {
        // 讲方向,不给固定场景(创始人定 2026-09-10:同一时点给方向,用户自己往自己身上套;一个具体动作不对号的人看不懂)
        "\u51B2\xB7\u4E8B\u4E1A": { yi: ["\u5148\u7A33\u4F4F\u672C\u804C"], ji: ["\u8D38\u7136\u5927\u52A8"] },
        "\u5408\xB7\u4E8B\u4E1A": { yi: ["\u501F\u529B\u8C0B\u4E8B"], ji: [] },
        "\u5211\xB7\u4E8B\u4E1A": { yi: ["\u7406\u987A\u5173\u7CFB"], ji: ["\u8F83\u52B2\u4E0D\u8BA9"] },
        "\u5BB3\xB7\u4E8B\u4E1A": { yi: ["\u5C11\u63FD\u95F2\u4E8B"], ji: ["\u5377\u5165\u662F\u975E"] },
        "\u4F0F\xB7\u4E8B\u4E1A": { yi: ["\u5B88\u6210\u3001\u6E05\u65E7\u52A1"], ji: ["\u539F\u6837\u8D70\u8001\u8DEF"] },
        "\u51B2\xB7\u5A5A\u59FB": { yi: ["\u591A\u4F53\u8C05\u3001\u591A\u6C9F\u901A"], ji: ["\u611F\u60C5\u4E0A\u8D4C\u6C14\u52A8\u5FF5"] },
        "\u5408\xB7\u5A5A\u59FB": { yi: ["\u7528\u5FC3\u7ECF\u8425\u611F\u60C5"], ji: [] },
        "\u5A5A\u5F15\xB7\u5A5A\u59FB": { yi: ["\u6B63\u89C6\u611F\u60C5\u3001\u591A\u4E0A\u5FC3"], ji: [] },
        "\u5211\xB7\u5A5A\u59FB": { yi: ["\u591A\u4F53\u8C05"], ji: ["\u7FFB\u65E7\u8D26\u3001\u8F83\u771F"] },
        "\u5BB3\xB7\u5A5A\u59FB": { yi: [], ji: ["\u542C\u4FE1\u95F2\u8BDD"] },
        "\u4F0F\xB7\u5A5A\u59FB": { yi: ["\u628A\u65E7\u5173\u7CFB\u7406\u987A"], ji: ["\u65E7\u4E8B\u7EA0\u7F20"] },
        "\u51B2\xB7\u5BB6\u5B85": { yi: ["\u591A\u987E\u5BB6"], ji: ["\u4E0E\u957F\u8F88\u786C\u9876"] },
        "\u5408\xB7\u5BB6\u5B85": { yi: ["\u591A\u987E\u5BB6\u3001\u5E38\u805A"], ji: [] },
        "\u5211\xB7\u5BB6\u5B85": { yi: ["\u591A\u62C5\u5F85\u5BB6\u91CC"], ji: ["\u4E3A\u5BB6\u4E8B\u52A8\u6C14"] },
        "\u5BB3\xB7\u5BB6\u5B85": { yi: [], ji: ["\u63BA\u548C\u5BB6\u91CC\u95F2\u8BDD"] },
        "\u4F0F\xB7\u5BB6\u5B85": { yi: ["\u7167\u5E94\u65E7\u4EBA\u65E7\u4E8B"], ji: [] },
        "\u51B2\xB7\u9879\u76EE": { yi: ["\u6536\u5C3E\u6E05\u65E7"], ji: ["\u8FD4\u5DE5\u8F83\u52B2"] },
        "\u5408\xB7\u9879\u76EE": { yi: ["\u987A\u52BF\u51FA\u6210\u679C"], ji: [] },
        ...
        "\u795E\xB7\u7984\u9A6C": { yi: ["\u5F80\u5916\u8D70\u3001\u52A8\u4E2D\u6C42\u8FDB"], ji: [] },
        "\u795E\xB7\u6587\u660C": { yi: ["\u8FDB\u4FEE\u3001\u957F\u672C\u4E8B"], ji: [] },
      ...
      var YEAR_YIJI_STAGE = {
        child: {
          \u5B98\u559C: { yi: ["\u5B88\u89C4\u77E9\u3001\u4E89\u8868\u73B0"], ji: ["\u9876\u649E\u5E08\u957F"] },
          \u5B98\u5FCC: { yi: ["\u6309\u8001\u5E08\u8BF4\u7684\u6765"], ji: ["\u786C\u78B0\u786C"] },
          \u5370\u559C: { yi: ["\u591A\u8BFB\u4E66\u3001\u591A\u8BF7\u6559"], ji: ["\u4E00\u4E8B\u4E45\u62D6\u4E0D\u51B3"] },
          \u5370\u5FCC: { yi: ["\u4F5C\u4E1A\u3001\u6587\u5177\u591A\u68C0\u67E5"], ji: ["\u8F7B\u4FE1\u65C1\u4EBA\u8BF4\u6CD5"] },
          \u8D22\u559C: { yi: ["\u5B66\u7740\u7BA1\u96F6\u82B1\u94B1"], ji: ["\u4E71\u82B1\u94B1"] },
          \u8D22\u5FCC: { yi: ["\u96F6\u82B1\u94B1\u8BB0\u8D26"], ji: ["\u51B2\u52A8\u82B1\u94B1"] },
          \u98DF\u559C: { yi: ["\u591A\u8868\u8FBE\u3001\u591A\u52A8\u624B"], ji: ["\u8BDD\u591A\u5931\u5EA6"] },
          \u98DF\u5FCC: { yi: ["\u5B9A\u4F5C\u606F\u3001\u6309\u65F6\u5B8C\u6210"], ji: ["\u677E\u52B2\u8BEF\u4E8B"] },
          \u4F24\u559C: { yi: ["\u4F5C\u54C1\u62FF\u51FA\u6765\u7ED9\u4EBA\u770B"], ji: ["\u8BDD\u8BF4\u592A\u6EE1"] },
          \u4F24\u5FCC: { yi: ["\u8981\u7D27\u7684\u8BDD\u5148\u60F3\u540E\u8BF4"], ji: ["\u4E0E\u4EBA\u4E89\u5634"] },
          \u6BD4\u559C: { yi: ["\u4E0E\u540C\u5B66\u642D\u4F34"], ji: ["\u4E00\u4E2A\u4EBA\u95F7\u5934\u505A"] },
          \u6BD4\u5FCC: { yi: ["\u4E1C\u897F\u501F\u8FD8\u8BB2\u6E05"], ji: ["\u66FF\u4EBA\u9876\u4E8B"] }
        },
        elder: {
          \u5B98\u559C: { yi: ["\u8BE5\u529E\u7684\u624B\u7EED\u8D81\u65E9\u529E"], ji: ["\u4E0E\u4EBA\u786C\u9876"] },
          \u5B98\u5FCC: { yi: ["\u6309\u89C4\u77E9\u6765\u3001\u5C11\u63FD\u4E8B"], ji: ["\u786C\u78B0\u786C"] },
          \u5370\u559C: { yi: ["\u529E\u6587\u4E66\u3001\u627E\u4EBA\u5546\u91CF"], ji: ["\u4E00\u4E8B\u4E45\u62D6\u4E0D\u51B3"] },
          \u5370\u5FCC: { yi: ["\u8BC1\u4EF6\u624B\u7EED\u591A\u6838\u5BF9"], ji: ["\u8F7B\u4FE1\u53E3\u5934\u627F\u8BFA"] },
          \u8D22\u559C: { yi: ["\u8BE5\u6536\u7684\u6536\u3001\u76D8\u70B9\u8FDB\u9879"], ji: ["\u8D2A\u591A\u94FA\u5F20"] },
          \u8D22\u5FCC: { yi: ["\u5B88\u4F4F\u672C\u91D1\u3001\u8BB0\u8D26"], ji: ["\u501F\u8D37\u62C5\u4FDD", "\u51B2\u52A8\u6D88\u8D39"] },
          \u98DF\u559C: { yi: ["\u591A\u8D70\u52A8\u3001\u627E\u70B9\u7231\u597D"], ji: ["\u8A00\u591A\u5931\u5EA6"] },
          \u98DF\u5FCC: { yi: ["\u5B9A\u4F5C\u606F\u3001\u522B\u8D56\u7740"], ji: ["\u677E\u52B2\u8BEF\u4E8B"] },
          \u4F24\u559C: { yi: ["\u60F3\u8BF4\u7684\u8BDD\u8BF4\u51FA\u6765"], ji: ["\u8BDD\u8BF4\u592A\u6EE1"] },
          \u4F24\u5FCC: { yi: ["\u8981\u7D27\u7684\u4E8B\u7559\u4E2A\u5B57\u636E"], ji: ["\u53E3\u820C\u4E4B\u4E89"] },
          \u6BD4\u559C: { yi: ["\u7ED3\u4F34\u540C\u884C\u3001\u5E38\u6765\u5F80"], ji: ["\u4E00\u4E2A\u4EBA\u625B\u4E8B"] },
          \u6BD4\u5FCC: { yi: ["\u8D26\u76EE\u767D\u7EB8\u9ED1\u5B57"], ji: ["\u66FF\u4EBA\u62C5\u4FDD\u625B\u4E8B"] }
        }
      };
      var YJ_SIGNAL_STAGE = {
        child: {
          "\u51B2\xB7\u4E8B\u4E1A": { yi: ["\u5148\u628A\u529F\u8BFE\u7A33\u4F4F"], ji: ["\u8D38\u7136\u6362\u6CD5\u5B50"] },
          "\u5211\xB7\u4E8B\u4E1A": { yi: ["\u7406\u987A\u540C\u5B66\u5173\u7CFB"], ji: ["\u8F83\u52B2\u4E0D\u8BA9"] },
          "\u5BB3\xB7\u4E8B\u4E1A": { yi: ["\u5C11\u63BA\u548C\u95F2\u4E8B"], ji: ["\u5377\u5165\u662F\u975E"] },
          "\u4F0F\xB7\u4E8B\u4E1A": { yi: ["\u628A\u5B66\u8FC7\u7684\u8865\u7262"], ji: ["\u539F\u6837\u8D70\u8001\u8DEF"] },
          "\u51B2\xB7\u9879\u76EE": { yi: ["\u6536\u5C3E\u65E7\u529F\u8BFE"], ji: ["\u6765\u56DE\u63A8\u7FFB\u91CD\u505A"] },
          "\u5211\xB7\u9879\u76EE": { yi: ["\u4E00\u4EF6\u4EF6\u505A\u5B8C"], ji: ["\u8D2A\u591A\u3001\u6765\u56DE\u6539"] },
          "\u4F0F\xB7\u9879\u76EE": { yi: ["\u628A\u4F1A\u7684\u7EC3\u719F"], ji: [] },
          "\u51B2\xB7\u5A5A\u59FB": { yi: ["\u591A\u4F53\u8C05\u540C\u4F34"], ji: ["\u8D4C\u6C14\u4E0D\u7406\u4EBA"] },
          "\u5211\xB7\u5A5A\u59FB": { yi: ["\u6709\u59D4\u5C48\u8BF4\u51FA\u6765"], ji: ["\u7FFB\u65E7\u8D26\u3001\u8F83\u771F"] },
          "\u4F0F\xB7\u5A5A\u59FB": { yi: ["\u628A\u95F9\u63B0\u7684\u5173\u7CFB\u7406\u987A"], ji: ["\u65E7\u4E8B\u7EA0\u7F20"] },
          "\u5408\xB7\u5A5A\u59FB": { yi: ["\u597D\u597D\u5F85\u8981\u597D\u7684\u670B\u53CB"], ji: [] },
          "\u5A5A\u5F15\xB7\u5A5A\u59FB": { yi: ["\u591A\u548C\u8981\u597D\u7684\u670B\u53CB\u6765\u5F80"], ji: [] },
          "\u5BB3\xB7\u5A5A\u59FB": { yi: [], ji: ["\u542C\u4FE1\u95F2\u8BDD"] },
          "\u795E\xB7\u7984\u795E": { yi: ["\u9760\u81EA\u5DF1\u7684\u672C\u4E8B\u4F7F\u52B2"], ji: [] },
          "\u795E\xB7\u7EA2\u9E3E\u6210": { yi: ["\u548C\u8EAB\u8FB9\u4EBA\u591A\u6765\u5F80"], ji: [] },
          "\u795E\xB7\u7EA2\u9E3E\u5C11": { yi: ["\u548C\u8EAB\u8FB9\u4EBA\u591A\u6765\u5F80"], ji: [] },
          "\u795E\xB7\u5929\u559C": { yi: ["\u5BB6\u91CC\u7684\u559C\u4E8B\u591A\u53C2\u4E0E"], ji: [] },
          "\u795E\xB7\u534E\u76D6": { yi: ["\u6C89\u4E0B\u5FC3\u3001\u7EC3\u672C\u4E8B"], ji: [] },
          "\u795E\xB7\u6587\u660C": { yi: ["\u591A\u8BFB\u4E66\u3001\u957F\u672C\u4E8B"], ji: [] },
          "\u795E\xB7\u6843\u82B1": { yi: ["\u591A\u548C\u540C\u4F34\u6765\u5F80"], ji: [] },
          "\u795E\xB7\u9A7F\u9A6C": { yi: ["\u591A\u51FA\u95E8\u89C1\u4E16\u9762"], ji: ["\u95F7\u5728\u5BB6\u91CC"] },
          "\u795E\xB7\u5929\u4E59": { yi: ["\u9047\u4E8B\u627E\u5927\u4EBA\u5546\u91CF"], ji: [] }
        },
        elder: {
          "\u51B2\xB7\u4E8B\u4E1A": { yi: ["\u5148\u7A33\u4F4F\u624B\u8FB9\u7684\u4E8B"], ji: ["\u8D38\u7136\u5927\u52A8"] },
          "\u5211\xB7\u4E8B\u4E1A": { yi: ["\u7406\u987A\u4EBA\u60C5\u5173\u7CFB"], ji: ["\u8F83\u52B2\u4E0D\u8BA9"] },
          "\u4F0F\xB7\u4E8B\u4E1A": { yi: ["\u628A\u65E7\u4E8B\u6E05\u4E00\u6E05"], ji: ["\u539F\u6837\u8D70\u8001\u8DEF"] },
          "\u51B2\xB7\u9879\u76EE": { yi: ["\u6536\u5C3E\u6E05\u65E7"], ji: ["\u53CD\u590D\u6298\u817E"] },
          "\u5211\xB7\u9879\u76EE": { yi: ["\u4E00\u4EF6\u4EF6\u6162\u6162\u529E"], ji: ["\u8D2A\u591A\u3001\u53CD\u590D\u6298\u817E"] },
          "\u4F0F\xB7\u9879\u76EE": { yi: ["\u65E7\u7269\u65E7\u4E8B\u91CD\u6574"], ji: [] },
          "\u795E\xB7\u6587\u660C": { yi: ["\u5199\u5199\u8BB0\u8BB0\u3001\u52A8\u52A8\u8111"], ji: [] },
          "\u795E\xB7\u7984\u795E": { yi: ["\u9760\u8001\u672C\u4E8B\u53D1\u529B"], ji: [] },
          "\u795E\xB7\u9A7F\u9A6C": { yi: ["\u51FA\u95E8\u8D70\u52A8"], ji: ["\u6574\u5929\u95F7\u5728\u5BB6"] },
          "\u795E\xB7\u6843\u82B1": { yi: ["\u591A\u8D70\u52A8\u3001\u5E38\u805A"], ji: [] },
          "\u795E\xB7\u534E\u76D6": { yi: ["\u6C89\u4E0B\u5FC3\u3001\u517B\u6027\u60C5"], ji: [] }
        }
      };
      var SUIYUN_YJ = {
        \u6362\u6321: { yi: ["\u5148\u9002\u5E94\u65B0\u8282\u594F"], ji: ["\u7167\u642C\u65E7\u6CD5"] },
        \u5E76\u4E34: { yi: ["\u7A33\u5B88\u672C\u76D8"], ji: ["\u4E0B\u91CD\u6CE8\u3001\u5B64\u6CE8\u4E00\u63B7"] },
        \u7FFB\u8986: { yi: ["\u5B88\u4F4F\u672C\u76D8"], ji: ["\u5927\u52A8\u3001\u52A0\u6760\u6746"] }
      };
      function composeYiji(baseYj, sigList, stage) {
        ...
        const yiKeys = yi.map(key);
        return { yi, ji: ji.filter((t) => !yiKeys.some((y) => y.includes(key(t)) || key(t).includes(y))) };
      }
      var GONG_TEXT = {
        \u4E8B\u4E1A\u73AF\u5883: {
          \u51B2\u559C: "\u73AF\u5883\u5FC5\u53D8\uFF0C\u4E14\u662F\u5F80\u4E0A\u8D70\u7684\u53D8\u52A8\uFF1A\u6362\u5C97\u3001\u6362\u5730\u65B9\uFF0C\u5927\u80C6\u6362\u3002",
          \u51B2\u5FCC: "\u5DE5\u4F5C\u6216\u73AF\u5883\u5927\u53D8\u52A8\u3002\u6362\u5C97\u3001\u6362\u5730\u65B9\u3001\u6362\u8282\u594F\uFF0C\u5927\u591A\u8EB2\u4E0D\u5F00\uFF1B\u4E0E\u5176\u88AB\u52A8\u7B49\uFF0C\u4E0D\u5982\u4E3B\u52A8\u6311\u4E2A\u65B9\u5411\u3002",
        ...
        \u5A5A\u59FB\u611F\u60C5: {
          \u51B2\u559C: "\u611F\u60C5\u8D77\u5927\u53D8\u5316\uFF0C\u662F\u5F80\u597D\u5904\u53D8\uFF1B\u53D8\u540E\u89C1\u5206\u6653\u3002",
          \u51B2\u5FCC: "\u611F\u60C5\u805A\u6563\u3002\u5173\u7CFB\u5BB9\u6613\u8D77\u5927\u53D8\u5316\uFF0C\u5206\u5408\u90FD\u5FEB\uFF1B\u5927\u51B3\u5B9A\u522B\u5728\u60C5\u7EEA\u5934\u4E0A\u505A\u3002",
          \u5211: "\u611F\u60C5\u78E8\u64E6\u3002\u76F8\u5904\u8D39\u52B2\u3001\u53E3\u89D2\u591A\uFF1B\u4E8B\u5F52\u4E8B\u3001\u4EBA\u5F52\u4EBA\uFF0C\u522B\u7FFB\u65E7\u8D26\u3002",
          \u5408\u559C: "\u611F\u60C5\u8D70\u8FD1\uFF0C\u5173\u7CFB\u4E0A\u6709\u4E00\u80A1\u5F80\u524D\u7684\u529B\u3002",
          \u5408\u5FCC: "\u611F\u60C5\u6709\u8FDB\u5C55\u4F46\u4F34\u7740\u538B\u529B\u3002\u5173\u7CFB\u5F80\u524D\u8D70\uFF0C\u4F46\u5916\u9762\u7684\u4E8B\u62D6\u7D2F\u4E24\u4E2A\u4EBA\u3002",
          \u5BB3: "\u611F\u60C5\u751F\u5ACC\u9699\u3002\u8BEF\u4F1A\u3001\u731C\u7591\u3001\u95F2\u8BDD\u5BB9\u6613\u8D77\uFF1B\u6709\u8BDD\u5F53\u9762\u8BF4\uFF0C\u522B\u8BA9\u7B2C\u4E09\u4E2A\u4EBA\u4F20\u3002",
          \u4F0F\u6210: "\u5A5A\u59FB\u5BAB\u5F15\u52A8\u3002\u611F\u60C5\u662F\u8FD9\u5E74\u7684\u4E3B\u7EBF\uFF0C\u5B9C\u591A\u4E0A\u5FC3\u3002",
          \u4F0F\u5C11: "\u611F\u60C5\u5FC3\u4E8B\u4E4B\u5E74\u3002\u8FD9\u65B9\u9762\u7684\u4E8B\u88AB\u7275\u52A8\uFF0C\u5BB9\u6613\u6709\u5FC3\u4E8B\u3002",
          \u5408\u5C11: "\u611F\u60C5\u5FC3\u4E8B\u4E4B\u5E74\u3002\u8FD9\u65B9\u9762\u7684\u5FC3\u601D\u88AB\u7275\u52A8\uFF0C\u5BB9\u6613\u6709\u5728\u610F\u7684\u4EBA\u3002",
          \u81EA: "\u611F\u60C5\u91CC\u81EA\u6211\u6D88\u8017\u3002\u5BB9\u6613\u94BB\u725B\u89D2\u5C16\u3001\u60F3\u592A\u591A\u3002"
        },
        \u957F\u8F88\u5BB6\u5B85: {
          // 2026-09-18:原来冲忌/刑/害 三种关系共用同一句「家里事多。长辈健康、家宅的事操心。」,
          //   分不出轻重也分不出性质。判定未动,只把三种关系各自讲清,并各给两套说法(按流年支定选)。
          \u51B2\u559C: ["\u5BB6\u5B85\u6709\u53D8\u52A8\uFF0C\u53D8\u540E\u66F4\u5B89\u3002", "\u5BB6\u91CC\u7684\u683C\u5C40\u4ECA\u5E74\u4F1A\u52A8\u4E00\u52A8\uFF0C\u52A8\u5B8C\u6BD4\u539F\u6765\u987A\u3002"],
          \u51B2\u5FCC: [
            "\u5BB6\u91CC\u6709\u5927\u7684\u53D8\u52A8\uFF1A\u4F4F\u5904\u3001\u957F\u8F88\u7684\u5B89\u6392\u90FD\u53EF\u80FD\u6539\uFF0C\u65E9\u505A\u51C6\u5907\u6BD4\u88AB\u52A8\u63A5\u62DB\u597D\u3002",
            "\u4ECA\u5E74\u5BB6\u91CC\u5B89\u5B9A\u4E0D\u4E0B\u6765\uFF0C\u642C\u52A8\u3001\u8C03\u6574\u3001\u6765\u56DE\u8DD1\u7684\u4E8B\u4E0D\u5C11\uFF0C\u65F6\u95F4\u4E0A\u7559\u8DB3\u4F59\u91CF\u3002"
          ],
          \u5211: [
            "\u5BB6\u91CC\u4EBA\u4E4B\u95F4\u5BB9\u6613\u8D77\u6469\u64E6\uFF0C\u65E7\u4E8B\u7FFB\u51FA\u6765\u8C01\u90FD\u4E0D\u8BA9\uFF1B\u4F60\u522B\u7AD9\u961F\uFF0C\u5148\u628A\u4E8B\u529E\u4E86\u3002",
            "\u4ECA\u5E74\u5BB6\u91CC\u610F\u89C1\u96BE\u7EDF\u4E00\uFF0C\u4E89\u8D77\u6765\u4F24\u548C\u6C14\uFF1B\u80FD\u4EE3\u529E\u7684\u4EE3\u529E\uFF0C\u5C11\u8FA9\u5BF9\u9519\u3002"
          ],
          \u5BB3: [
            "\u5BB6\u91CC\u7684\u6D88\u8017\u5728\u6697\u5904\uFF1A\u8BDD\u4F20\u5C94\u3001\u4E8B\u6CA1\u4EBA\u8BA4\u9886\uFF0C\u7B49\u4F60\u53D1\u73B0\u5DF2\u7ECF\u62D6\u4E86\u4E00\u9635\u3002",
            "\u4ECA\u5E74\u5BB6\u91CC\u7684\u4E8B\u5BB9\u6613\u88AB\u8F6C\u8FF0\u5E26\u504F\uFF0C\u8981\u7D27\u7684\u4E8B\u76F4\u63A5\u95EE\u5F53\u4E8B\u4EBA\u3002"
          ],
          \u5408\u559C: ["\u5BB6\u5B85\u548C\u987A\u3002\u5BB6\u91CC\u7701\u5FC3\uFF0C\u957F\u8F88\u8FD9\u8FB9\u6709\u52A9\u529B\u3002", "\u4ECA\u5E74\u5BB6\u91CC\u8FD9\u8FB9\u662F\u52A9\u529B\uFF1A\u8981\u529E\u7684\u4E8B\u3001\u8981\u5546\u91CF\u7684\u4E8B\u90FD\u597D\u5F00\u53E3\u3002"],
          \u5408\u5FCC: ["\u5BB6\u4E8B\u7275\u626F\u591A\u3002\u64CD\u5FC3\u591A\u3001\u8DD1\u52A8\u591A\u3002", "\u4ECA\u5E74\u5BB6\u91CC\u7684\u4E8B\u4E00\u4EF6\u63A5\u4E00\u4EF6\u7275\u7740\u4F60\uFF0C\u65F6\u95F4\u548C\u7CBE\u529B\u90FD\u5F97\u9884\u7559\u3002"],
          \u4F0F: ["\u5BB6\u91CC\u7684\u4E8B\u91CD\u590D\u3001\u62D6\u7740\u3002\u8001\u95EE\u9898\u8FD8\u662F\u90A3\u4E9B\u3002", "\u4ECA\u5E74\u5BB6\u91CC\u6CA1\u6709\u65B0\u95EE\u9898\uFF0C\u4E5F\u6CA1\u89E3\u51B3\u65E7\u95EE\u9898\uFF0C\u539F\u6837\u62D6\u7740\u3002"],
          \u81EA: ["\u5BB6\u4E8B\u4E0A\u64CD\u5FC3\u8FC7\u5934\uFF0C\u81EA\u6211\u6D88\u8017\u3002", "\u4ECA\u5E74\u4E3A\u5BB6\u91CC\u7684\u4E8B\u60AC\u7740\u5FC3\uFF0C\u62C5\u5B50\u5E38\u662F\u4F60\u81EA\u5DF1\u5148\u63FD\u8FC7\u6765\u7684\u3002"]
        },
        ...
        \u4F5C\u54C1\u9879\u76EE: {
          ...
          \u5408\u5FCC: "\u9879\u76EE\u7F20\u8EAB\u3001\u6536\u5C3E\u62D6\u62C9\u3002",
          \u5BB3: "\u9879\u76EE\u5F53\u5FC3\u6697\u635F\u3002\u5907\u4EFD\u3001\u7559\u5E95\u3002",
          \u4F0F: "\u8BA1\u5212\u505C\u5728\u539F\u5730\u3001\u63A8\u8FDB\u6162\u3002\u6253\u78E8\u6BD4\u6269\u5F20\u5408\u9002\u3002",
          \u81EA: "\u9879\u76EE\u4E0A\u81EA\u6211\u6D88\u8017\u3002\u5BB9\u6613\u53CD\u590D\u8FD4\u5DE5\uFF0C\u5065\u5EB7\u3001\u72B6\u6001\u5BB9\u6613\u900F\u652F\u3002"
        }
      };
      var GONG_TEXT_MONTH = {
        \u4E8B\u4E1A\u73AF\u5883: {
          \u51B2\u559C: [
            "\u8FD9\u4E2A\u6708\u6392\u671F\u3001\u5206\u5DE5\u4F1A\u52A8\uFF0C\u52A8\u7684\u65B9\u5411\u5BF9\u4F60\u6709\u5229\u3002\u8DDF\u7740\u8C03\uFF0C\u522B\u5B88\u7740\u65E7\u8BA1\u5212\u3002",
            "\u73AF\u5883\u8FD9\u4E2A\u6708\u4F1A\u632A\u4E00\u4E0B\uFF0C\u632A\u5B8C\u66F4\u987A\u624B\u3002\u8BE5\u63A5\u7684\u65B0\u5B89\u6392\u63A5\u4E0B\u6765\u3002",
            "\u8282\u594F\u88AB\u5916\u9762\u63A8\u7740\u53D8\uFF0C\u4F46\u53D8\u5F97\u4E0D\u574F\u3002\u987A\u7740\u65B0\u5B89\u6392\u8D70\uFF0C\u6548\u7387\u53CD\u800C\u9AD8\u3002"
          ],
          \u51B2\u5FCC: [
            "\u6392\u671F\u548C\u5206\u5DE5\u53CD\u590D\u6539\uFF0C\u8BF4\u5B9A\u7684\u4E8B\u53C8\u63A8\u7FFB\u3002\u8981\u7D27\u7684\u522B\u538B\u5728\u6708\u5E95\uFF0C\u7559\u51FA\u4F59\u91CF\u3002",
            "\u8BA1\u5212\u8FD9\u4E2A\u6708\u7AD9\u4E0D\u4F4F\uFF0C\u6539\u52A8\u6765\u81EA\u5916\u9762\u3002\u6BCF\u4EF6\u4E8B\u7559\u4E00\u4E2A\u5907\u9009\u65B9\u6848\u3002",
            "\u4E8B\u60C5\u53D8\u6765\u53D8\u53BB\uFF0C\u65F6\u95F4\u88AB\u6253\u4E71\u3002\u52A8\u624B\u524D\u5148\u786E\u8BA4\u4E00\u904D\uFF0C\u522B\u6309\u65E7\u53E3\u5934\u7EA6\u5B9A\u505A\u3002"
          ],
          \u5211: [
            "\u6469\u64E6\u96C6\u4E2D\u5728\u534F\u4F5C\u4E0A\uFF1A\u8D23\u4EFB\u4E0D\u6E05\u3001\u6C9F\u901A\u7ED5\u8FDC\u3002\u628A\u81EA\u5DF1\u90A3\u4EFD\u505A\u624E\u5B9E\uFF0C\u754C\u9650\u8BF4\u5728\u524D\u9762\u3002",
            "\u8FD9\u4E2A\u6708\u5BB9\u6613\u5377\u8FDB\u522B\u4EBA\u7684\u4E8B\u3002\u8C01\u8D1F\u8D23\u4EC0\u4E48\uFF0C\u5148\u95EE\u6E05\u695A\u518D\u63A5\u3002",
            "\u540C\u4E8B\u3001\u5408\u4F5C\u65B9\u4E4B\u95F4\u6709\u62C9\u626F\u3002\u522B\u5F53\u4E2D\u95F4\u4EBA\uFF0C\u4E8B\u60C5\u843D\u5230\u7EB8\u9762\u4E0A\u3002"
          ],
          \u5408\u559C: [
            "\u8FD9\u4E2A\u6708\u597D\u5F00\u53E3\u3002\u8981\u8C08\u7684\u4E8B\u3001\u8981\u627E\u7684\u4EBA\uFF0C\u8D81\u672C\u6708\u529E\u3002",
            "\u5916\u9762\u613F\u610F\u63A5\u4F60\u7684\u8BDD\uFF0C\u627E\u4EBA\u5E2E\u5FD9\u5BB9\u6613\u6210\u3002\u522B\u81EA\u5DF1\u95F7\u5934\u505A\u3002",
            "\u8FD9\u4E2A\u6708\u4EBA\u548C\u4E8B\u90FD\u63A5\u5F97\u4E0A\u3002\u6401\u7F6E\u7684\u6C9F\u901A\u6392\u8FDB\u65E5\u7A0B\u3002"
          ],
          \u5408\u5FCC: [
            "\u6742\u4E8B\u628A\u65F6\u95F4\u5207\u788E\uFF0C\u6B63\u4E8B\u63A8\u4E0D\u52A8\u3002\u63A8\u6389\u80FD\u63A8\u7684\uFF0C\u6BCF\u5929\u7559\u4E00\u6BB5\u6574\u5757\u65F6\u95F4\u3002",
            "\u4EBA\u60C5\u5F80\u6765\u5360\u6389\u5927\u534A\u7CBE\u529B\u3002\u5206\u6E05\u54EA\u4E9B\u662F\u4F60\u7684\u4E8B\uFF0C\u54EA\u4E9B\u53EA\u662F\u70ED\u95F9\u3002",
          ...
          \u4F0F: [
            "\u4E8B\u60C5\u5728\u539F\u5730\u91CD\u590D\uFF0C\u770B\u4E0D\u51FA\u8FDB\u5C55\u3002\u8FD9\u4E2A\u6708\u8865\u5E95\u5B50\u3001\u7406\u65E7\u8D26\uFF0C\u4E0D\u5FC5\u5F3A\u51FA\u6210\u679C\u3002",
            "\u91CD\u590D\u6027\u7684\u6D3B\u513F\u5360\u6EE1\u65E5\u7A0B\u3002\u8D81\u673A\u628A\u6D41\u7A0B\u7406\u987A\uFF0C\u4E0B\u4E2A\u6708\u624D\u5FEB\u5F97\u8D77\u6765\u3002",
            "\u8FDB\u5C55\u5E73\uFF0C\u63A8\u4E5F\u63A8\u4E0D\u52A8\u3002\u628A\u624B\u4E0A\u7684\u65E7\u4E8B\u6E05\u5E72\u51C0\uFF0C\u6BD4\u5F00\u65B0\u5934\u5212\u7B97\u3002"
          ],
          \u81EA: [
            "\u5185\u8017\u5728\u81EA\u5DF1\u8FD9\u5934\uFF1A\u53CD\u590D\u63A8\u6572\u3001\u8FDF\u8FDF\u4E0D\u5B9A\u3002\u5B9A\u4E2A\u622A\u6B62\u70B9\uFF0C\u5148\u505A\u51FA\u6765\u518D\u6539\u3002",
            "\u8FD9\u4E2A\u6708\u6700\u5927\u7684\u963B\u529B\u662F\u81EA\u5DF1\uFF1A\u60F3\u5F97\u591A\u3001\u52A8\u624B\u665A\u3002\u5148\u5B9A\u4E00\u4E2A\u6700\u5C0F\u65B9\u6848\u3002",
            "\u60F3\u5F97\u6BD4\u505A\u5F97\u591A\uFF0C\u8017\u5728\u72B9\u8C6B\u4E0A\u3002\u6311\u4E00\u4EF6\u4ECA\u5929\u5C31\u80FD\u52A8\u7684\u5148\u505A\u3002"
          ]
        },
        \u5A5A\u59FB\u611F\u60C5: {
          \u51B2\u559C: [
            "\u5173\u7CFB\u6709\u677E\u52A8\uFF0C\u5F80\u597D\u7684\u65B9\u5411\u8D70\u3002\u60F3\u8BF4\u7684\u8BDD\u8D81\u8FD9\u4E2A\u6708\u8BF4\u3002",
            "\u8FD9\u4E2A\u6708\u5173\u7CFB\u4F1A\u52A8\u4E00\u52A8\uFF0C\u52A8\u5B8C\u66F4\u8FD1\u3002\u4E3B\u52A8\u4E00\u70B9\u4E0D\u5403\u4E8F\u3002",
            "\u50F5\u7740\u7684\u5730\u65B9\u8FD9\u4E2A\u6708\u4F1A\u677E\u3002\u5148\u5F00\u53E3\u7684\u90A3\u4E2A\u4E0D\u5403\u4E8F\u3002"
          ],
          \u51B2\u5FCC: [
            "\u60C5\u7EEA\u8D77\u843D\u5927\uFF0C\u8BDD\u5BB9\u6613\u8BF4\u91CD\u3002\u5173\u7CFB\u4E0A\u7684\u5B9A\u8BBA\uFF0C\u8FD9\u4E2A\u6708\u5148\u522B\u4E0B\u3002",
            "\u8FD9\u4E2A\u6708\u5BB9\u6613\u5FFD\u8FD1\u5FFD\u8FDC\u3002\u522B\u5728\u6C14\u5934\u4E0A\u8C08\u4EE5\u540E\u7684\u4E8B\u3002",
            "\u5173\u7CFB\u4E0A\u7684\u6CE2\u52A8\u6765\u81EA\u5916\u9762\u7684\u538B\u529B\u3002\u5148\u5904\u7406\u4E8B\uFF0C\u518D\u8C08\u5FC3\u60C5\u3002"
          ],
          \u5211: [
            "\u53E3\u89D2\u5E38\u4ECE\u65E7\u4E8B\u8D77\u3002\u5C31\u4E8B\u8BBA\u4E8B\uFF0C\u7FFB\u65E7\u8D26\u53EA\u4F1A\u62D6\u957F\u3002",
            "\u8FD9\u4E2A\u6708\u4E00\u70B9\u5C0F\u4E8B\u5C31\u80FD\u5435\u8D77\u6765\u3002\u628A\u300C\u8FD9\u4EF6\u4E8B\u300D\u548C\u300C\u8FD9\u4E2A\u4EBA\u300D\u5206\u5F00\u3002",
            "\u76F8\u5904\u8D39\u52B2\uFF0C\u8C01\u90FD\u89C9\u5F97\u59D4\u5C48\u3002\u5C11\u8BB2\u9053\u7406\uFF0C\u591A\u8BB2\u5177\u4F53\u5B89\u6392\u3002",
            "\u8BDD\u8D76\u8BDD\u5BB9\u6613\u4F24\u4EBA\u3002\u8FD9\u4E2A\u6708\u628A\u300C\u73B0\u5728\u600E\u4E48\u529E\u300D\u8BF4\u6E05\u695A\u5C31\u591F\u4E86\u3002"
          ],
          \u5408\u559C: [
            "\u8FD9\u4E2A\u6708\u76F8\u5904\u987A\uFF0C\u4E24\u4E2A\u4EBA\u90FD\u613F\u610F\u9760\u8FD1\u3002\u6401\u7740\u7684\u8BDD\u9002\u5408\u8BF4\u5F00\u3002",
            "\u5173\u7CFB\u8FD9\u4E2A\u6708\u5F80\u524D\u8D70\u4E00\u6B65\u3002\u60F3\u7EA6\u7684\u3001\u60F3\u8BF4\u7684\uFF0C\u522B\u62D6\u5230\u4E0B\u4E2A\u6708\u3002",
            "\u8FD9\u4E2A\u6708\u5BF9\u65B9\u597D\u8BF4\u8BDD\uFF0C\u6C14\u6C1B\u677E\u3002\u8981\u5546\u91CF\u7684\u4E8B\u8D81\u73B0\u5728\u3002"
          ],
          \u5408\u5FCC: [
            "\u5173\u7CFB\u8FD1\uFF0C\u9EBB\u70E6\u4E5F\u4E00\u8D77\u8FD1\uFF1A\u5916\u9762\u7684\u4E8B\u538B\u8FDB\u4E24\u4E2A\u4EBA\u4E2D\u95F4\u3002\u4E8B\u5F52\u4E8B\uFF0C\u522B\u628A\u6C14\u5E26\u56DE\u5BB6\u3002",
            "\u8FD9\u4E2A\u6708\u9ECF\u5F97\u7D27\uFF0C\u4E5F\u7D2F\u5F97\u614C\u3002\u5404\u81EA\u7559\u70B9\u7A7A\u95F4\uFF0C\u95EE\u9898\u53CD\u800C\u5C0F\u3002",
            "\u4E24\u4E2A\u4EBA\u90FD\u88AB\u5916\u9762\u7684\u4E8B\u62D6\u7740\uFF0C\u89C1\u9762\u4E5F\u5728\u5904\u7406\u9EBB\u70E6\u3002\u5148\u5404\u81EA\u628A\u4E8B\u4E86\u4E86\u3002"
          ],
          \u5BB3: [
            "\u8BEF\u4F1A\u5E38\u6765\u81EA\u8F6C\u8FF0\u3002\u6709\u8BDD\u5F53\u9762\u95EE\uFF0C\u522B\u9694\u7740\u4EBA\u4F20\u3002",
            "\u8FD9\u4E2A\u6708\u5BB9\u6613\u88AB\u7B2C\u4E09\u4E2A\u4EBA\u7684\u8BDD\u6405\u5C40\u3002\u5F53\u4E8B\u4EBA\u4E4B\u95F4\u81EA\u5DF1\u8BF4\u6E05\u695A\u3002",
            "\u542C\u6765\u7684\u8BDD\u522B\u6025\u7740\u5F53\u771F\u3002\u95EE\u4E00\u53E5\uFF0C\u6BD4\u731C\u4E00\u4E2A\u6708\u7701\u4E8B\u3002"
          ],
          \u4F0F\u6210: [
            "\u5FC3\u601D\u5927\u534A\u5728\u8FD9\u4EF6\u4E8B\u4E0A\uFF0C\u56DE\u907F\u4E0D\u6389\u3002\u7ED9\u5B83\u4E00\u6BB5\u6B63\u7ECF\u65F6\u95F4\u3002",
            "\u8FD9\u4E2A\u6708\u611F\u60C5\u7684\u4E8B\u7ED5\u4E0D\u5F00\uFF0C\u5360\u7740\u5FC3\u795E\u3002\u522B\u7528\u5FD9\u6765\u8EB2\u3002"
          ],
          \u4F0F\u5C11: [
            "\u603B\u60E6\u8BB0\u7740\u67D0\u4E2A\u4EBA\uFF0C\u5FC3\u91CC\u4E0D\u6E05\u9759\u3002",
            "\u8FD9\u4E2A\u6708\u5FC3\u601D\u98D8\u5728\u4E00\u6BB5\u5173\u7CFB\u4E0A\uFF0C\u505A\u4E8B\u5BB9\u6613\u5206\u795E\u3002"
          ...
          \u81EA: [
            "\u81EA\u5DF1\u8DDF\u81EA\u5DF1\u62C9\u626F\uFF0C\u53CD\u590D\u7422\u78E8\u5BF9\u65B9\u7684\u8BDD\u3002\u5199\u4E0B\u6765\u6BD4\u5728\u8111\u5B50\u91CC\u8F6C\u6709\u7528\u3002",
            "\u8FD9\u4E2A\u6708\u5185\u8017\u5728\u5173\u7CFB\u4E0A\uFF1A\u60F3\u592A\u591A\u3001\u95EE\u592A\u5C11\u3002\u76F4\u63A5\u95EE\u4E00\u53E5\u66F4\u7701\u4E8B\u3002"
          ]
        },
        \u957F\u8F88\u5BB6\u5B85: {
          \u51B2\u559C: [
          ...
          \u51B2\u5FCC: [
            "\u5BB6\u91CC\u7684\u4E8B\u5206\u5FC3\uFF1A\u4F4F\u5904\u3001\u957F\u8F88\u8EAB\u4F53\u3001\u6765\u56DE\u8DD1\u3002\u63D0\u524D\u6392\u65F6\u95F4\uFF0C\u522B\u6324\u5728\u6708\u5E95\u3002",
            "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u4F1A\u6709\u9700\u8981\u4F60\u5230\u573A\u7684\u4E8B\u3002\u65E5\u7A0B\u7559\u51FA\u7A7A\u6863\u3002",
            "\u5BB6\u91CC\u7684\u5B89\u6392\u4E34\u65F6\u6539\uFF0C\u7275\u7740\u4F60\u8DD1\u3002\u65E9\u4E00\u6B65\u786E\u8BA4\uFF0C\u5C11\u8DD1\u4E00\u8D9F\u3002"
          ],
          \u5211: [
            "\u5BB6\u91CC\u610F\u89C1\u4E0D\u4E00\uFF0C\u8BF4\u7740\u8BF4\u7740\u53D8\u6210\u4E89\u3002\u5148\u542C\u5B8C\u518D\u7B54\uFF0C\u4E0D\u5FC5\u5F53\u573A\u5206\u5BF9\u9519\u3002",
            "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u4E8B\u591A\u3001\u53E3\u89D2\u4E5F\u591A\u3002\u80FD\u66FF\u957F\u8F88\u529E\u7684\u5148\u529E\uFF0C\u8BDD\u5C11\u8BF4\u4E24\u53E5\u3002",
            "\u5BB6\u91CC\u4E3A\u4E00\u4EF6\u4E8B\u50F5\u7740\u3002\u6362\u4E2A\u4EBA\u53BB\u8BF4\uFF0C\u6BD4\u786C\u78B0\u6709\u7528\u3002"
          ],
          \u5408\u559C: [
            "\u5BB6\u91CC\u7701\u5FC3\uFF0C\u957F\u8F88\u8FD9\u8FB9\u597D\u8BF4\u8BDD\u3002\u8981\u5546\u91CF\u7684\u4E8B\u8FD9\u4E2A\u6708\u63D0\u3002",
            "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u6C14\u6C1B\u987A\uFF0C\u957F\u8F88\u613F\u610F\u542C\u4F60\u7684\u3002",
            "\u5BB6\u91CC\u8FD9\u8FB9\u642D\u5F97\u4E0A\u624B\u3002\u8981\u529E\u7684\u5BB6\u4E8B\u8D81\u8FD9\u4E2A\u6708\u529E\u3002"
          ],
          \u5408\u5FCC: [
            "\u5BB6\u4E8B\u7275\u626F\u591A\u3001\u8DD1\u52A8\u591A\uFF0C\u65F6\u95F4\u88AB\u5360\u6389\u3002\u5206\u4E00\u90E8\u5206\u51FA\u53BB\uFF0C\u522B\u4E00\u4E2A\u4EBA\u625B\u3002",
            "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u7684\u4E8B\u4E00\u4EF6\u63A5\u4E00\u4EF6\u3002\u6392\u4E2A\u5148\u540E\uFF0C\u522B\u90FD\u62A2\u7740\u529E\u3002",
            "\u5BB6\u91CC\u7684\u4E8B\u9ECF\u7740\u4F60\u7684\u65F6\u95F4\u3002\u80FD\u8BA9\u522B\u4EBA\u529E\u7684\u8BA9\u51FA\u53BB\u3002"
          ],
          \u5BB3: [
            "\u4E00\u53E5\u8BDD\u4F20\u4E24\u904D\u5C31\u53D8\u5473\u3002\u76F4\u63A5\u95EE\u5F53\u4E8B\u4EBA\u3002",
            "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u5BB9\u6613\u8D77\u8BEF\u4F1A\uFF0C\u5E38\u662F\u8BDD\u6CA1\u4F20\u5168\u3002"
          ...
          \u4F0F: [
            "\u8001\u95EE\u9898\u53C8\u5192\u5934\uFF0C\u8C01\u90FD\u6CA1\u53D8\u3002\u8FD9\u4E2A\u6708\u53EA\u5904\u7406\u80FD\u5904\u7406\u7684\u90A3\u4E00\u534A\u3002",
            "\u5BB6\u91CC\u7684\u65E7\u8D26\u53C8\u7FFB\u4E0A\u6765\u3002\u89E3\u51B3\u4E0D\u4E86\u7684\u5148\u653E\uFF0C\u522B\u8F83\u52B2\u3002",
            "\u5BB6\u91CC\u8FD8\u662F\u90A3\u51E0\u4EF6\u8001\u4E8B\uFF0C\u4ECA\u5E74\u6CA1\u65B0\u89E3\u6CD5\u3002\u505A\u80FD\u505A\u7684\u90E8\u5206\u3002"
          ],
          \u81EA: [
            "\u4E3A\u5BB6\u91CC\u7684\u4E8B\u64CD\u5FC3\u8FC7\u5934\uFF0C\u7761\u4E0D\u5B89\u7A33\u3002\u7BA1\u5F97\u4F4F\u7684\u7BA1\uFF0C\u7BA1\u4E0D\u4F4F\u7684\u5148\u653E\u3002",
            "\u8FD9\u4E2A\u6708\u5BB9\u6613\u66FF\u5BB6\u91CC\u4EBA\u7126\u8651\u3002\u5148\u987E\u597D\u81EA\u5DF1\u7684\u4F5C\u606F\u3002",
            "\u5FC3\u91CC\u66FF\u5BB6\u91CC\u60AC\u7740\uFF0C\u4E8B\u5374\u4E0D\u5728\u4F60\u624B\u4E0A\u3002\u653E\u4E0B\u4F60\u7BA1\u4E0D\u4E86\u7684\u90A3\u90E8\u5206\u3002"
          ]
        },
        \u4F5C\u54C1\u9879\u76EE: {
          \u51B2\u559C: [
            "\u624B\u4E0A\u7684\u4E1C\u897F\u8981\u6539\uFF0C\u6539\u5B8C\u6BD4\u539F\u6765\u597D\u3002\u8D81\u65E9\u52A8\u624B\u3002",
            "\u8FD9\u4E2A\u6708\u65B9\u6848\u4F1A\u8C03\u6574\uFF0C\u8C03\u5B8C\u66F4\u987A\u3002\u522B\u820D\u4E0D\u5F97\u539F\u6765\u7684\u7248\u672C\u3002",
            "\u624B\u4E0A\u7684\u4E8B\u8981\u7FFB\u65B0\u4E00\u8F6E\uFF0C\u7FFB\u5B8C\u66F4\u597D\u7528\u3002\u65E9\u6539\u65E9\u7701\u4E8B\u3002"
          ],
          \u51B2\u5FCC: [
            "\u8BA1\u5212\u53CD\u590D\uFF0C\u505A\u5230\u4E00\u534A\u63A8\u7FFB\u3002\u5148\u5B58\u597D\u65E7\u7248\u672C\uFF0C\u518D\u52A8\u65B0\u7684\u3002",
            "\u8FD9\u4E2A\u6708\u624B\u4E0A\u7684\u4E8B\u5BB9\u6613\u6539\u65B9\u5411\u3002\u6BCF\u6539\u4E00\u6B21\u7559\u4E2A\u8BB0\u5F55\u3002",
            "\u9700\u6C42\u3001\u5B89\u6392\u53D8\u5F97\u5FEB\u3002\u505A\u4E4B\u524D\u5148\u786E\u8BA4\u4E00\u904D\uFF0C\u7701\u5F97\u767D\u505A\u3002"
          ],
          \u5211: [
            "\u5361\u5728\u7EC6\u8282\u4E0A\u6765\u56DE\u4FEE\u6539\u3002\u5B9A\u4E00\u6761\u300C\u591F\u7528\u5373\u4EA4\u300D\u7684\u7EBF\u3002",
            "\u8FD9\u4E2A\u6708\u6539\u5F97\u591A\u3001\u8FDB\u5F97\u5C11\u3002\u5148\u4EA4\u4E00\u7248\uFF0C\u518D\u6309\u53CD\u9988\u6539\u3002",
            "\u53CD\u590D\u6253\u78E8\u770B\u4E0D\u5230\u5934\u3002\u7ED9\u81EA\u5DF1\u8BBE\u4E2A\u622A\u6B62\u65F6\u95F4\u3002"
          ],
          \u5408\u559C: [
            "\u8FD9\u4E2A\u6708\u6536\u5F97\u4E86\u5C3E\u3002\u6401\u7740\u7684\u90A3\u4EF6\uFF0C\u672C\u6708\u80FD\u7ED3\u675F\u3002",
            "\u624B\u4E0A\u7684\u4E8B\u80FD\u843D\u5730\u3002\u8D81\u8FD9\u4E2A\u6708\u628A\u5C3E\u5DF4\u6536\u6389\u3002",
            "\u8FD9\u4E2A\u6708\u51FA\u6210\u679C\u3002\u96C6\u4E2D\u505A\u5B8C\u4E00\u4EF6\uFF0C\u6BD4\u540C\u65F6\u63A8\u4E09\u4EF6\u5F3A\u3002"
          ],
          \u5408\u5FCC: [
            "\u644A\u5B50\u94FA\u5F97\u5F00\u3001\u7ED3\u4E0D\u4E86\u5C3E\u3002\u5148\u505C\u4E00\u4EF6\uFF0C\u7ED3\u4E00\u4EF6\u3002",
            "\u8FD9\u4E2A\u6708\u5F00\u7684\u5934\u6BD4\u7ED3\u7684\u5C3E\u591A\u3002\u65B0\u7684\u5148\u522B\u63A5\u3002",
          ...
          \u5BB3: [
            "\u758F\u6F0F\u51FA\u5728\u6CA1\u4EBA\u76EF\u7684\u5730\u65B9\u3002\u5B58\u6863\u3001\u7559\u5E95\u3001\u6838\u5BF9\u4E00\u904D\u3002",
            "\u8FD9\u4E2A\u6708\u5BB9\u6613\u767D\u505A\u5DE5\u3002\u91CD\u8981\u7684\u7248\u672C\u591A\u5B58\u4E00\u4EFD\u3002",
            "\u51FA\u95EE\u9898\u7684\u5E38\u662F\u4F60\u6CA1\u68C0\u67E5\u7684\u90A3\u4E00\u6B65\u3002\u4EA4\u4E4B\u524D\u8FC7\u4E00\u904D\u3002"
          ],
          \u4F0F: [
            "\u8FDB\u5C55\u6162\uFF0C\u770B\u7740\u50CF\u5728\u539F\u5730\u3002\u9002\u5408\u6253\u78E8\u7EC6\u8282\uFF0C\u4E0D\u9002\u5408\u52A0\u65B0\u7684\u3002",
            "\u8FD9\u4E2A\u6708\u63A8\u4E0D\u52A8\u3002\u628A\u5DF2\u6709\u7684\u505A\u7EC6\uFF0C\u522B\u6025\u7740\u6269\u3002",
            "\u624B\u4E0A\u7684\u4E8B\u6CA1\u8D77\u8272\uFF0C\u91CD\u590D\u5C45\u591A\u3002\u8D81\u8FD9\u4E2A\u6708\u628A\u5E95\u5B50\u505A\u624E\u5B9E\u3002"
          ],
          \u81EA: [
            "\u53CD\u590D\u63A8\u7FFB\u81EA\u5DF1\uFF0C\u8D8A\u505A\u8D8A\u71AC\u3002\u5148\u5B9A\u7A3F\u518D\u4F18\u5316\uFF0C\u522B\u8FB9\u505A\u8FB9\u6539\u3002",
            "\u8FD9\u4E2A\u6708\u6700\u5BB9\u6613\u6BC1\u5728\u8FD4\u5DE5\u4E0A\u3002\u5B9A\u7A3F\u4E4B\u524D\u4E0D\u505A\u5927\u6539\u3002",
            "\u81EA\u5DF1\u7ED9\u81EA\u5DF1\u52A0\u5DE5\u4F5C\u91CF\uFF1A\u6539\u4E86\u53C8\u6539\u3002\u5148\u4EA4\u4E00\u7248\u51FA\u53BB\u3002"
          ]
        }
      };
      var VAR_ZHI = ["\u5B50", "\u4E11", "\u5BC5", "\u536F", "\u8FB0", "\u5DF3", "\u5348", "\u672A", "\u7533", "\u9149", "\u620C", "\u4EA5"];
      var VAR_PICK = [0, 2, 1, 0, 1, 2, 2, 0, 1, 1, 2, 0];
      var STAGE_GONG = {
        child: {
          // <16 学龄
          \u4E8B\u4E1A\u73AF\u5883: {
            label: "\u5B66\u4E1A\u73AF\u5883",
            \u51B2\u559C: { y: "\u5B66\u4E60\u73AF\u5883\u4F1A\u53D8\uFF0C\u4E14\u662F\u5F80\u597D\u5904\u53D8\uFF1A\u6362\u73ED\u3001\u6362\u8001\u5E08\u3001\u6362\u5B66\u6CD5\uFF0C\u987A\u52BF\u8C03\u6574\u3002", m: "\u5B66\u6821\u7684\u5B89\u6392\u4F1A\u52A8\uFF1A\u8C03\u73ED\u3001\u6362\u8001\u5E08\u3001\u6539\u8BFE\u8868\uFF0C\u8DDF\u7740\u8C03\u6574\u3002" },
            \u51B2\u5FCC: { y: "\u5B66\u4E60\u73AF\u5883\u6709\u53D8\u52A8\u3002\u6362\u73ED\u3001\u6362\u8001\u5E08\u3001\u6362\u8282\u594F\uFF0C\u63D0\u524D\u9002\u5E94\u6BD4\u88AB\u52A8\u63A5\u53D7\u597D\u3002", m: "\u5B66\u6821\u7684\u5B89\u6392\u5BB9\u6613\u53D8\uFF0C\u8282\u594F\u88AB\u6253\u4E71\u3002\u63D0\u524D\u95EE\u6E05\u695A\uFF0C\u522B\u4E34\u65F6\u614C\u3002" },
            \u5211: { y: "\u5B66\u6821\u91CC\u662F\u975E\u591A\u3002\u540C\u5B66\u3001\u5E08\u751F\u4E4B\u95F4\u5BB9\u6613\u6709\u6469\u64E6\uFF1B\u628A\u81EA\u5DF1\u7684\u4E8B\u505A\u597D\uFF0C\u4E0D\u63BA\u548C\u3002", m: "\u540C\u5B66\u4E4B\u95F4\u5BB9\u6613\u95F9\u522B\u626D\uFF0C\u662F\u975E\u591A\u3002\u505A\u597D\u81EA\u5DF1\u7684\uFF0C\u4E0D\u63BA\u548C\u3002" },
            \u5408\u559C: { y: "\u5B66\u4E60\u4E0A\u6709\u4EBA\u5E2E\u3002\u8001\u5E08\u3001\u540C\u5B66\u613F\u610F\u642D\u628A\u624B\uFF0C\u5F00\u53E3\u6C42\u52A9\u5BB9\u6613\u5F97\u5230\u56DE\u5E94\u3002", m: "\u8FD9\u4E2A\u6708\u5F00\u53E3\u95EE\u5C31\u6709\u4EBA\u6559\u3002\u4E0D\u4F1A\u7684\u5F53\u573A\u95EE\uFF0C\u522B\u6512\u7740\u3002" },
            \u5408\u5FCC: { y: "\u6742\u4E8B\u5360\u65F6\u95F4\u3002\u6D3B\u52A8\u3001\u7410\u4E8B\u591A\uFF0C\u6B63\u7ECF\u529F\u8BFE\u5BB9\u6613\u88AB\u6324\u6389\u3002", m: "\u6D3B\u52A8\u3001\u6742\u4E8B\u5360\u65F6\u95F4\uFF0C\u529F\u8BFE\u5BB9\u6613\u88AB\u6324\u6389\u3002\u5148\u628A\u5F53\u5929\u8BE5\u505A\u7684\u505A\u5B8C\u3002" },
            \u5BB3: { y: "\u5F53\u5FC3\u80CC\u540E\u7684\u95F2\u8BDD\u3002\u522B\u4EBA\u7684\u8BAE\u8BBA\u5BB9\u6613\u5F71\u54CD\u5FC3\u60C5\uFF1B\u8BDD\u8BF4\u6E05\u695A\uFF0C\u522B\u9760\u4F20\u3002", m: "\u80CC\u540E\u5BB9\u6613\u6709\u95F2\u8BDD\u3002\u542C\u5230\u4EC0\u4E48\u5148\u522B\u6025\u7740\u4FE1\u3002" },
            \u4F0F: { y: "\u5B66\u4E60\u539F\u5730\u6253\u8F6C\u3002\u6210\u7EE9\u3001\u72B6\u6001\u53D8\u5316\u4E0D\u5927\uFF1B\u8FD9\u5E74\u9002\u5408\u8865\u57FA\u7840\u3002", m: "\u8FDB\u6B65\u4E0D\u660E\u663E\uFF0C\u770B\u7740\u50CF\u539F\u5730\u8E0F\u6B65\u3002\u8FD9\u4E2A\u6708\u8865\u57FA\u7840\u6700\u5212\u7B97\u3002" },
            \u81EA: { y: "\u5B66\u4E60\u4E0A\u81EA\u5DF1\u8DDF\u81EA\u5DF1\u8F83\u52B2\u3002\u5BB9\u6613\u94BB\u725B\u89D2\u5C16\u3001\u71AC\u591C\u6B7B\u6491\u3002", m: "\u5BB9\u6613\u8DDF\u81EA\u5DF1\u8F83\u52B2\u3001\u71AC\u591C\u6B7B\u6491\u3002\u65E9\u70B9\u7761\uFF0C\u7B2C\u4E8C\u5929\u53CD\u800C\u5FEB\u3002" }
          },
          \u4F5C\u54C1\u9879\u76EE: {
            label: "\u529F\u8BFE\u5174\u8DA3",
            \u51B2\u559C: { y: "\u624B\u4E0A\u7684\u529F\u8BFE\u3001\u5174\u8DA3\u6709\u8C03\u6574\uFF0C\u8C03\u5B8C\u66F4\u987A\u3002", m: "\u624B\u4E0A\u7684\u8BA1\u5212\u8981\u6539\uFF0C\u6539\u5B8C\u66F4\u987A\u3002" },
            \u51B2\u5FCC: { y: "\u8BA1\u5212\u5BB9\u6613\u53D8\u3002\u62A5\u7684\u73ED\u3001\u51C6\u5907\u7684\u6BD4\u8D5B\u53EF\u80FD\u6709\u8C03\u6574\u3002", m: "\u62A5\u7684\u73ED\u3001\u51C6\u5907\u7684\u4E8B\u5BB9\u6613\u53D8\u3002\u7559\u70B9\u4F59\u5730\uFF0C\u522B\u6392\u592A\u6EE1\u3002" },
            \u5211: { y: "\u505A\u4E8B\u8D39\u52B2\u3002\u529F\u8BFE\u3001\u4F5C\u54C1\u53CD\u590D\u6539\uFF0C\u6025\u4E0D\u5F97\u3002", m: "\u4F5C\u4E1A\u3001\u4F5C\u54C1\u6765\u56DE\u6539\uFF0C\u8FDB\u5EA6\u6162\u3002\u4E00\u4EF6\u505A\u5B8C\u518D\u770B\u4E0B\u4E00\u4EF6\u3002" },
            \u5408\u559C: { y: "\u6709\u6210\u679C\u3002\u4F5C\u4E1A\u3001\u6BD4\u8D5B\u3001\u4F5C\u54C1\u80FD\u51FA\u4E1C\u897F\u3002", m: "\u8FD9\u4E2A\u6708\u80FD\u6536\u5C3E\u3002\u624B\u4E0A\u7684\u4F5C\u54C1\u3001\u6BD4\u8D5B\u505A\u5F97\u5B8C\u3002" },
            \u5408\u5FCC: { y: "\u4E8B\u60C5\u5806\u7740\u6536\u4E0D\u4E86\u5C3E\u3002\u644A\u5B50\u522B\u94FA\u592A\u5927\u3002", m: "\u5F00\u5934\u591A\u3001\u6536\u5C3E\u5C11\u3002\u5148\u5B8C\u6210\u4E00\u4EF6\uFF0C\u518D\u5F00\u65B0\u7684\u3002" },
            \u5BB3: { y: "\u5F53\u5FC3\u767D\u505A\u5DE5\u3002\u4F5C\u4E1A\u3001\u4F5C\u54C1\u5B58\u597D\u3001\u7559\u5E95\u3002", m: "\u4E1C\u897F\u5BB9\u6613\u4E22\u3001\u767D\u505A\u5DE5\u3002\u505A\u5B8C\u5C31\u5B58\u597D\u3001\u4EA4\u6E05\u695A\u3002" },
            \u4F0F: { y: "\u8FDB\u5C55\u6162\u3002\u9002\u5408\u628A\u4F1A\u7684\u7EC3\u719F\uFF0C\u4E0D\u6025\u7740\u52A0\u65B0\u7684\u3002", m: "\u8FDB\u5EA6\u6162\uFF0C\u65B0\u4E1C\u897F\u5B66\u4E0D\u52A8\u3002\u628A\u4F1A\u7684\u7EC3\u719F\u6700\u5212\u7B97\u3002" },
            \u81EA: { y: "\u5BB9\u6613\u8DDF\u81EA\u5DF1\u8FC7\u4E0D\u53BB\u3002\u53CD\u590D\u63A8\u7FFB\u91CD\u6765\uFF0C\u522B\u71AC\u57AE\u8EAB\u4F53\u3002", m: "\u53CD\u590D\u63A8\u7FFB\u91CD\u6765\uFF0C\u8D8A\u505A\u8D8A\u7D2F\u3002\u5148\u505A\u5B8C\u518D\u6539\u3002" }
          },
          \u957F\u8F88\u5BB6\u5B85: {
            label: "\u5BB6\u91CC",
            \u51B2\u559C: { y: "\u5BB6\u91CC\u6709\u53D8\u52A8\uFF0C\u53D8\u5B8C\u66F4\u5B89\u7A33\u3002", m: "\u5BB6\u91CC\u6709\u53D8\u52A8\uFF0C\u53D8\u5B8C\u66F4\u597D\u3002" },
            \u51B2\u5FCC: { y: "\u5BB6\u91CC\u4E8B\u591A\uFF1A\u642C\u5BB6\u3001\u5927\u4EBA\u5FD9\u3001\u6765\u56DE\u8DD1\uFF0C\u4F60\u4E5F\u4F1A\u88AB\u5E26\u7740\u52A8\u3002", m: ["\u5BB6\u91CC\u8FD9\u4E2A\u6708\u4E8B\u591A\uFF0C\u4F60\u4E5F\u4F1A\u88AB\u5E26\u7740\u8DD1\u3002", "\u5BB6\u91CC\u7684\u5B89\u6392\u4F1A\u53D8\uFF0C\u8DDF\u7740\u8C03\u6574\u3002"] },
            \u5211: { y: "\u5BB6\u91CC\u6C14\u6C1B\u7D27\uFF0C\u5927\u4EBA\u4E4B\u95F4\u5BB9\u6613\u6709\u4E89\u6267\u3002\u4E0D\u662F\u4F60\u7684\u9519\uFF0C\u522B\u5F80\u81EA\u5DF1\u8EAB\u4E0A\u63FD\u3002", m: ["\u5BB6\u91CC\u6C14\u6C1B\u7D27\uFF0C\u5BB9\u6613\u542C\u5230\u4E89\u6267\u3002\u4E0D\u662F\u4F60\u7684\u9519\u3002", "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u5BB9\u6613\u5435\u3002\u8EB2\u5F00\u5F53\u4E0B\uFF0C\u7B49\u6C14\u8FC7\u4E86\u518D\u8BF4\u3002"] },
            \u5408\u559C: { y: "\u5BB6\u91CC\u548C\u987A\uFF0C\u5927\u4EBA\u8FD9\u8FB9\u597D\u8BF4\u8BDD\u3002\u60F3\u8981\u7684\u3001\u60F3\u53BB\u7684\uFF0C\u8FD9\u5E74\u63D0\u3002", m: ["\u5BB6\u91CC\u597D\u8BF4\u8BDD\u3002\u60F3\u8981\u4EC0\u4E48\u3001\u60F3\u53BB\u54EA\uFF0C\u8FD9\u4E2A\u6708\u63D0\u3002", "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u6C14\u6C1B\u987A\uFF0C\u8DDF\u5927\u4EBA\u5546\u91CF\u4E8B\u5BB9\u6613\u6210\u3002"] },
            \u5408\u5FCC: { y: "\u5BB6\u91CC\u7684\u4E8B\u5360\u65F6\u95F4\uFF0C\u4F60\u7684\u5B89\u6392\u5E38\u88AB\u6253\u4E71\u3002", m: ["\u5BB6\u91CC\u7684\u4E8B\u5360\u65F6\u95F4\uFF0C\u5B89\u6392\u5BB9\u6613\u88AB\u6253\u4E71\u3002", "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u5B89\u6392\u591A\uFF0C\u81EA\u5DF1\u7684\u8BA1\u5212\u7559\u70B9\u4F59\u5730\u3002"] },
            \u5BB3: { y: "\u5BB6\u91CC\u5BB9\u6613\u6709\u8BEF\u4F1A\uFF0C\u5E38\u662F\u8BDD\u4F20\u5C94\u4E86\u3002\u6709\u4E8B\u76F4\u63A5\u8BF4\u3002", m: ["\u8BDD\u4F20\u5C94\u4E86\u5BB9\u6613\u751F\u8BEF\u4F1A\u3002\u6709\u4E8B\u76F4\u63A5\u8DDF\u5927\u4EBA\u8BF4\u3002", "\u8FD9\u4E2A\u6708\u5BB9\u6613\u88AB\u8BEF\u4F1A\u3002\u8BF4\u6E05\u695A\u6BD4\u8D4C\u6C14\u7BA1\u7528\u3002"] },
            \u4F0F: { y: "\u5BB6\u91CC\u8FD8\u662F\u90A3\u4E9B\u8001\u95EE\u9898\uFF0C\u4ECA\u5E74\u6CA1\u4EC0\u4E48\u53D8\u5316\u3002", m: ["\u5BB6\u91CC\u7684\u8001\u95EE\u9898\u53C8\u5192\u5934\u4E86\u3002", "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u8FD8\u662F\u8001\u6837\u5B50\u3002"] },
            \u81EA: { y: "\u5BB9\u6613\u4E3A\u5BB6\u91CC\u7684\u4E8B\u95F7\u5728\u5FC3\u91CC\u3002\u8BF4\u7ED9\u4FE1\u5F97\u8FC7\u7684\u5927\u4EBA\u542C\u3002", m: ["\u5BB9\u6613\u4E3A\u5BB6\u91CC\u7684\u4E8B\u95F7\u7740\u3002\u627E\u4E2A\u4FE1\u5F97\u8FC7\u7684\u5927\u4EBA\u8BF4\u8BF4\u3002", "\u8FD9\u4E2A\u6708\u5FC3\u91CC\u88C5\u7740\u5BB6\u91CC\u7684\u4E8B\u3002\u522B\u4E00\u4E2A\u4EBA\u625B\u3002"] }
          },
          \u5A5A\u59FB\u611F\u60C5: {
            label: "\u670B\u53CB\u76F8\u5904",
            \u51B2\u559C: { y: "\u670B\u53CB\u5708\u4F1A\u6362\u4E00\u6279\uFF0C\u6362\u5F97\u597D\u3002", m: "\u73A9\u5728\u4E00\u8D77\u7684\u4EBA\u4F1A\u6362\u4E00\u6279\u3002" },
            \u51B2\u5FCC: { y: "\u670B\u53CB\u805A\u6563\u3002\u8981\u597D\u7684\u4EBA\u53EF\u80FD\u5206\u5F00\uFF0C\u96BE\u8FC7\u4E00\u9635\u662F\u6B63\u5E38\u7684\u3002", m: "\u548C\u670B\u53CB\u5BB9\u6613\u95F9\u5F00\u53C8\u548C\u597D\uFF0C\u6765\u56DE\u6298\u817E\u3002" },
            \u5211: { y: "\u540C\u4F34\u4E4B\u95F4\u6469\u64E6\u591A\u3002\u6709\u59D4\u5C48\u8981\u8BF4\u51FA\u6765\uFF0C\u522B\u618B\u7740\u3002", m: "\u540C\u4F34\u4E4B\u95F4\u5BB9\u6613\u95F9\u522B\u626D\u3002\u6709\u59D4\u5C48\u5F53\u573A\u8BF4\uFF0C\u522B\u618B\u7740\u3002" },
            \u5408\u559C: { y: "\u5BB9\u6613\u4EA4\u5230\u5408\u5F97\u6765\u7684\u670B\u53CB\u3002", m: "\u8FD9\u4E2A\u6708\u548C\u540C\u4F34\u76F8\u5904\u987A\uFF0C\u5BB9\u6613\u73A9\u5230\u4E00\u8D77\u3002" },
            \u5408\u5FCC: { y: "\u670B\u53CB\u7684\u4E8B\u7275\u626F\u7CBE\u529B\u3002\u522B\u4E3A\u4E86\u5408\u7FA4\u59D4\u5C48\u81EA\u5DF1\u3002", m: "\u670B\u53CB\u7684\u4E8B\u5360\u5FC3\u601D\u3002\u522B\u4E3A\u4E86\u5408\u7FA4\u59D4\u5C48\u81EA\u5DF1\u3002" },
            \u5BB3: { y: "\u5F53\u5FC3\u95F2\u8BDD\u3002\u80CC\u540E\u4F20\u7684\u8BDD\u5BB9\u6613\u4F24\u4EBA\uFF0C\u6709\u4E8B\u5F53\u9762\u95EE\u6E05\u695A\u3002", m: "\u5BB9\u6613\u6709\u95F2\u8BDD\u3002\u5F53\u9762\u95EE\u6E05\u695A\uFF0C\u522B\u81EA\u5DF1\u731C\u3002" },
            \u4F0F\u6210: { y: "\u548C\u8EAB\u8FB9\u4EBA\u7684\u5173\u7CFB\u662F\u8FD9\u5E74\u7684\u4E3B\u7EBF\u3002", m: "\u5FC3\u601D\u5927\u534A\u5728\u540C\u4F34\u8EAB\u4E0A\u3002" },
            \u4F0F\u5C11: { y: "\u548C\u8EAB\u8FB9\u4EBA\u7684\u5173\u7CFB\u662F\u8FD9\u5E74\u7684\u4E3B\u7EBF\u3002", m: "\u5FC3\u601D\u5927\u534A\u5728\u540C\u4F34\u8EAB\u4E0A\u3002" },
            \u5408\u5C11: { y: "\u5BB9\u6613\u7279\u522B\u5728\u610F\u67D0\u4E2A\u4EBA\u3002", m: "\u5BB9\u6613\u7279\u522B\u5728\u610F\u67D0\u4E00\u4E2A\u4EBA\u3002" },
            \u81EA: { y: "\u5BB9\u6613\u81EA\u5DF1\u751F\u95F7\u6C14\u3002\u60F3\u4E0D\u901A\u5C31\u627E\u5927\u4EBA\u8BF4\u8BF4\u3002", m: "\u5BB9\u6613\u4E00\u4E2A\u4EBA\u751F\u95F7\u6C14\u3002\u8BF4\u51FA\u6765\u5C31\u8FC7\u53BB\u4E86\u3002" }
          }
        },
        study: {
          // 16-22 求学 / 起步
          \u4E8B\u4E1A\u73AF\u5883: {
            label: "\u5B66\u4E1A\u73AF\u5883",
            \u51B2\u559C: { y: "\u73AF\u5883\u4F1A\u53D8\uFF0C\u4E14\u662F\u5F80\u4E0A\u8D70\u7684\u53D8\u52A8\uFF1A\u6362\u5B66\u6821\u3001\u6362\u4E13\u4E1A\u3001\u6362\u65B9\u5411\uFF0C\u5927\u80C6\u8BD5\u3002", m: "\u8FD9\u4E2A\u6708\u5B89\u6392\u4F1A\u52A8\uFF0C\u52A8\u5B8C\u66F4\u987A\u3002\u8DDF\u7740\u8C03\u6574\u3002" },
            \u51B2\u5FCC: { y: "\u5B66\u4E1A\u6216\u6240\u5904\u73AF\u5883\u6709\u5927\u53D8\u52A8\u3002\u6362\u5730\u65B9\u3001\u6362\u8282\u594F\u8EB2\u4E0D\u5F00\uFF0C\u4E3B\u52A8\u6311\u65B9\u5411\u6BD4\u88AB\u52A8\u7B49\u597D\u3002", m: "\u5B89\u6392\u5BB9\u6613\u53D8\uFF0C\u8BA1\u5212\u8D76\u4E0D\u4E0A\u3002\u7559\u51FA\u4F59\u91CF\uFF0C\u522B\u628A\u4E8B\u6392\u6EE1\u3002" },
          ...
          \u4F5C\u54C1\u9879\u76EE: {
            label: "\u8BFE\u4E1A\u6210\u679C",
            \u51B2\u559C: { y: "\u624B\u4E0A\u7684\u8BFE\u9898\u3001\u4F5C\u54C1\u5927\u6539\uFF0C\u6539\u540E\u66F4\u987A\u3002", m: "\u624B\u4E0A\u7684\u8BFE\u9898\u3001\u4F5C\u54C1\u8981\u6539\uFF0C\u6539\u5B8C\u66F4\u987A\u3002" },
            \u51B2\u5FCC: { y: "\u8BA1\u5212\u53D8\u52A8\u3002\u8BBA\u6587\u3001\u8BFE\u9898\u3001\u51C6\u5907\u4E2D\u7684\u4E8B\u5BB9\u6613\u8C03\u6574\uFF1B\u4E3B\u52A8\u6539\u6BD4\u88AB\u52A8\u7B49\u597D\u3002", m: "\u65B9\u5411\u5BB9\u6613\u53CD\u590D\u3002\u5148\u7559\u5E95\uFF0C\u518D\u52A8\u65B0\u7248\u672C\u3002" },
            \u5211: { y: "\u78E8\u4EBA\u3002\u53CD\u590D\u4FEE\u6539\u3001\u6765\u56DE\u6253\u56DE\uFF0C\u522B\u8D76\u8FDB\u5EA6\u3002", m: "\u6765\u56DE\u4FEE\u6539\u3001\u53CD\u590D\u6253\u56DE\u3002\u5B9A\u4E00\u6761\u4EA4\u4ED8\u7EBF\uFF0C\u522B\u65E0\u9650\u6539\u3002" },
            \u5408\u559C: { y: "\u6709\u6210\u679C\u3002\u4F5C\u54C1\u3001\u8BFE\u9898\u80FD\u843D\u5730\u3002", m: "\u8FD9\u4E2A\u6708\u80FD\u6536\u5C3E\u3002\u6401\u7740\u7684\u90A3\u4EF6\u505A\u5F97\u5B8C\u3002" },
            \u5408\u5FCC: { y: "\u6536\u5C3E\u62D6\u62C9\u3001\u644A\u5B50\u94FA\u5F97\u5927\u3002", m: "\u644A\u5B50\u94FA\u5F97\u5F00\u3001\u6536\u5C3E\u62D6\u3002\u5148\u7ED3\u4E00\u4EF6\uFF0C\u518D\u5F00\u4E0B\u4E00\u4EF6\u3002" },
            \u5BB3: { y: "\u5F53\u5FC3\u6697\u635F\u3002\u5907\u4EFD\u3001\u7559\u5E95\u3002", m: "\u758F\u6F0F\u51FA\u5728\u6CA1\u4EBA\u76EF\u7684\u5730\u65B9\u3002\u5907\u4EFD\u3001\u6838\u5BF9\u4E00\u904D\u3002" },
            \u4F0F: { y: "\u505C\u5728\u539F\u5730\u3001\u63A8\u8FDB\u6162\u3002\u6253\u78E8\u6BD4\u6269\u5F20\u5408\u9002\u3002", m: "\u8FDB\u5C55\u6162\uFF0C\u9002\u5408\u6253\u78E8\u7EC6\u8282\uFF0C\u4E0D\u9002\u5408\u52A0\u65B0\u7684\u3002" },
            \u81EA: { y: "\u81EA\u6211\u6D88\u8017\u3002\u5BB9\u6613\u53CD\u590D\u63A8\u7FFB\uFF0C\u71AC\u591C\u4F24\u8EAB\u3002", m: "\u53CD\u590D\u63A8\u7FFB\u81EA\u5DF1\u3001\u71AC\u591C\u8D76\u5DE5\u3002\u5148\u5B9A\u7A3F\u518D\u4F18\u5316\u3002" }
          }
        },
        elder: {
          // 60+ 退休 / 生活为主
          \u4E8B\u4E1A\u73AF\u5883: {
            label: "\u65E5\u5E38\u4E8B\u52A1",
            \u51B2\u559C: { y: "\u751F\u6D3B\u5B89\u6392\u4F1A\u53D8\uFF0C\u4E14\u662F\u5F80\u8212\u670D\u91CC\u53D8\uFF1A\u6362\u4F4F\u5904\u3001\u6362\u5708\u5B50\u3001\u6362\u8282\u594F\u90FD\u5408\u9002\u3002", m: "\u65E5\u5B50\u7684\u5B89\u6392\u4F1A\u52A8\uFF0C\u52A8\u5B8C\u66F4\u8212\u670D\u3002" },
            \u51B2\u5FCC: { y: "\u65E5\u5E38\u5B89\u6392\u6709\u53D8\u52A8\u3002\u4F4F\u5904\u3001\u6765\u5F80\u7684\u4EBA\u3001\u4F5C\u606F\u5BB9\u6613\u6539\uFF0C\u65E9\u505A\u51C6\u5907\u3002", m: ["\u5B89\u6392\u5BB9\u6613\u53D8\uFF1A\u51FA\u884C\u3001\u5C31\u533B\u3001\u7EA6\u4EBA\u90FD\u53EF\u80FD\u6539\u671F\u3002\u63D0\u524D\u786E\u8BA4\u4E00\u904D\u3002", "\u8FD9\u4E2A\u6708\u5B9A\u597D\u7684\u4E8B\u5BB9\u6613\u6539\u671F\u3002\u51FA\u95E8\u524D\u5148\u6253\u4E2A\u7535\u8BDD\u95EE\u4E00\u58F0\u3002"] },
            \u5211: { y: "\u4EBA\u60C5\u4E0A\u6709\u6469\u64E6\u3002\u4EB2\u53CB\u3001\u90BB\u91CC\u4E4B\u95F4\u7684\u662F\u975E\uFF0C\u4E0D\u5FC5\u8F83\u771F\u3002", m: ["\u4EB2\u53CB\u90BB\u91CC\u4E4B\u95F4\u5BB9\u6613\u6709\u53E3\u89D2\u3002\u4E0D\u5FC5\u8F83\u771F\uFF0C\u8BA9\u4E00\u6B65\u7701\u5FC3\u3002", "\u8FD9\u4E2A\u6708\u4EBA\u60C5\u4E0A\u6709\u6469\u64E6\u3002\u5C11\u4E89\u4E00\u53E5\uFF0C\u5FC3\u91CC\u5BBD\u4E00\u5929\u3002"] },
            \u5408\u559C: { y: "\u6709\u4EBA\u7167\u5E94\u3002\u5B50\u5973\u3001\u8001\u53CB\u3001\u90BB\u91CC\u5E2E\u5F97\u4E0A\uFF0C\u5F00\u53E3\u5C31\u6709\u4EBA\u5E94\u3002", m: ["\u8FD9\u4E2A\u6708\u6709\u4EBA\u7167\u5E94\u3002\u9700\u8981\u5E2E\u5FD9\u5C31\u5F00\u53E3\uFF0C\u522B\u81EA\u5DF1\u6491\u7740\u3002", "\u5B50\u5973\u3001\u8001\u53CB\u8FD9\u4E2A\u6708\u642D\u5F97\u4E0A\u624B\u3002\u8981\u529E\u7684\u4E8B\u987A\u52BF\u6258\u4E00\u6258\u3002"] },
            \u5408\u5FCC: { y: "\u4EBA\u60C5\u6742\u4E8B\u591A\u3002\u5E94\u916C\u3001\u8DD1\u817F\u5360\u65F6\u95F4\uFF0C\u91CF\u529B\u800C\u884C\u3002", m: ["\u5E94\u916C\u3001\u8DD1\u817F\u7684\u4E8B\u591A\uFF0C\u4F53\u529B\u5403\u7D27\u3002\u91CF\u529B\u800C\u884C\uFF0C\u80FD\u63A8\u7684\u63A8\u3002", "\u8FD9\u4E2A\u6708\u4EBA\u60C5\u5F80\u6765\u5BC6\uFF0C\u8DD1\u52A8\u591A\u3002\u6311\u8981\u7D27\u7684\u53BB\uFF0C\u522B\u52C9\u5F3A\u3002"] },
            \u5BB3: { y: "\u5F53\u5FC3\u95F2\u8BDD\u4E0E\u8BEF\u4F1A\u3002\u8981\u7D27\u7684\u4E8B\u8BF4\u6E05\u695A\uFF0C\u522B\u53EA\u542C\u8F6C\u8FF0\u3002", m: ["\u5BB9\u6613\u542C\u5C94\u3001\u4F20\u5C94\u3002\u8981\u7D27\u7684\u4E8B\u5F53\u9762\u8BF4\u6E05\u695A\u3002", "\u8FD9\u4E2A\u6708\u542C\u6765\u7684\u8BDD\u672A\u5FC5\u51C6\u3002\u81EA\u5DF1\u6838\u4E00\u904D\u518D\u5F53\u771F\u3002"] },
            \u4F0F: { y: "\u65E5\u5B50\u5E73\u6DE1\u5C11\u53D8\u5316\u3002\u9002\u5408\u628A\u4F5C\u606F\u548C\u8EAB\u4F53\u517B\u7A33\u3002", m: ["\u65E5\u5B50\u5E73\u6DE1\uFF0C\u6CA1\u4EC0\u4E48\u53D8\u5316\u3002\u628A\u4F5C\u606F\u517B\u7A33\u6700\u8981\u7D27\u3002", "\u8FD9\u4E2A\u6708\u6CA1\u4EC0\u4E48\u65B0\u4E8B\u3002\u6309\u65F6\u5403\u996D\u7761\u89C9\uFF0C\u6BD4\u4EC0\u4E48\u90FD\u5F3A\u3002"] },
            \u81EA: { y: "\u5BB9\u6613\u81EA\u5DF1\u8DDF\u81EA\u5DF1\u8F83\u52B2\u3002\u60F3\u592A\u591A\u8017\u795E\uFF0C\u51FA\u95E8\u8D70\u8D70\u3002", m: ["\u5BB9\u6613\u60F3\u592A\u591A\u3001\u7761\u4E0D\u5B89\u7A33\u3002\u51FA\u95E8\u8D70\u8D70\uFF0C\u6BD4\u5728\u5BB6\u91CC\u8F6C\u597D\u3002", "\u8FD9\u4E2A\u6708\u5FC3\u91CC\u88C5\u7740\u4E8B\uFF0C\u7761\u4E0D\u8E0F\u5B9E\u3002\u767D\u5929\u591A\u8D70\u52A8\uFF0C\u665A\u4E0A\u597D\u7761\u3002"] }
          },
          \u4F5C\u54C1\u9879\u76EE: {
            label: "\u624B\u8FB9\u4E8B\u52A1",
            \u51B2\u559C: { y: "\u624B\u8FB9\u7684\u5B89\u6392\u6709\u8C03\u6574\uFF0C\u8C03\u5B8C\u66F4\u7701\u5FC3\u3002", m: "\u624B\u8FB9\u7684\u5B89\u6392\u8981\u6539\uFF0C\u6539\u5B8C\u66F4\u7701\u5FC3\u3002" },
            \u51B2\u5FCC: { y: "\u624B\u8FB9\u7684\u4E8B\u5BB9\u6613\u53D8\u3002\u8BA1\u5212\u597D\u7684\u51FA\u884C\u3001\u4FEE\u7F2E\u3001\u5B89\u6392\u53EF\u80FD\u8981\u6539\u3002", m: ["\u8BA1\u5212\u597D\u7684\u4E8B\u5BB9\u6613\u53D8\uFF1A\u51FA\u884C\u3001\u4FEE\u7F2E\u3001\u9884\u7EA6\u3002\u7559\u51FA\u4F59\u5730\u3002", "\u8FD9\u4E2A\u6708\u5B89\u6392\u597D\u7684\u4E8B\u5BB9\u6613\u6539\u3002\u522B\u628A\u4E24\u4EF6\u8981\u7D27\u7684\u6392\u5728\u540C\u4E00\u5929\u3002"] },
            \u5211: { y: "\u7410\u4E8B\u78E8\u4EBA\u3002\u53CD\u590D\u3001\u6765\u56DE\u8DD1\u7684\u4E8B\u591A\uFF0C\u522B\u50AC\u81EA\u5DF1\u3002", m: ["\u7410\u4E8B\u53CD\u590D\u3001\u6765\u56DE\u8DD1\u3002\u5206\u4E24\u5929\u529E\uFF0C\u522B\u6324\u5728\u4E00\u5929\u3002", "\u8FD9\u4E2A\u6708\u7684\u4E8B\u4E00\u8D9F\u529E\u4E0D\u5B8C\u3002\u5E26\u9F50\u4E1C\u897F\u518D\u51FA\u95E8\uFF0C\u5C11\u8DD1\u4E00\u8D9F\u3002"] },
            \u5408\u559C: { y: "\u529E\u5F97\u6210\u3002\u60F3\u529E\u7684\u4E8B\u3001\u60F3\u505A\u7684\u624B\u827A\u80FD\u843D\u5730\u3002", m: ["\u8FD9\u4E2A\u6708\u529E\u5F97\u6210\u3002\u60F3\u529E\u7684\u4E8B\u8D81\u672C\u6708\u529E\u6389\u3002", "\u624B\u8FB9\u6401\u7740\u7684\u4E8B\u8FD9\u4E2A\u6708\u80FD\u4E86\u3002\u6311\u4E00\u4EF6\u5148\u529E\u6389\u3002"] },
            \u5408\u5FCC: { y: "\u4E8B\u60C5\u62D6\u7740\u6536\u4E0D\u4E86\u5C3E\u3002\u4E00\u6B21\u53EA\u529E\u4E00\u4EF6\u3002", m: ["\u4E8B\u60C5\u62D6\u7740\u7ED3\u4E0D\u4E86\u3002\u4E00\u6B21\u53EA\u529E\u4E00\u4EF6\u3002", "\u8FD9\u4E2A\u6708\u4E8B\u60C5\u5806\u7740\uFF0C\u8D8A\u60F3\u4E00\u8D77\u529E\u8D8A\u529E\u4E0D\u5B8C\u3002\u5148\u4E86\u4E00\u4EF6\u3002"] },
            \u5BB3: { y: "\u5F53\u5FC3\u758F\u6F0F\u3002\u8BC1\u4EF6\u3001\u5355\u636E\u3001\u8981\u7D27\u7269\u4EF6\u6536\u597D\u3002", m: ["\u5BB9\u6613\u758F\u6F0F\u3002\u8BC1\u4EF6\u3001\u5355\u636E\u3001\u8981\u7D27\u7269\u4EF6\u653E\u5728\u56FA\u5B9A\u7684\u5730\u65B9\u3002", "\u8FD9\u4E2A\u6708\u5BB9\u6613\u5FD8\u3001\u5BB9\u6613\u4E22\u3002\u51FA\u95E8\u524D\u6E05\u70B9\u4E00\u904D\u3002"] },
            \u4F0F: { y: "\u6CA1\u4EC0\u4E48\u8FDB\u5C55\u3002\u628A\u65E5\u5B50\u8FC7\u987A\u6BD4\u591A\u529E\u4E8B\u91CD\u8981\u3002", m: ["\u8FDB\u5C55\u6162\uFF0C\u6CA1\u4EC0\u4E48\u8D77\u8272\u3002\u6162\u70B9\u6CA1\u5173\u7CFB\u3002", "\u8FD9\u4E2A\u6708\u7167\u65E7\uFF0C\u6CA1\u4EC0\u4E48\u65B0\u8FDB\u5C55\u3002\u4E0D\u5FC5\u6025\u7740\u6539\u3002"] },
            \u81EA: { y: "\u5BB9\u6613\u64CD\u5FC3\u8FC7\u5934\u3002\u60A0\u7740\u70B9\uFF0C\u522B\u71AC\u3002", m: ["\u5BB9\u6613\u64CD\u5FC3\u8FC7\u5934\u3002\u60A0\u7740\u70B9\uFF0C\u522B\u71AC\u591C\u3002", "\u8FD9\u4E2A\u6708\u4E8B\u4E8B\u90FD\u60F3\u81EA\u5DF1\u76EF\u3002\u653E\u4E24\u4EF6\u7ED9\u522B\u4EBA\uFF0C\u8EAB\u4F53\u8981\u7D27\u3002"] }
          },
          \u957F\u8F88\u5BB6\u5B85: {
            label: "\u5BB6\u5B85\u4EB2\u7737",
            \u51B2\u559C: { y: "\u5BB6\u91CC\u6709\u53D8\u52A8\uFF0C\u53D8\u540E\u66F4\u5B89\u3002", m: "\u5BB6\u91CC\u6709\u53D8\u52A8\uFF0C\u53D8\u5B8C\u66F4\u987A\u3002" },
            \u51B2\u5FCC: { y: "\u5BB6\u91CC\u4E8B\u591A\u3002\u4F4F\u5904\u3001\u4EB2\u4EBA\u8EAB\u4F53\u7684\u4E8B\u8981\u5206\u5FC3\u3002", m: "\u5BB6\u91CC\u7684\u4E8B\u5206\u5FC3\uFF1A\u4F4F\u5904\u3001\u4EB2\u4EBA\u8EAB\u4F53\u3002\u63D0\u524D\u6392\u65F6\u95F4\u3002" },
            \u5211: { y: "\u5BB6\u91CC\u4E8B\u6742\u3002\u4EB2\u4EBA\u4E4B\u95F4\u610F\u89C1\u4E0D\u4E00\uFF0C\u8D39\u5FC3\u3002", m: ["\u5BB6\u91CC\u610F\u89C1\u4E0D\u4E00\uFF0C\u8D39\u5FC3\u3002\u5148\u542C\u5B8C\u518D\u7B54\u3002", "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u4E3A\u4E00\u4EF6\u4E8B\u5404\u8BF4\u5404\u8BDD\u3002\u542C\u5B8C\u518D\u5F00\u53E3\uFF0C\u522B\u6025\u7740\u8BC4\u7406\u3002"] },
            \u5408\u559C: { y: "\u5BB6\u5B85\u548C\u987A\u3002\u5B50\u5973\u3001\u4EB2\u7737\u8FD9\u8FB9\u6709\u7167\u5E94\u3002", m: ["\u5BB6\u91CC\u7701\u5FC3\uFF0C\u665A\u8F88\u8FD9\u8FB9\u597D\u8BF4\u8BDD\u3002", "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u548C\u987A\uFF0C\u665A\u8F88\u613F\u610F\u542C\u3002\u8981\u4EA4\u4EE3\u7684\u4E8B\u8D81\u73B0\u5728\u8BF4\u3002"] },
            \u5408\u5FCC: { y: "\u5BB6\u4E8B\u7275\u626F\u591A\u3002\u64CD\u5FC3\u591A\u3001\u8DD1\u52A8\u591A\u3002", m: ["\u5BB6\u4E8B\u7275\u626F\u591A\u3001\u8DD1\u52A8\u591A\u3002\u5206\u4E00\u90E8\u5206\u7ED9\u522B\u4EBA\u3002", "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u7684\u4E8B\u4E00\u4EF6\u63A5\u4E00\u4EF6\uFF0C\u5360\u65F6\u95F4\u3002\u8BA9\u665A\u8F88\u5206\u62C5\u4E00\u4E9B\u3002"] },
            \u5BB3: { y: "\u5BB6\u91CC\u5BB9\u6613\u6709\u8BEF\u4F1A\u3002\u8BDD\u8BF4\u5F00\uFF0C\u522B\u9760\u8F6C\u8FF0\u3002", m: ["\u4E00\u53E5\u8BDD\u4F20\u4E24\u904D\u5C31\u53D8\u5473\u3002\u76F4\u63A5\u95EE\u5F53\u4E8B\u4EBA\u3002", "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u5BB9\u6613\u8BEF\u4F1A\u3002\u6709\u8BDD\u76F4\u63A5\u5BF9\u5F53\u4E8B\u4EBA\u8BF4\u3002"] },
            \u4F0F: { y: "\u5BB6\u91CC\u7684\u8001\u95EE\u9898\u8FD8\u662F\u90A3\u4E9B\u3002", m: ["\u8001\u95EE\u9898\u53C8\u5192\u5934\uFF0C\u8C01\u90FD\u6CA1\u53D8\u3002", "\u8FD9\u4E2A\u6708\u5BB6\u91CC\u8FD8\u662F\u90A3\u51E0\u4EF6\u65E7\u4E8B\uFF0C\u8C01\u4E5F\u6CA1\u9000\u4E00\u6B65\u3002"] },
            \u81EA: { y: "\u4E3A\u5BB6\u91CC\u7684\u4E8B\u64CD\u5FC3\u8FC7\u5934\u3002", m: ["\u4E3A\u5BB6\u91CC\u7684\u4E8B\u64CD\u5FC3\u8FC7\u5934\u3002\u7BA1\u5F97\u4F4F\u7684\u7BA1\uFF0C\u7BA1\u4E0D\u4F4F\u7684\u5148\u653E\u3002", "\u8FD9\u4E2A\u6708\u66FF\u5BB6\u91CC\u60AC\u7740\u5FC3\uFF0C\u4E8B\u5374\u4E0D\u5728\u4F60\u624B\u4E0A\u3002\u5C11\u60F3\u4E00\u70B9\u3002"] }
          }
        }
      };
      ...
      var SHEN_TEXT = {
        \u7EA2\u9E3E\u6210: "\u7EA2\u9E3E\u5165\u547D\u3002\u611F\u60C5\u3001\u5BB6\u4E8B\u4E0A\u6709\u559C\u6C14\u7684\u4E00\u5E74\u3002",
        \u7EA2\u9E3E\u5C11: "\u7EA2\u9E3E\u5165\u547D\u3002\u611F\u60C5\u4E0A\u7684\u5FC3\u601D\u591A\u3001\u7F18\u5206\u52A8\u3002",
        \u5929\u559C: "\u5929\u559C\u5165\u547D\u3002\u5BB6\u91CC\u5BB9\u6613\u6709\u987A\u5FC3\u7684\u559C\u6C14\u3002",
        \u9A7F\u9A6C: "\u9A7F\u9A6C\u4E4B\u5E74\u3002\u8D70\u52A8\u3001\u53D8\u52A8\u591A\uFF0C\u8FD9\u5E74\u52A8\u6BD4\u5B88\u5F3A\u3002",
        \u6587\u660C: "\u6587\u660C\u4E4B\u5E74\u3002\u8FDB\u4FEE\u3001\u957F\u672C\u4E8B\u987A\uFF0C\u8981\u7528\u529F\u7684\u4E8B\u653E\u8FD9\u5E74\u3002",
        \u6843\u82B1: "\u6843\u82B1\u4E4B\u5E74\u3002\u5F02\u6027\u7F18\u3001\u793E\u4EA4\u660E\u663E\u53D8\u65FA\u3002",
        \u534E\u76D6: "\u534E\u76D6\u4E4B\u5E74\u3002\u9002\u5408\u6C89\u6DC0\u4FEE\u5B66\uFF0C\u793E\u4EA4\u6DE1\u3002",
      ...
      var SHEN_STAGE = {
        child: {
          \u7984\u795E: "\u5E95\u6C14\u8DB3\u7684\u4E00\u5E74\u3002\u505A\u4E8B\u6709\u51C6\u5934\uFF0C\u60F3\u8981\u7684\u4E1C\u897F\u4E89\u5F97\u5230\u3002",
          \u7984\u9A6C: "\u8D70\u52A8\u4E2D\u5F97\u5229\u3002\u6362\u73AF\u5883\u3001\u51FA\u8FDC\u95E8\u90FD\u987A\u3002",
          \u9A7F\u9A6C: "\u8D70\u52A8\u591A\u7684\u4E00\u5E74\u3002\u8F6C\u5B66\u3001\u642C\u5BB6\u3001\u51FA\u8FDC\u95E8\u7684\u4E8B\u5BB9\u6613\u78B0\u4E0A\u3002",
          \u6587\u660C: "\u8BFB\u4E66\u987A\u7684\u4E00\u5E74\u3002\u5B66\u65B0\u4E1C\u897F\u5FEB\uFF0C\u8BE5\u7528\u529F\u7684\u4E8B\u653E\u8FD9\u5E74\u3002",
          \u6843\u82B1: "\u4EBA\u7F18\u65FA\u7684\u4E00\u5E74\u3002\u8D70\u5230\u54EA\u513F\u90FD\u6709\u4EBA\u613F\u610F\u4E00\u8D77\u73A9\u3002",
          \u534E\u76D6: "\u559C\u6B22\u72EC\u5904\u7684\u4E00\u5E74\u3002\u9002\u5408\u9759\u4E0B\u5FC3\u94BB\u4E00\u6837\u559C\u6B22\u7684\u4E8B\u3002",
          \u5929\u4E59: "\u6709\u4EBA\u62A4\u7740\u7684\u4E00\u5E74\u3002\u9047\u5230\u96BE\u5904\u603B\u6709\u4EBA\u5E2E\u4E00\u628A\u3002",
          \u7EA2\u9E3E\u6210: "\u4EBA\u7F18\u597D\u3001\u5BB6\u91CC\u6709\u559C\u6C14\u7684\u4E00\u5E74\u3002",
          \u7EA2\u9E3E\u5C11: "\u4EBA\u7F18\u597D\u3001\u5BB6\u91CC\u6709\u559C\u6C14\u7684\u4E00\u5E74\u3002",
          \u5929\u559C: "\u5BB6\u91CC\u5BB9\u6613\u6709\u987A\u5FC3\u7684\u559C\u4E8B\u3002"
        },
        elder: {
          \u7984\u795E: "\u624B\u5934\u5BBD\u88D5\u3001\u8EAB\u4F53\u6709\u5E95\u7684\u4E00\u5E74\u3002",
          \u7984\u9A6C: "\u8D70\u52A8\u4E2D\u5F97\u5229\u3002\u51FA\u95E8\u3001\u6362\u4E2A\u4F4F\u5904\u90FD\u987A\u3002",
          \u9A7F\u9A6C: "\u8D70\u52A8\u591A\u7684\u4E00\u5E74\u3002\u51FA\u884C\u3001\u63A2\u4EB2\u3001\u6362\u4F4F\u5904\u7684\u4E8B\u5BB9\u6613\u78B0\u4E0A\u3002",
          \u6587\u660C: "\u9002\u5408\u5B66\u70B9\u65B0\u4E1C\u897F\u3001\u5199\u70B9\u4EC0\u4E48\u7684\u4E00\u5E74\u3002",
          \u6843\u82B1: "\u4EBA\u7F18\u65FA\u7684\u4E00\u5E74\u3002\u8001\u53CB\u65B0\u4EA4\u90FD\u70ED\u95F9\u3002",
          \u534E\u76D6: "\u6E05\u9759\u7684\u4E00\u5E74\u3002\u9002\u5408\u517B\u6027\u3001\u505A\u70B9\u9759\u5FC3\u7684\u4E8B\u3002",
          \u5929\u4E59: "\u8D35\u4EBA\u660E\u663E\u3002\u6C42\u4EBA\u529E\u4E8B\u987A\uFF0C\u96BE\u4E8B\u6709\u4EBA\u63A5\u3002",
          \u7EA2\u9E3E\u6210: "\u5BB6\u91CC\u6709\u559C\u6C14\u7684\u4E00\u5E74\u3002",
          \u7EA2\u9E3E\u5C11: "\u5BB6\u91CC\u6709\u559C\u6C14\u7684\u4E00\u5E74\u3002",
          \u5929\u559C: "\u5BB6\u91CC\u5BB9\u6613\u6709\u987A\u5FC3\u7684\u559C\u6C14\u3002"
      ...
      var SHEN_TEXT_MONTH = {
        ...
        \u5929\u4E59: ["\u6C42\u4EBA\u529E\u4E8B\u987A\uFF0C\u96BE\u5904\u6709\u4EBA\u63A5\u3002\u8BE5\u5F00\u53E3\u5C31\u5F00\u53E3\u3002", "\u8FD9\u4E2A\u6708\u6709\u4EBA\u80AF\u642D\u624B\u3002\u5F00\u53E3\u6C42\u52A9\u6BD4\u81EA\u5DF1\u95F7\u5934\u505A\u5FEB\u3002"],
        \u7984\u795E: "\u5E95\u6C14\u8DB3\uFF0C\u672C\u4E1A\u4E0A\u4F7F\u5F97\u4E0A\u52B2\u3002",
        \u7984\u9A6C: "\u52A8\u8D77\u6765\u5C31\u6709\u8FDB\u8D26\uFF0C\u522B\u5728\u539F\u5730\u7B49\u3002"
      };
      var SHEN_MONTH_STAGE = {
        child: {
          \u7984\u795E: "\u505A\u4E8B\u6709\u51C6\u5934\uFF0C\u624B\u4E0A\u7684\u4E8B\u62FF\u5F97\u7A33\u3002",
          \u7984\u9A6C: "\u51FA\u95E8\u8D70\u52A8\u987A\uFF0C\u8DD1\u4E00\u8D9F\u6709\u6536\u83B7\u3002",
          \u9A7F\u9A6C: "\u8D70\u52A8\u53D8\u591A\uFF0C\u5750\u4E0D\u4F4F\u662F\u6B63\u5E38\u7684\u3002",
      ...
      var GONG_HEAVY = {
        work: {
          ...
          \u4E8B\u4E1A\u73AF\u5883: "\u5DE5\u4F5C\u8FD9\u6761\u7EBF\u4ECA\u5E74\u52A8\u5F97\u5389\u5BB3\uFF1A\u4F4D\u7F6E\u3001\u8282\u594F\u3001\u4EBA\u4E8B\u90FD\u8981\u91CD\u6392\u3002\u65E9\u70B9\u81EA\u5DF1\u6311\u65B9\u5411\uFF0C\u6BD4\u7B49\u7740\u88AB\u5B89\u6392\u597D\u3002",
        ...
        study: {
          ...
          \u4E8B\u4E1A\u73AF\u5883: "\u5B66\u4E1A\u8FD9\u6761\u7EBF\u4ECA\u5E74\u52A8\u5F97\u5389\u5BB3\uFF1A\u73AF\u5883\u3001\u65B9\u5411\u3001\u8282\u594F\u90FD\u8981\u91CD\u6392\u3002\u65E9\u70B9\u81EA\u5DF1\u6311\u65B9\u5411\uFF0C\u6BD4\u7B49\u7740\u88AB\u5B89\u6392\u597D\u3002",
          \u5A5A\u59FB\u611F\u60C5: "\u611F\u60C5\u4ECA\u5E74\u662F\u4E3B\u7EBF\uFF0C\u8D77\u843D\u90FD\u5927\u3002\u5927\u51B3\u5B9A\u522B\u5728\u60C5\u7EEA\u4E0A\u505A\uFF0C\u4F46\u4E5F\u522B\u5F53\u6CA1\u8FD9\u56DE\u4E8B\u3002",
        ...
        child: {
          ...
          \u4E8B\u4E1A\u73AF\u5883: "\u5B66\u6821\u8FD9\u6761\u7EBF\u4ECA\u5E74\u52A8\u5F97\u5927\uFF1A\u73AF\u5883\u3001\u8001\u5E08\u3001\u8282\u594F\u90FD\u53EF\u80FD\u53D8\u3002\u8DDF\u7740\u8C03\u6574\uFF0C\u522B\u81EA\u5DF1\u625B\u3002",
      ...
      function gongShenSignals(chart, subjectZhi, age, favVec, dayWx, dayGan, label) {
        ...
        const vi = Math.max(0, VAR_ZHI.indexOf(subjectZhi));
        const one = (v) => Array.isArray(v) ? v[VAR_PICK[vi] % v.length] : v;
        const SH = (k) => one(isMonth ? (SHEN_MONTH_STAGE[stage] || {})[k] || SHEN_TEXT_MONTH[k] || SHEN_TEXT[k] : (SHEN_STAGE[stage] || {})[k] || SHEN_TEXT[k]);
        const pick = (gong) => {
        ...
        for (const [name0, idx, sh] of GONGS) {
          ...
          if (CHONG[subjectZhi] === zhi) {
            ...
            const pos = favSign(dayWx, favVec, hwx, hz) === "\u559C";
            const txt = idx === 2 && age < 22 ? P.\u5408\u5C11 : pos ? P.\u5408\u559C : P.\u5408\u5FCC;
            push(60, `\u3010${name}\u3011${txt}`, `${label}${subjectZhi}\u5408${gongLabel}${zhi}`, "\u5408\xB7" + sh);
          } else {
            const ban = SANHE.find((g) => g.trio.includes(subjectZhi) && g.trio.includes(zhi) && subjectZhi !== zhi && (g.wang === subjectZhi || g.wang === zhi));
            if (ban) {
              const pos = favSign(dayWx, favVec, ban.wx, null) === "\u559C";
              const txt = idx === 2 && age < 22 ? P.\u5408\u5C11 : pos ? P.\u5408\u559C : P.\u5408\u5FCC;
      ...
      function studentize(signals, age) {
        ...
        return signals.map((g) => {
          ...
          if (t.startsWith("\u3010\u4E8B\u4E1A\u73AF\u5883\u3011")) {
            t = t.replace("\u3010\u4E8B\u4E1A\u73AF\u5883\u3011", "\u3010\u5B66\u4E1A\u73AF\u5883\u3011").replace(/工作或环境大变动。换岗、换地方、换节奏/, "\u5B66\u4E1A\u73AF\u5883\u5927\u53D8\u52A8\u3002\u8F6C\u5B66\u3001\u5347\u5B66\u3001\u6362\u73AF\u5883").replace(/工作里/g, "\u5B66\u6821\u91CC").replace(/想换想升，这年开口合适/, "\u5347\u5B66\u62E9\u6821\u8FD9\u7C7B\u4E8B\uFF0C\u8FD9\u5E74\u987A").replace(/换岗、换地方，大胆换/, "\u8F6C\u5B66\u5347\u5B66\u6362\u73AF\u5883\uFF0C\u8DDF\u7740\u8D70\u5373\u53EF").replace(/工作/g, "\u5B66\u4E1A");
          }
          return { ...g, text: t };
        });
      }
      function liuNian2(mj, chart, year, yGan, yZhi, dyn) {
        ...
        if (dy && dy.startYear === year)
          push(95, SUIYUN_TEXT.\u6362\u6321, `${year}\u5E74\u8D77\u8D70${dy.gan}${dy.zhi}\u5927\u8FD0`, "\u6362\u6321");
      ...
      var MONTH_TYPE = {
        \u6B63\u5B98: { \u559C: ["\u540D\u5206\u6708", "\u540D\u5206\u3001\u6B63\u4E8B\u4E0A\u987A\uFF0C\u8BE5\u8C08\u7684\u8C08\u3002"], \u5FCC: ["\u53D7\u5236\u6708", "\u89C4\u77E9\u591A\u3001\u88AB\u7BA1\u7740\uFF0C\u6309\u6D41\u7A0B\u8D70\u3002"], \u5E73: ["\u672C\u5206\u6708", "\u7167\u7AE0\u529E\u4E8B\u5373\u53EF\uFF0C\u673A\u4F1A\u5230\u4E86\u81EA\u7136\u8F6E\u5230\u3002"] },
        \u4E03\u6740: { \u559C: ["\u653B\u575A\u6708", "\u786C\u4E8B\u8FD9\u6708\u5543\u5F97\u52A8\u3002"], \u5FCC: ["\u5403\u52B2\u6708", "\u538B\u529B\u96C6\u4E2D\uFF0C\u5148\u7A33\u4F4F\u624B\u91CC\u7684\u3002"], \u5E73: ["\u625B\u4E8B\u6708", "\u62C5\u5B50\u6709\uFF0C\u538B\u5F97\u4F4F\uFF0C\u6311\u8981\u7D27\u7684\u625B\u3002"] },
        \u6B63\u5370: { \u559C: ["\u6587\u4E66\u6708", "\u6587\u4E66\u3001\u5B66\u4E60\u4E0A\u7684\u4E8B\u987A\u3002"], \u5FCC: ["\u8D39\u5FC3\u6708", "\u624B\u7EED\u62D6\u6C93\uFF0C\u6587\u4EF6\u591A\u6838\u5BF9\u3002"], \u5E73: ["\u79EF\u7D2F\u6708", "\u5B66\u7684\u3001\u529E\u7684\u90FD\u5E73\u987A\uFF0C\u8FDB\u5EA6\u6162\u4E5F\u7B97\u6570\u3002"] },
        \u504F\u5370: { \u559C: ["\u94BB\u7814\u6708", "\u5F88\u9002\u5408\u6C89\u4E0B\u6765\u5B66\u4E1C\u897F\u3002"], \u5FCC: ["\u95F7\u6708", "\u88AB\u5B89\u6392\u7684\u4E8B\u591A\uFF0C\u5FC3\u91CC\u5835\u3002"], \u5E73: ["\u9759\u4FEE\u6708", "\u5916\u5934\u52A8\u9759\u5C11\uFF0C\u9002\u5408\u78E8\u7EC6\u624B\u827A\u3002"] },
        \u6B63\u8D22: { \u559C: ["\u8FDB\u8D26\u6708", "\u8C08\u94B1\u3001\u6536\u6B3E\u987A\u3002"], \u5FCC: ["\u7834\u8D39\u6708", "\u5F00\u9500\u96C6\u4E2D\uFF0C\u5927\u989D\u7F13\u4E00\u7F13\u3002"], \u5E73: ["\u5E73\u8FDB\u6708", "\u6536\u5165\u6309\u90E8\u5C31\u73ED\uFF0C\u8BB0\u8D26\u7559\u7ED3\u4F59\u3002"] },
        \u504F\u8D22: { \u559C: ["\u6D3B\u94B1\u6708", "\u5916\u5FEB\u673A\u4F1A\u591A\uFF0C\u89C1\u597D\u5C31\u6536\u3002"], \u5FCC: ["\u6563\u8D22\u6708", "\u94B1\u8FC7\u624B\u7559\u4E0D\u4F4F\u3002"], \u5E73: ["\u5C0F\u673A\u6708", "\u96F6\u661F\u673A\u4F1A\u6709\uFF0C\u987A\u624B\u63A5\uFF0C\u4E0D\u6539\u4E3B\u7EBF\u3002"] },
        \u98DF\u795E: { \u559C: ["\u8212\u5C55\u6708", "\u8868\u8FBE\u51FA\u6D3B\u987A\uFF0C\u5FC3\u60C5\u677E\u3002"], \u5FCC: ["\u677E\u52B2\u6708", "\u5BB9\u6613\u6563\uFF0C\u8BBE\u4E2A\u622A\u6B62\u65E5\u3002"], \u5E73: ["\u81EA\u5728\u6708", "\u5FC3\u60C5\u677E\uFF0C\u5B89\u6392\u4E00\u4EF6\u60F3\u505A\u7684\u4E8B\u3002"] },
        \u4F24\u5B98: { \u559C: ["\u9732\u8138\u6708", "\u4F5C\u54C1\u60F3\u6CD5\u62FF\u51FA\u6765\u89C1\u4EBA\u3002"], \u5FCC: ["\u53E3\u820C\u6708", "\u8BDD\u8FC7\u8111\u518D\u8BF4\uFF0C\u5173\u952E\u4E8B\u7559\u75D5\u3002"], \u5E73: ["\u8868\u8FBE\u6708", "\u60F3\u6CD5\u591A\uFF0C\u91CD\u8981\u573A\u5408\u8BDD\u5148\u8FC7\u8111\u3002"] },
        \u6BD4\u80A9: { \u559C: ["\u642D\u4F19\u6708", "\u627E\u4EBA\u540C\u505A\u4E8B\uFF0C\u987A\u3002"], \u5FCC: ["\u5206\u8D26\u6708", "\u8D26\u8BF4\u6E05\uFF0C\u60C5\u9762\u653E\u540E\u3002"], \u5E73: ["\u81EA\u7ACB\u6708", "\u4E8B\u60C5\u591A\u9760\u81EA\u5DF1\uFF0C\u642D\u4F19\u5148\u6E05\u8D26\u3002"] },
        \u52AB\u8D22: { \u559C: ["\u4E92\u52A9\u6708", "\u6709\u4EBA\u642D\u628A\u624B\u3002"], \u5FCC: ["\u6F0F\u8D22\u6708", "\u501F\u51FA\u3001\u62C5\u4FDD\u90FD\u8981\u9632\u3002"], \u5E73: ["\u5B88\u5DF1\u6708", "\u4EBA\u60C5\u5F80\u6765\u591A\uFF0C\u501F\u51FA\u62C5\u4FDD\u7167\u65E7\u8C28\u614E\u3002"] }
      };
      var MONTH_TYPE_CHILD = {
        \u6B63\u5B98: { \u559C: ["\u53D7\u8BA4\u53EF\u6708", "\u5B88\u89C4\u77E9\u3001\u80AF\u8868\u73B0\uFF0C\u5BB9\u6613\u88AB\u770B\u89C1\u3002"], \u5FCC: ["\u88AB\u7BA1\u6708", "\u89C4\u77E9\u591A\u3001\u88AB\u76EF\u5F97\u7D27\uFF0C\u6309\u8981\u6C42\u8D70\u3002"], \u5E73: ["\u672C\u5206\u6708", "\u7167\u7740\u8981\u6C42\u505A\uFF0C\u4E0D\u591A\u4E0D\u5C11\u3002"] },
        \u4E03\u6740: { \u559C: ["\u95EF\u5173\u6708", "\u786C\u529F\u8BFE\u8FD9\u6708\u5543\u5F97\u52A8\u3002"], \u5FCC: ["\u5403\u52B2\u6708", "\u538B\u529B\u96C6\u4E2D\uFF0C\u5148\u628A\u624B\u4E0A\u7684\u505A\u5B8C\u3002"], \u5E73: ["\u625B\u4E8B\u6708", "\u62C5\u5B50\u6709\uFF0C\u6311\u8981\u7D27\u7684\u505A\u3002"] },
        \u6B63\u5370: { \u559C: ["\u5F00\u7A8D\u6708", "\u5B66\u4E1C\u897F\u3001\u529E\u624B\u7EED\u90FD\u987A\u3002"], \u5FCC: ["\u8D39\u5FC3\u6708", "\u4F5C\u4E1A\u3001\u6750\u6599\u53CD\u590D\uFF0C\u591A\u68C0\u67E5\u4E24\u904D\u3002"], \u5E73: ["\u79EF\u7D2F\u6708", "\u5B66\u7684\u529E\u7684\u5E73\u987A\uFF0C\u6162\u4E5F\u7B97\u6570\u3002"] },
        \u504F\u5370: { \u559C: ["\u94BB\u7814\u6708", "\u5F88\u9002\u5408\u81EA\u5DF1\u6C89\u4E0B\u6765\u5B66\u3002"], \u5FCC: ["\u95F7\u6708", "\u88AB\u5B89\u6392\u7684\u4E8B\u591A\uFF0C\u5FC3\u91CC\u5835\u3002"], \u5E73: ["\u9759\u4FEE\u6708", "\u5916\u5934\u52A8\u9759\u5C11\uFF0C\u9002\u5408\u7EC3\u719F\u624B\u4E0A\u7684\u3002"] },
        \u6B63\u8D22: { \u559C: ["\u6512\u94B1\u6708", "\u96F6\u82B1\u94B1\u6709\u7ED3\u4F59\u3002"], \u5FCC: ["\u4E71\u82B1\u6708", "\u5F00\u9500\u96C6\u4E2D\uFF0C\u5927\u4EF6\u5148\u7F13\u3002"], \u5E73: ["\u5E73\u8FDB\u6708", "\u96F6\u82B1\u94B1\u6309\u90E8\u5C31\u73ED\uFF0C\u8BB0\u4E2A\u8D26\u3002"] },
        \u504F\u8D22: { \u559C: ["\u610F\u5916\u4E4B\u559C\u6708", "\u96F6\u661F\u597D\u5904\u591A\uFF0C\u89C1\u597D\u5C31\u6536\u3002"], \u5FCC: ["\u7559\u4E0D\u4F4F\u6708", "\u94B1\u8FC7\u624B\u7559\u4E0D\u4F4F\u3002"], \u5E73: ["\u5C0F\u673A\u6708", "\u96F6\u661F\u673A\u4F1A\u6709\uFF0C\u987A\u624B\u63A5\u3002"] },
        \u98DF\u795E: { \u559C: ["\u8212\u5C55\u6708", "\u8868\u8FBE\u3001\u52A8\u624B\u90FD\u987A\uFF0C\u5FC3\u60C5\u677E\u3002"], \u5FCC: ["\u677E\u52B2\u6708", "\u5BB9\u6613\u6563\uFF0C\u5B9A\u4E2A\u622A\u6B62\u65E5\u3002"], \u5E73: ["\u81EA\u5728\u6708", "\u5FC3\u60C5\u677E\uFF0C\u5B89\u6392\u4E00\u4EF6\u60F3\u505A\u7684\u4E8B\u3002"] },
        \u4F24\u5B98: { \u559C: ["\u9732\u8138\u6708", "\u4F5C\u54C1\u3001\u60F3\u6CD5\u62FF\u51FA\u6765\u7ED9\u4EBA\u770B\u3002"], \u5FCC: ["\u53E3\u820C\u6708", "\u8BDD\u8FC7\u8111\u518D\u8BF4\uFF0C\u522B\u4E89\u5634\u3002"], \u5E73: ["\u8868\u8FBE\u6708", "\u60F3\u6CD5\u591A\uFF0C\u91CD\u8981\u573A\u5408\u5148\u60F3\u540E\u8BF4\u3002"] },
        \u6BD4\u80A9: { \u559C: ["\u642D\u4F34\u6708", "\u548C\u540C\u4F34\u4E00\u8D77\u505A\u4E8B\u987A\u3002"], \u5FCC: ["\u5206\u6B67\u6708", "\u4E1C\u897F\u501F\u8FD8\u8BB2\u6E05\uFF0C\u522B\u4E3A\u5C0F\u4E8B\u95F9\u3002"], \u5E73: ["\u81EA\u7ACB\u6708", "\u4E8B\u60C5\u591A\u9760\u81EA\u5DF1\uFF0C\u642D\u4F34\u5148\u8BF4\u6E05\u3002"] },
        \u52AB\u8D22: { \u559C: ["\u4E92\u52A9\u6708", "\u6709\u4EBA\u642D\u628A\u624B\u3002"], \u5FCC: ["\u501F\u51FA\u6708", "\u4E1C\u897F\u3001\u94B1\u501F\u51FA\u53BB\u5BB9\u6613\u56DE\u4E0D\u6765\u3002"], \u5E73: ["\u5B88\u5DF1\u6708", "\u6765\u5F80\u591A\uFF0C\u501F\u51FA\u7167\u65E7\u8C28\u614E\u3002"] }
      };
      function liuYue2(mj, chart, year, mGan, mZhi, yZhi, dyn) {
        ...
        const YJ0 = (k) => (YEAR_YIJI_STAGE[lifeStage(age)] || {})[k] || YEAR_YIJI[k];
        const baseYj = YJ0(yk + xj) || (xj === "\u5E73" && YJ0(yk + "\u559C") && YJ0(yk + "\u5FCC") ? { yi: [YJ0(yk + "\u559C").yi[0]], ji: [YJ0(yk + "\u5FCC").ji[0]] } : { yi: [], ji: [] });
        const yj = composeYiji(baseYj, sorted.slice(0, 4), lifeStage(age));
        return { headline: mt[0], trait: mt[1], signals, yi: yj.yi, ji: yj.ji };
      }
      var DAYUN_HINT = {
        \u6B63\u5B98: "\u540D\u5206\u4E0E\u8D23\u4EFB\u4E3A\u4E3B\u7EBF",
        \u4E03\u6740: "\u538B\u529B\u4E0E\u95EF\u52B2\u5E76\u884C",
  ...
  var require_folk = __commonJS({
    "engine/folk.js"(exports, module) {
      ...
      var LMONTH_CN = ["", "\u6B63\u6708", "\u4E8C\u6708", "\u4E09\u6708", "\u56DB\u6708", "\u4E94\u6708", "\u516D\u6708", "\u4E03\u6708", "\u516B\u6708", "\u4E5D\u6708", "\u5341\u6708", "\u51AC\u6708", "\u814A\u6708"];
      ...
      var DEITY_DESC = [];
      var CONCEPT_DESC = {
        "\u5929\u8D66\u65E5": '\u4E00\u5E74\u4EC5\u7EA65\u20136\u5929\u7684\u9EC4\u5386\u4E0A\u5409\u4E4B\u8FB0\u3002\u53E4\u79F0"\u8D66\u8FC7\u5BA5\u7F6A\u4E4B\u65E5"\u2014\u2014\u5929\u5730\u5F00\u6069\u3001\u767E\u4E8B\u53EF\u4E3A\uFF0C\u5B9C\u7948\u798F\u4FEE\u9020\u3001\u542F\u52A8\u8981\u4E8B\u3001\u548C\u89E3\u91CA\u6028\u3002',
        "\u6708\u6069\u65E5": "\u62E9\u65E5\u5B66\u4E2D\u7684\u6E29\u548C\u5409\u795E\u65E5\uFF0C\u4F20\u7EDF\u89C6\u4E3A\u9002\u5408\u8C08\u4E8B\u3001\u548C\u89E3\u7684\u65E5\u5B50\u3002"
      };
      function descOf(t) {
      ...
      function folkOf(year, month, day) {
        ...
        const mZhi = ec.getMonthZhi();
        const dGan = ec.getDayGan();
        const dZhi = ec.getDayZhi();
        const dGZ = dGan + dZhi;
        const tags = [];
        ...
        return {
          ...
          lunarDay: ld,
          isLeap,
          lunarLabel: (isLeap ? "\u95F0" : "") + LMONTH_CN[lm] + LDAY_CN[ld],
          lunarDayCN: LDAY_CN[ld],
          ganZhi: dGZ,
          wuRi,
          band,
          tags,
      ...
      function upcomingDeities(today, spanDays = 365, maxLv = 2) {
        const out = [];
        for (let i = 0; i < spanDays; i++) {
          const dt = new Date(today.year, today.month - 1, today.day + i);
      ...
      var MODERN_YI = [
        ...
        ["\u4E0A\u4EFB\u5C65\u65B0", ["\u4E0A\u5B98\u8D74\u4EFB", "\u8D74\u4EFB", "\u4E34\u653F\u4EB2\u6C11"]],
        ["\u5C31\u533B\u8C03\u517B", ["\u6C42\u533B", "\u7597\u75C5", "\u9488\u7078", "\u7597\u76EE"]],
        ["\u88C5\u4FEE\u52A8\u5DE5", ["\u52A8\u571F", "\u4FEE\u9020", "\u8D77\u57FA", "\u7AD6\u67F1", "\u4E0A\u6881", "\u76D6\u5C4B", "\u5B89\u95E8", "\u9020\u5C4B"]],
        ["\u7F6E\u529E\u6536\u7EB3", ["\u7EB3\u755C", "\u4FEE\u4ED3\u5E93", "\u5F00\u4ED3\u5E93", "\u5B89\u673A\u68B0", "\u9020\u8F66\u5668"]],
        ["\u683D\u79CD\u517B\u80B2", ["\u683D\u79CD", "\u7267\u517B", "\u6C42\u55E3"]],
        ["\u7406\u53D1\u6E05\u6D01", ["\u6574\u5BB9", "\u5243\u5934", "\u6C90\u6D74", "\u626B\u820D\u5B87", "\u89E3\u9664"]],
        ["\u7948\u798F\u8FD8\u613F", ["\u796D\u7940", "\u7948\u798F", "\u658B\u91AE", "\u5F00\u5149"]],
        ["\u796D\u626B\u5B89\u846C", ["\u5B89\u846C", "\u542F\u6512", "\u4FEE\u575F", "\u7834\u571F", "\u7ACB\u7891"]]
      ];
      ...
      module.exports = { folkOf, upcomingDeities, modernYi, LDAY_CN, LMONTH_CN };
    }
  });

  // engine/content.js
  var require_content = __commonJS({
    "engine/content.js"(exports, module) {
      "use strict";
      var { Solar } = require_lunar();
      var JIEQI = [
        {
          ...
          e: "\u9633\u6C14\u521D\u751F\uFF0C\u4E07\u7269\u59CB\u840C",
          hou: ["\u4E1C\u98CE\u89E3\u51BB", "\u86F0\u866B\u59CB\u632F", "\u9C7C\u965F\u8D1F\u51B0"],
          intro: "\u6625\u4E4B\u59CB\uFF0C\u51AC\u85CF\u4E4B\u6C14\u6E10\u8F6C\u751F\u53D1\u3002\u4E4D\u6696\u8FD8\u5BD2\uFF0C\u9633\u6C14\u59CB\u52A8\u800C\u672A\u76DB\u3002",
          from: "\u65E9\u7761\u65E9\u8D77\uFF0C\u677E\u89E3\u8863\u9886\u8170\u5E26\uFF0C\u8212\u5C55\u5F62\u4F53\u4EE5\u5E94\u751F\u53D1\u4E4B\u6C14\u3002",
          eat: "\u5C11\u9178\u591A\u7518\uFF0C\u517B\u809D\u62A4\u813E\uFF1B\u5B9C\u6625\u82BD\u3001\u97ED\u83DC\u3001\u9999\u83DC\u3001\u8C46\u82BD\u3002",
          food: "\u97ED\u83DC\u7092\u86CB\u2014\u2014\u6E29\u4E2D\u52A9\u9633\u3001\u987A\u5E94\u6625\u5347\uFF1B\u7EA2\u67A3\u67B8\u675E\u8336\u758F\u809D\u5065\u813E\u3002",
          move: "\u6668\u8D77\u6563\u6B65\u3001\u516B\u6BB5\u9526\u300C\u53CC\u624B\u6258\u5929\u300D,\u8212\u5C55\u7B4B\u9AA8\u3001\u7545\u8FBE\u6C14\u8840\u3002",
          mood: "\u5C11\u751F\u6C14\u3001\u628A\u5FC3\u653E\u5BBD\uFF0C\u987A\u7740\u6625\u5929\u90A3\u80A1\u8212\u5C55\u7684\u52B2\u513F\u3002",
          care: "\u300C\u6625\u6342\u300D\u52FF\u6025\u8131\u8863\uFF0C\u91CD\u5728\u62A4\u4F4F\u4E0B\u80CC\u4E0E\u53CC\u8DB3\uFF0C\u9632\u5012\u6625\u5BD2\u3002",
          say: "\u4E00\u5E74\u4E4B\u8BA1\u5728\u4E8E\u6625\u3002"
        },
        {
          name: "\u96E8\u6C34",
          e: "\u96E8\u6DA6\u840C\u751F\uFF0C\u6E7F\u6C14\u6E10\u8D77",
          hou: ["\u736D\u796D\u9C7C", "\u5019\u96C1\u5317", "\u8349\u6728\u840C\u52A8"],
          intro: "\u964D\u6C34\u6E10\u591A\uFF0C\u51B0\u96EA\u6D88\u878D\u3002\u6E7F\u6C14\u59CB\u76DB\uFF0C\u813E\u80C3\u6613\u56F0\u3002",
          from: "\u591C\u5367\u65E9\u8D77\uFF0C\u6DFB\u51CF\u5F97\u5B9C\uFF0C\u7559\u610F\u300C\u5012\u6625\u5BD2\u300D\u83AB\u8D2A\u51C9\u3002",
          eat: "\u5065\u813E\u795B\u6E7F\u3001\u5C11\u9178\u589E\u7518\uFF1B\u5B9C\u5C71\u836F\u3001\u858F\u7C73\u3001\u7EA2\u67A3\u3001\u5C0F\u7C73\u3002",
          food: "\u858F\u7C73\u5C71\u836F\u7CA5\u2014\u2014\u5065\u813E\u5229\u6E7F\u3001\u517B\u62A4\u4E2D\u7126\uFF1B\u9648\u76AE\u7EA2\u67A3\u8336\u7406\u6C14\u548C\u4E2D\u3002",
          move: "\u8212\u7F13\u6563\u6B65\u3001\u4F38\u5C55\u5BFC\u5F15\uFF0C\u5FAE\u52A8\u51FA\u6C57\u4EE5\u5316\u6E7F\u6D4A\u3002",
          mood: "\u522B\u60F3\u592A\u591A\u3001\u5FC3\u653E\u5E73\uFF0C\u60F3\u5F97\u592A\u591A\u4EBA\u4E5F\u7D2F\u3002",
          care: "\u91CD\u5728\u5065\u813E\u5316\u6E7F\uFF0C\u5C11\u98DF\u751F\u51B7\u6CB9\u817B\uFF0C\u62A4\u597D\u813E\u80C3\u8FD0\u5316\u3002",
          say: "\u6625\u96E8\u8D35\u5982\u6CB9\u3002"
        },
        {
          name: "\u60CA\u86F0",
          e: "\u6625\u96F7\u4E4D\u52A8\uFF0C\u86F0\u866B\u59CB\u9192",
          hou: ["\u6843\u59CB\u534E", "\u4ED3\u5E9A\u9E23", "\u9E70\u5316\u4E3A\u9E20"],
          intro: "\u96F7\u52A8\u800C\u767E\u866B\u82CF\uFF0C\u4E07\u7269\u751F\u673A\u52C3\u53D1\u3002\u6C14\u6E29\u56DE\u5347\uFF0C\u4EA6\u591A\u98CE\u71E5\u3002",
          from: "\u65E9\u7761\u65E9\u8D77\uFF0C\u591A\u5230\u6237\u5916\u8212\u5C55\uFF0C\u987A\u9633\u6C14\u4E4B\u5347\u53D1\u3002",
          eat: "\u6E05\u6DE1\u6DA6\u71E5\u3001\u517B\u809D\u5065\u813E\uFF1B\u5B9C\u68A8\u3001\u8702\u871C\u3001\u83E0\u83DC\u3001\u82B9\u83DC\u3002",
          food: "\u51B0\u7CD6\u96EA\u68A8\u2014\u2014\u6DA6\u80BA\u751F\u6D25\u3001\u7F13\u6625\u71E5\uFF1B\u83E0\u83DC\u732A\u809D\u6C64\u517B\u809D\u8865\u8840\u3002",
          move: "\u5FEB\u8D70\u3001\u8E0F\u9752\u3001\u8212\u7B4B\u6D3B\u7EDC\uFF0C\u52A9\u9633\u6C14\u5347\u817E\u3002",
          mood: "\u795E\u6E05\u6C14\u548C\uFF0C\u9632\u300C\u6625\u56F0\u300D\u660F\u6C89\uFF0C\u5B9C\u52A8\u4EE5\u63D0\u795E\u3002",
          care: "\u987A\u809D\u6C14\u5347\u53D1\uFF0C\u5FCC\u90C1\u6012\u538B\u6291\uFF1B\u8FC7\u654F\u4F53\u8D28\u7559\u610F\u82B1\u7C89\u9632\u62A4\u3002",
          say: "\u60CA\u86F0\u4E00\u7281\u571F\uFF0C\u6625\u5206\u5730\u6C14\u901A\u3002"
        },
        {
          name: "\u6625\u5206",
          e: "\u9634\u9633\u76F8\u534A\uFF0C\u663C\u591C\u5747\u5E73",
          hou: ["\u7384\u9E1F\u81F3", "\u96F7\u4E43\u53D1\u58F0", "\u59CB\u7535"],
          intro: "\u663C\u591C\u7B49\u957F\uFF0C\u5BD2\u6691\u5E73\u5206\u3002\u5929\u5730\u9634\u9633\u8C03\u548C\uFF0C\u517B\u751F\u91CD\u5728\u4E00\u4E2A\u300C\u5E73\u300D\u3002",
          from: "\u4F5C\u606F\u89C4\u5F8B\uFF0C\u52A8\u9759\u76F8\u5B9C\uFF0C\u8D77\u5C45\u6709\u5E38\u4EE5\u5E94\u5929\u65F6\u4E4B\u5E73\u3002",
          eat: "\u5BD2\u70ED\u5747\u8861\u3001\u4E0D\u504F\u4E0D\u501A\uFF1B\u5B9C\u65F6\u852C\u3001\u8C46\u5236\u54C1\uFF0C\u5FCC\u8FC7\u5BD2\u8FC7\u70ED\u3002",
          food: "\u8360\u83DC\u8C46\u8150\u7FB9\u2014\u2014\u6E05\u809D\u660E\u76EE\u3001\u5E73\u548C\u6ECB\u517B\uFF1B\u83CA\u82B1\u67B8\u675E\u8336\u6E05\u517B\u809D\u76EE\u3002",
          move: "\u592A\u6781\u3001\u6162\u8DD1\u7B49\u548C\u7F13\u8FD0\u52A8\uFF0C\u4F7F\u6C14\u8840\u5E73\u987A\u3002",
          mood: "\u5E73\u548C\u4E2D\u6B63\uFF0C\u8C03\u7545\u60C5\u7EEA\uFF0C\u4E0D\u4F7F\u5927\u559C\u5927\u6012\u3002",
          care: "\u4EE5\u300C\u5E73\u8861\u300D\u4E3A\u8981\uFF0C\u996E\u98DF\u5BD2\u6E29\u3001\u4F5C\u606F\u52A8\u9759\u7686\u6C42\u5176\u4E2D\u3002",
          say: "\u6625\u5206\u9EA6\u8D77\u8EAB\uFF0C\u4E00\u523B\u503C\u5343\u91D1\u3002"
        },
        {
          name: "\u6E05\u660E",
          e: "\u6C14\u6E05\u666F\u660E\uFF0C\u751F\u673A\u76CE\u7136",
          hou: ["\u6850\u59CB\u534E", "\u7530\u9F20\u5316\u4E3A\u9D3D", "\u8679\u59CB\u89C1"],
          intro: "\u5929\u6E05\u5730\u660E\uFF0C\u8349\u6728\u5410\u7EFF\u3002\u6C14\u5019\u591A\u53D8\u3001\u96E8\u6C34\u589E\u591A\uFF0C\u9633\u6C14\u4E0A\u5347\u3002",
          from: "\u591A\u5230\u6237\u5916\u8E0F\u9752\uFF0C\u8212\u5C55\u9633\u6C14\uFF1B\u96E8\u5929\u9632\u6F6E\uFF0C\u8863\u7269\u5E38\u6362\u3002",
          eat: "\u6E05\u8865\u4E3A\u5B9C\u3001\u67D4\u809D\u517B\u80BA\uFF1B\u5B9C\u65F6\u4EE4\u9752\u852C\u3001\u8360\u83DC\u3001\u83E0\u83DC\u3002",
          food: "\u827E\u8349\u9752\u56E2\u2014\u2014\u65F6\u4EE4\u6E05\u9999\uFF1B\u9A6C\u5170\u5934\u62CC\u9999\u5E72\u6E05\u809D\u5229\u6E7F\u3002",
          move: "\u8E0F\u9752\u90CA\u6E38\u3001\u767B\u9AD8\u8FDC\u773A\uFF0C\u7545\u6000\u8212\u6C14\u3002",
          mood: "\u614E\u7EC8\u8FFD\u8FDC\u800C\u4E0D\u6C89\u6EBA\u54C0\u4F24\uFF0C\u653E\u6000\u81EA\u7136\u4EE5\u8212\u60C5\u5FD7\u3002",
          care: "\u5FC3\u91CC\u522B\u618B\u7740\uFF0C\u8D81\u7740\u8E0F\u9752\u51FA\u53BB\u6563\u6563\u5FC3\uFF0C\u9632\u6625\u5929\u60C5\u7EEA\u4F4E\u843D\u3002",
          say: "\u6E05\u660E\u524D\u540E\uFF0C\u79CD\u74DC\u70B9\u8C46\u3002"
        },
        {
          name: "\u8C37\u96E8",
          e: "\u96E8\u751F\u767E\u8C37\uFF0C\u4E07\u7269\u751F\u957F",
          hou: ["\u840D\u59CB\u751F", "\u9E23\u9E20\u62C2\u5176\u7FBD", "\u6234\u80DC\u964D\u4E8E\u6851"],
          intro: "\u6625\u4E4B\u672B\uFF0C\u96E8\u6DA6\u4E94\u8C37\u3002\u6C14\u6E29\u6E10\u9AD8\u3001\u6E7F\u6C14\u66F4\u91CD\uFF0C\u8FC7\u654F\u591A\u53D1\u3002",
          from: "\u65E9\u8D77\u9632\u6F6E\uFF0C\u9002\u5EA6\u51FA\u6C57\u4EE5\u6392\u6E7F\uFF1B\u7A7A\u6C14\u6E7F\u91CD\u5B9C\u5E38\u901A\u98CE\u3002",
          eat: "\u5065\u813E\u5229\u6E7F\u3001\u67D4\u809D\uFF1B\u5B9C\u9999\u693F\u3001\u858F\u4EC1\u3001\u767D\u6241\u8C46\u3001\u7EFF\u53F6\u83DC\u3002",
          food: "\u9999\u693F\u7092\u86CB\u2014\u2014\u65F6\u4EE4\u8865\u517B\uFF1B\u8D64\u5C0F\u8C46\u858F\u7C73\u6C64\u5065\u813E\u795B\u6E7F\u3002",
          move: "\u8212\u5C55\u8FD0\u52A8\u5FAE\u6C57\u4E3A\u5EA6\uFF0C\u52A9\u6E7F\u6C14\u5916\u6563\u3002",
          mood: "\u8282\u594F\u653E\u7F13\u4E9B\uFF0C\u522B\u8BA9\u81EA\u5DF1\u592A\u7D2F\u3002",
          care: "\u6E7F\u6C14\u5F53\u4EE4\uFF0C\u5065\u813E\u4E3A\u5148\uFF1B\u8FC7\u654F\u4F53\u8D28\u9632\u82B1\u7C89\u3001\u62A4\u597D\u547C\u5438\u3002",
          say: "\u8C37\u96E8\u524D\u540E\uFF0C\u683D\u74DC\u79CD\u8C46\u3002"
        },
        {
          name: "\u7ACB\u590F",
          e: "\u9633\u6C14\u6E10\u76DB\uFF0C\u4E07\u7269\u7E41\u8302",
          hou: ["\u877C\u8748\u9E23", "\u86AF\u8693\u51FA", "\u738B\u74DC\u751F"],
          intro: "\u590F\u4E4B\u59CB\uFF0C\u9633\u6C14\u65E5\u76DB\u3001\u4E07\u7269\u7E41\u8302\u3002\u5FC3\u6C14\u6E10\u65FA\uFF0C\u5B9C\u517B\u5FC3\u3002",
          from: "\u665A\u7761\u65E9\u8D77\uFF0C\u5348\u95F4\u5C0F\u61A9\u534A\u523B\uFF0C\u4EE5\u517B\u5FC3\u795E\u3001\u8865\u9633\u6C14\u3002",
          eat: "\u6E05\u6DE1\u517B\u5FC3\u3001\u5C11\u82E6\u6E05\u706B\uFF1B\u5B9C\u7EA2\u8C46\u3001\u83B2\u5B50\u3001\u5C0F\u9EA6\u3001\u82E6\u74DC\u9002\u91CF\u3002",
          food: "\u83B2\u5B50\u767E\u5408\u7CA5\u2014\u2014\u517B\u5FC3\u5B89\u795E\uFF1B\u7EA2\u8C46\u6C64\u6E05\u5FC3\u5229\u6C34\u3002",
          move: "\u6E05\u6668\u548C\u7F13\u8FD0\u52A8\uFF0C\u907F\u6B63\u5348\u70C8\u65E5\uFF0C\u5FAE\u6C57\u5373\u6B62\u52FF\u5927\u6C57\u3002",
          mood: "\u9759\u5FC3\u6212\u8E81,\u300C\u5FC3\u9759\u81EA\u7136\u51C9\u300D,\u62A4\u517B\u5FC3\u795E\u52FF\u8FC7\u559C\u3002",
          care: "\u590F\u6C14\u901A\u5FC3\uFF0C\u91CD\u5728\u517B\u5FC3\u5B89\u795E\uFF1B\u5348\u7761\u517B\u9633\uFF0C\u51FA\u6C57\u52FF\u8FC7\u3002",
          say: "\u7ACB\u590F\u4E0D\u4E0B\uFF0C\u7281\u8019\u9AD8\u6302\u3002"
        },
        {
          name: "\u5C0F\u6EE1",
          e: "\u9EA6\u7C92\u6E10\u6EE1\uFF0C\u672A\u53CA\u5168\u719F",
          hou: ["\u82E6\u83DC\u79C0", "\u9761\u8349\u6B7B", "\u9EA6\u79CB\u81F3"],
          intro: "\u4E07\u7269\u76C8\u800C\u672A\u6EE1\uFF0C\u590F\u719F\u4F5C\u7269\u59CB\u704C\u6D46\u3002\u6C14\u6E29\u5347\u9AD8\uFF0C\u6E7F\u70ED\u6E10\u663E\u3002",
          from: "\u9632\u6E7F\u9632\u70ED\uFF0C\u8863\u7269\u900F\u6C14\u5438\u6C57\uFF0C\u52FF\u8D2A\u51C9\u9732\u5BBF\u3002",
          eat: "\u6E05\u70ED\u5229\u6E7F\u3001\u5C11\u98DF\u82E6\u5BD2\uFF1B\u5B9C\u82E6\u74DC\u3001\u7EFF\u8C46\u3001\u51AC\u74DC\u3001\u858F\u7C73\u3002",
          food: "\u7EFF\u8C46\u6C64\u2014\u2014\u6E05\u70ED\u6D88\u6691\uFF1B\u51AC\u74DC\u858F\u7C73\u6392\u9AA8\u6C64\u5229\u6C34\u795B\u6E7F\u3002",
          move: "\u6E05\u6668\u6563\u6B65\u3001\u6E38\u6CF3\u7B49\u6E05\u51C9\u8FD0\u52A8\uFF0C\u907F\u6E7F\u70ED\u4E2D\u6691\u3002",
          mood: "\u77E5\u8DB3\u5E38\u4E50,\u300C\u5C0F\u6EE1\u5373\u5B89\u300D,\u4E0D\u6C42\u76C8\u6EE1\u3001\u5FC3\u5883\u5E73\u548C\u3002",
          care: "\u6E7F\u70ED\u5E76\u91CD\uFF0C\u9632\u76AE\u80A4\u6E7F\u75B9\u75AE\u7596\uFF1B\u996E\u98DF\u6E05\u6DE1\u5FCC\u80A5\u7518\u539A\u5473\u3002",
          say: "\u5C0F\u6EE1\u4E0D\u6EE1\uFF0C\u8292\u79CD\u4E0D\u7BA1\u3002"
        },
        {
          name: "\u8292\u79CD",
          e: "\u9EA6\u719F\u5C06\u6536\uFF0C\u519C\u4E8B\u7E41\u5FD9",
          hou: ["\u87B3\u8782\u751F", "\u9D59\u59CB\u9E23", "\u53CD\u820C\u65E0\u58F0"],
          intro: "\u6709\u8292\u4E4B\u8C37\u53EF\u79CD\uFF0C\u590F\u6536\u590F\u79CD\u4E24\u76F8\u5FD9\u3002\u6C14\u5019\u6E7F\u70ED\uFF0C\u6613\u611F\u5026\u6020\u3002",
          from: "\u52E4\u6D17\u52E4\u6362\u3001\u5348\u95F4\u5C0F\u61A9\uFF0C\u9632\u6691\u6E7F\u3001\u89E3\u75B2\u4E4F\u3002",
          eat: "\u6E05\u8865\u751F\u6D25\u3001\u5065\u813E\u5316\u6E7F\uFF1B\u5B9C\u9752\u6885\u3001\u51AC\u74DC\u3001\u4E1D\u74DC\u3001\u858F\u7C73\u3002",
          food: "\u9752\u6885\u996E\u2014\u2014\u751F\u6D25\u5F00\u80C3\uFF1B\u4E1D\u74DC\u7626\u8089\u6C64\u6E05\u70ED\u795B\u6E7F\u3002",
          move: "\u907F\u6691\u65F6\u8FD0\u52A8\uFF0C\u9009\u6E05\u6668\u6216\u508D\u665A\uFF0C\u8865\u8DB3\u6C34\u5206\u3002",
          mood: "\u8C03\u606F\u51CF\u8E81\uFF0C\u52FF\u56E0\u5FD9\u788C\u800C\u5FC3\u70E6\uFF0C\u5FD9\u4E2D\u5077\u95F2\u3002",
          care: "\u6E7F\u70ED\u56F0\u813E\uFF0C\u9632\u300C\u6691\u6E7F\u611F\u5192\u300D;\u52E4\u6362\u8863\u3001\u5E38\u64E6\u6C57\u62A4\u76AE\u80A4\u3002",
          say: "\u8292\u79CD\u5FD9\uFF0C\u9EA6\u4E0A\u573A\u3002"
        },
        {
          name: "\u590F\u81F3",
          e: "\u65E5\u957F\u4E4B\u6781\uFF0C\u9633\u76DB\u9634\u751F",
          hou: ["\u9E7F\u89D2\u89E3", "\u8729\u59CB\u9E23", "\u534A\u590F\u751F"],
          intro: "\u767D\u663C\u6700\u957F\uFF0C\u9633\u6C14\u81F3\u6781\u800C\u4E00\u9634\u59CB\u751F\u3002\u76DB\u590F\u5C06\u4E34\uFF0C\u517B\u9633\u62A4\u9634\u5E76\u91CD\u3002",
          from: "\u665A\u7761\u65E9\u8D77\u3001\u5348\u7761\u517B\u795E\uFF1B\u907F\u70C8\u65E5\u3001\u987E\u62A4\u9633\u6C14\u52FF\u8D2A\u51C9\u3002",
          eat: "\u6E05\u6DE1\u6D88\u6691\u3001\u9002\u98DF\u82E6\u9178\uFF1B\u5B9C\u82E6\u74DC\u3001\u4E4C\u6885\u3001\u7EFF\u8C46\u3001\u83B2\u5B50\u3002",
          food: "\u4E4C\u6885\u6C64\u2014\u2014\u751F\u6D25\u655B\u6C57\u3001\u6D88\u6691\u5F00\u80C3\uFF1B\u82E6\u74DC\u7092\u86CB\u6E05\u5FC3\u964D\u706B\u3002",
          move: "\u5B9C\u9759\u517B\u3001\u548C\u7F13\u5BFC\u5F15\uFF0C\u907F\u514D\u5927\u6C57\u4F24\u9633\u8017\u6C14\u3002",
          mood: "\u9759\u4E0B\u5FC3\u3001\u522B\u4E0A\u706B\uFF0C\u60C5\u7EEA\u8BE5\u53D1\u5C31\u53D1\u51FA\u6765\uFF0C\u4F46\u522B\u8FC7\u5934\u3002",
          care: "\u300C\u51AC\u75C5\u590F\u6CBB\u300D\u4E4B\u65F6\uFF1B\u62A4\u9633\u5FCC\u8FC7\u98DF\u51B0\u51B7\uFF0C\u7A7A\u8C03\u52FF\u5BF9\u8EAB\u76F4\u5439\u3002",
          say: "\u590F\u81F3\u4E09\u5E9A\u6570\u5934\u4F0F\u3002"
        },
        {
          name: "\u5C0F\u6691",
          e: "\u6691\u6C14\u6E10\u76DB\uFF0C\u96F7\u96E8\u589E\u591A",
          hou: ["\u6E29\u98CE\u81F3", "\u87CB\u87C0\u5C45\u5B87", "\u9E70\u59CB\u9E37"],
          intro: "\u6691\u70ED\u6E10\u76DB\u800C\u672A\u6781\uFF0C\u96F7\u96E8\u9891\u4F5C\u3002\u6E7F\u70ED\u4EA4\u84B8\uFF0C\u5FC3\u70E6\u4F53\u5026\u3002",
          from: "\u907F\u70C8\u65E5\u3001\u614E\u7EB3\u51C9\uFF0C\u7A7A\u8C03\u6E29\u5EA6\u9002\u4E2D\uFF0C\u591C\u5367\u52FF\u5F53\u98CE\u3002",
          eat: "\u89E3\u6691\u5065\u813E\u3001\u6E05\u6DE1\u4E3A\u4E3B\uFF1B\u5B9C\u83B2\u85D5\u3001\u4E1D\u74DC\u3001\u7EFF\u8C46\u3001\u8377\u53F6\u3002",
          food: "\u8377\u53F6\u7EFF\u8C46\u7CA5\u2014\u2014\u6E05\u6691\u5229\u6E7F\uFF1B\u51C9\u62CC\u85D5\u7247\u6E05\u70ED\u751F\u6D25\u3002",
          move: "\u6E05\u6668\u508D\u665A\u548C\u7F13\u8FD0\u52A8\uFF0C\u5927\u6691\u524D\u84C4\u517B\u3001\u52FF\u8FC7\u8017\u3002",
          mood: "\u300C\u5FC3\u9759\u81EA\u7136\u51C9\u300D,\u5E73\u5FC3\u9759\u6C14\uFF0C\u6212\u8E81\u9632\u706B\u3002",
          care: "\u6691\u6E7F\u5F53\u4EE4\uFF0C\u9632\u4E2D\u6691\u3001\u80A0\u80C3\u4E0D\u9002\uFF1B\u996E\u98DF\u6D01\u51C0\u3001\u5FCC\u8FC7\u51B7\u3002",
          say: "\u5C0F\u6691\u5927\u6691\uFF0C\u4E0A\u84B8\u4E0B\u716E\u3002"
        },
        {
          name: "\u5927\u6691",
          e: "\u4E00\u5E74\u6700\u70ED\uFF0C\u6E7F\u70ED\u4EA4\u84B8",
          hou: ["\u8150\u8349\u4E3A\u8424", "\u571F\u6DA6\u6EBD\u6691", "\u5927\u96E8\u65F6\u884C"],
          intro: "\u4E00\u5E74\u4E2D\u6700\u708E\u70ED\u65F6\u8282\uFF0C\u6E7F\u70ED\u8FBE\u4E8E\u6781\u76DB\u3002\u51FA\u6C57\u591A\uFF0C\u6613\u8017\u6C14\u4F24\u6D25\u3002",
          from: "\u9632\u6691\u964D\u6E29\u3001\u8865\u6C34\u5145\u8DB3\uFF0C\u5348\u95F4\u907F\u70ED\u9759\u517B\u3002",
          eat: "\u6E05\u70ED\u751F\u6D25\u3001\u76CA\u6C14\u517B\u9634\uFF1B\u5B9C\u897F\u74DC\u3001\u7EFF\u8C46\u3001\u51AC\u74DC\u3001\u8001\u9E2D\u3002",
          food: "\u51AC\u74DC\u8001\u9E2D\u6C64\u2014\u2014\u6E05\u70ED\u6ECB\u9634\uFF1B\u7EFF\u8C46\u767E\u5408\u6C64\u6D88\u6691\u5B89\u795E\u3002",
          move: "\u51CF\u5C11\u5267\u70C8\u8FD0\u52A8\uFF0C\u4EE5\u9759\u517B\u3001\u5BA4\u5185\u5BFC\u5F15\u4E3A\u5B9C\u3002",
          mood: "\u5E73\u5FC3\u9759\u6C14\u3001\u907F\u70E6\u8E81,\u300C\u5FC3\u5BBD\u4E00\u5BF8\uFF0C\u6691\u9000\u4E09\u5206\u300D\u3002",
          care: "\u6B63\u662F\u4E09\u4F0F\u5929\uFF0C\u9632\u6691\u6E7F\uFF1B\u51FA\u6C57\u591A\u5BB9\u6613\u4E4F\uFF0C\u9002\u5F53\u8865\u8865\u6C14\u3001\u517B\u517B\u9634\u3002",
          say: "\u5927\u6691\u4E0D\u6691\uFF0C\u4E94\u8C37\u4E0D\u9F13\u3002"
        },
        {
          name: "\u7ACB\u79CB",
          e: "\u6691\u53BB\u51C9\u6765\uFF0C\u9633\u6536\u9634\u957F",
          hou: ["\u51C9\u98CE\u81F3", "\u767D\u9732\u964D", "\u5BD2\u8749\u9E23"],
          intro: "\u79CB\u4E4B\u59CB\uFF0C\u6691\u6C14\u6E10\u9000\u3001\u51C9\u98CE\u521D\u751F\u3002\u71E5\u6C14\u5C06\u8D77\uFF0C\u5B9C\u517B\u80BA\u6DA6\u71E5\u3002",
          from: "\u65E9\u5367\u65E9\u8D77\uFF0C\u9632\u300C\u79CB\u8001\u864E\u300D\u4F59\u70ED\uFF0C\u6E10\u589E\u8863\u7269\u3002",
          eat: "\u6DA6\u71E5\u517B\u80BA\u3001\u51CF\u8F9B\u589E\u9178\uFF1B\u5B9C\u767E\u5408\u3001\u94F6\u8033\u3001\u83B2\u85D5\u3001\u68A8\u3002",
          food: "\u94F6\u8033\u83B2\u5B50\u7FB9\u2014\u2014\u6ECB\u9634\u6DA6\u80BA\uFF1B\u767E\u5408\u7CA5\u6E05\u5FC3\u6DA6\u71E5\u3002",
          move: "\u767B\u9AD8\u3001\u6162\u8DD1\u7B49\u8212\u5C55\u8FD0\u52A8\uFF0C\u987A\u6536\u655B\u4E4B\u6C14\u3002",
          mood: "\u6536\u655B\u795E\u6C14\uFF0C\u5FC3\u5883\u5B81\u548C\uFF0C\u52FF\u4F7F\u60B2\u79CB\u6270\u795E\u3002",
          care: "\u7531\u300C\u957F\u300D\u8F6C\u300C\u6536\u300D;\u8D34\u79CB\u8198\u5B9C\u6E05\u8865\u52FF\u9AA4\u8865\uFF0C\u62A4\u597D\u813E\u80C3\u3002",
          say: "\u7ACB\u79CB\u4E4B\u65E5\u51C9\u98CE\u81F3\u3002"
        },
        {
          name: "\u5904\u6691",
          e: "\u6691\u6C14\u81F3\u6B64\u800C\u6B62",
          hou: ["\u9E70\u4E43\u796D\u9E1F", "\u5929\u5730\u59CB\u8083", "\u79BE\u4E43\u767B"],
          intro: "\u6691\u6C14\u6B62\u606F\uFF0C\u79CB\u610F\u6E10\u6D53\u3002\u663C\u70ED\u591C\u51C9\u3001\u6E29\u5DEE\u52A0\u5927\uFF0C\u71E5\u8C61\u521D\u73B0\u3002",
          from: "\u589E\u51CF\u8863\u7269\u5F97\u5B9C\uFF0C\u65E9\u7761\u65E9\u8D77\uFF0C\u9632\u663C\u591C\u6E29\u5DEE\u7740\u51C9\u3002",
          eat: "\u6ECB\u9634\u6DA6\u71E5\u3001\u6E05\u8865\uFF1B\u5B9C\u68A8\u3001\u8702\u871C\u3001\u829D\u9EBB\u3001\u94F6\u8033\u3001\u9E2D\u8089\u3002",
          food: "\u96EA\u68A8\u767E\u5408\u6C64\u2014\u2014\u6DA6\u71E5\u517B\u9634\uFF1B\u829D\u9EBB\u7CCA\u6ECB\u9634\u6DA6\u80A0\u3002",
          move: "\u8212\u7F13\u8FD0\u52A8\u6E10\u589E\u91CF\uFF0C\u987A\u79CB\u6536\u4EE5\u84C4\u517B\u3002",
          mood: "\u5E73\u548C\u5B89\u795E\uFF0C\u6E10\u5165\u79CB\u4E4B\u6C89\u9759\uFF0C\u8C03\u7545\u60C5\u5FD7\u3002",
          care: "\u300C\u79CB\u4E4F\u300D\u6613\u56F0\uFF0C\u4F5C\u606F\u89C4\u5F8B\uFF1B\u65E9\u665A\u6DFB\u8863\u62A4\u597D\u9888\u80CC\u3002",
          say: "\u5904\u6691\u5929\u4E0D\u6691\uFF0C\u708E\u70ED\u5728\u4E2D\u5348\u3002"
        },
        {
          name: "\u767D\u9732",
          e: "\u9732\u51DD\u800C\u767D\uFF0C\u663C\u6696\u591C\u51C9",
          hou: ["\u9E3F\u96C1\u6765", "\u7384\u9E1F\u5F52", "\u7FA4\u9E1F\u517B\u7F9E"],
          intro: "\u591C\u5BD2\u663C\u6696\uFF0C\u6C34\u6C7D\u51DD\u9732\u3002\u5929\u6C14\u8F6C\u51C9\u3001\u71E5\u6C14\u5F53\u4EE4\uFF0C\u5B9C\u6DA6\u80BA\u9632\u71E5\u3002",
          from: "\u591C\u5367\u6DFB\u8863\uFF0C\u62A4\u597D\u8DB3\u80CC\u4E0E\u9888\u9879,\u300C\u767D\u9732\u8EAB\u4E0D\u9732\u300D\u3002",
          eat: "\u6DA6\u80BA\u9632\u71E5\u3001\u591A\u98DF\u767D\u8272\uFF1B\u5B9C\u767D\u841D\u535C\u3001\u94F6\u8033\u3001\u767E\u5408\u3001\u83B2\u85D5\u3001\u68A8\u3002",
          food: "\u51B0\u7CD6\u7096\u68A8\u2014\u2014\u6DA6\u80BA\u6B62\u71E5\uFF1B\u5C71\u836F\u6392\u9AA8\u6C64\u5065\u813E\u6DA6\u71E5\u3002",
          move: "\u548C\u7F13\u6709\u6C27\u8FD0\u52A8\uFF0C\u5FAE\u6C57\u4E3A\u5EA6\uFF0C\u52FF\u8FC7\u6C57\u4F24\u6D25\u3002",
          mood: "\u8BA9\u5FC3\u6C89\u9759\u4E9B\uFF0C\u522B\u618B\u7740\uFF0C\u4E5F\u522B\u6025\u8E81\u3002",
          care: "\u663C\u591C\u6E29\u5DEE\u5927\uFF0C\u9632\u51C9\u71E5\u4F24\u80BA\uFF1B\u8FC7\u654F\u3001\u54EE\u5598\u8005\u5C24\u9700\u62A4\u547C\u5438\u3002",
          say: "\u767D\u9732\u8EAB\u4E0D\u9732\uFF0C\u5BD2\u9732\u811A\u4E0D\u9732\u3002"
        },
        {
          name: "\u79CB\u5206",
          e: "\u9634\u9633\u518D\u5E73\uFF0C\u663C\u591C\u5747\u5206",
          hou: ["\u96F7\u59CB\u6536\u58F0", "\u86F0\u866B\u576F\u6237", "\u6C34\u59CB\u6DB8"],
          intro: "\u663C\u591C\u518D\u6B21\u5747\u5206\uFF0C\u79CB\u6C14\u8FC7\u534A\u3002\u9634\u9633\u5E73\u8861\uFF0C\u517B\u751F\u91CD\u5728\u300C\u8C03\u548C\u300D\u3002",
          from: "\u65E9\u7761\u65E9\u8D77\uFF0C\u8D77\u5C45\u6709\u5E38\uFF0C\u987A\u79CB\u4E4B\u6536\u655B\u3001\u517B\u62A4\u80BA\u6C14\u3002",
          eat: "\u5E73\u8865\u6DA6\u71E5\u3001\u5BD2\u6E29\u9002\u4E2D\uFF1B\u5B9C\u767E\u5408\u3001\u94F6\u8033\u3001\u829D\u9EBB\u3001\u8702\u871C\u3001\u767D\u841D\u535C\u3002",
          food: "\u767E\u5408\u94F6\u8033\u83B2\u5B50\u7FB9\u2014\u2014\u5E73\u8865\u6DA6\u71E5\uFF1B\u8702\u871C\u67DA\u5B50\u996E\u6DA6\u80BA\u751F\u6D25\u3002",
          move: "\u767B\u9AD8\u3001\u516B\u6BB5\u9526\u7B49\u8212\u7F13\u8FD0\u52A8\uFF0C\u4F7F\u6C14\u8840\u8C03\u548C\u3002",
          mood: "\u4ECE\u5BB9\u5B89\u5B81\uFF0C\u6536\u655B\u5FC3\u7EEA\uFF0C\u9632\u79CB\u90C1\u60B2\u51C9\u3002",
          care: "\u9634\u9633\u5E73\u548C\u4E3A\u8981\uFF1B\u6DA6\u71E5\u4E0D\u5B9C\u8FC7\u5BD2\uFF0C\u6E29\u8865\u4E0D\u5B9C\u8FC7\u71E5\u3002",
          say: "\u79CB\u5206\u79CB\u5206\uFF0C\u663C\u591C\u5E73\u5206\u3002"
        },
        {
          name: "\u5BD2\u9732",
          ...
          intro: "\u9732\u6C14\u66F4\u5BD2\uFF0C\u5C06\u51DD\u4E3A\u971C\u3002\u79CB\u71E5\u8F6C\u51C9\u3001\u6C14\u5019\u5E72\u51B7\uFF0C\u5B9C\u6ECB\u9634\u6DA6\u71E5\u3002",
          from: "\u8DB3\u90E8\u4FDD\u6696,\u300C\u5BD2\u9732\u811A\u4E0D\u9732\u300D,\u9002\u5EA6\u6DFB\u8863\u9632\u5BD2\u3002",
          eat: "\u6ECB\u9634\u6DA6\u80BA\u3001\u6E29\u6DA6\uFF1B\u5B9C\u829D\u9EBB\u3001\u6838\u6843\u3001\u94F6\u8033\u3001\u5C71\u836F\u3001\u67FF\u5B50(\u9002\u91CF)\u3002",
          food: "\u829D\u9EBB\u6838\u6843\u7CCA\u2014\u2014\u6ECB\u9634\u6DA6\u71E5\u3001\u8865\u80BE\u4E4C\u53D1\uFF1B\u5C71\u836F\u67B8\u675E\u7CA5\u5065\u813E\u8865\u80BE\u3002",
          move: "\u6162\u8DD1\u3001\u767B\u9AD8\u7B49\u8212\u5C55\u8FD0\u52A8\uFF0C\u987A\u6536\u85CF\u800C\u4E0D\u8FC7\u8017\u3002",
          mood: "\u9759\u517B\u6536\u85CF\uFF0C\u52FF\u8FC7\u60B2\u79CB\uFF0C\u591A\u89C1\u6696\u9633\u4EE5\u7545\u60C5\u3002",
          care: "\u51C9\u71E5\u4F24\u80BA\u3001\u5BD2\u4ECE\u811A\u8D77\uFF1B\u62A4\u597D\u53CC\u8DB3\u4E0E\u819D\uFF0C\u614E\u9632\u53D7\u51C9\u3002",
          say: "\u5BD2\u9732\u811A\u4E0D\u9732\u3002"
        },
        {
          name: "\u971C\u964D",
          e: "\u9732\u7ED3\u4E3A\u971C\uFF0C\u79CB\u4E4B\u672B\u5019",
          hou: ["\u8C7A\u4E43\u796D\u517D", "\u8349\u6728\u9EC4\u843D", "\u8707\u866B\u54B8\u4FEF"],
          intro: "\u79CB\u5B63\u6700\u540E\u4E00\u4E2A\u8282\u6C14\uFF0C\u663C\u591C\u6E29\u5DEE\u6781\u5927\u3001\u521D\u971C\u964D\u4E34\u3002\u5B9C\u5E73\u8865\u56FA\u672C\u3002",
          from: "\u9632\u5BD2\u4FDD\u6696\u3001\u56FA\u62A4\u813E\u80C3\uFF0C\u65E9\u5367\u665A\u8D77\u4EE5\u517B\u9633\u3002",
          eat: "\u5E73\u8865\u5065\u813E\u3001\u6DA6\u71E5\uFF1B\u5B9C\u6817\u5B50\u3001\u841D\u535C\u3001\u5C71\u836F\u3001\u82F9\u679C\u3001\u725B\u7F8A\u8089\u9002\u91CF\u3002",
          food: "\u677F\u6817\u7096\u9E21\u2014\u2014\u5065\u813E\u8865\u80BE\uFF1B\u767D\u841D\u535C\u7096\u725B\u8089\u7406\u6C14\u6D88\u98DF\u3002",
          move: "\u8212\u7F13\u6709\u6C27\u3001\u767B\u9AD8\u8D4F\u79CB\uFF0C\u84C4\u517B\u800C\u4E0D\u8FC7\u52B3\u3002",
          mood: "\u5E73\u548C\u6536\u655B\uFF0C\u517B\u85CF\u5F85\u51AC\uFF0C\u52FF\u4F7F\u60C5\u5FD7\u4F4E\u6C89\u3002",
          care: "\u300C\u8865\u51AC\u4E0D\u5982\u8865\u971C\u964D\u300D;\u6E29\u548C\u8FDB\u8865\u6253\u5E95\uFF0C\u62A4\u813E\u80C3\u3001\u9632\u5173\u8282\u53D7\u51C9\u3002",
          say: "\u971C\u964D\u89C1\u971C\uFF0C\u7C73\u8C37\u6EE1\u4ED3\u3002"
        },
        {
          name: "\u7ACB\u51AC",
          e: "\u6C34\u59CB\u51B0\uFF0C\u5730\u59CB\u51BB\uFF0C\u4E07\u7269\u6536\u85CF",
          hou: ["\u6C34\u59CB\u51B0", "\u5730\u59CB\u51BB", "\u96C9\u5165\u5927\u6C34\u4E3A\u8703"],
          intro: "\u51AC\u4E4B\u59CB\uFF0C\u9633\u6C14\u6F5C\u85CF\u3001\u4E07\u7269\u86F0\u4F0F\u3002\u517B\u751F\u91CD\u5728\u300C\u85CF\u300D,\u6E29\u8865\u517B\u80BE\u3002",
          from: "\u65E9\u5367\u665A\u8D77\uFF0C\u5FC5\u5F85\u65E5\u5149\uFF1B\u62A4\u597D\u5934\u9888\u3001\u8170\u8179\u4E0E\u53CC\u8DB3\u3002",
          eat: "\u6E29\u8865\u517B\u80BE\u3001\u591A\u98DF\u9ED1\u8272\uFF1B\u5B9C\u7F8A\u8089\u3001\u9ED1\u8C46\u3001\u9ED1\u829D\u9EBB\u3001\u6838\u6843\u3001\u6817\u5B50\u3002",
          food: "\u5F53\u5F52\u751F\u59DC\u7F8A\u8089\u6C64\u2014\u2014\u6E29\u4E2D\u8865\u865A\u3001\u5FA1\u5BD2\uFF1B\u9ED1\u8C46\u6838\u6843\u7CA5\u8865\u80BE\u4E4C\u53D1\u3002",
          move: "\u65E5\u51FA\u540E\u548C\u7F13\u8FD0\u52A8\uFF0C\u5FAE\u6C57\u5373\u6B62\uFF0C\u52FF\u5927\u6C57\u6CC4\u9633\u3002",
          mood: "\u5FC3\u601D\u5F80\u91CC\u6536\u4E00\u6536\uFF0C\u5C11\u64CD\u5FC3\u8D39\u795E\uFF0C\u60C5\u7EEA\u4E5F\u522B\u5916\u9732\u3001\u85CF\u7740\u70B9\u3002",
          care: "\u300C\u51AC\u4EE4\u8FDB\u8865\u300D\u5F00\u7AEF\uFF0C\u56E0\u4EBA\u800C\u5F02\u3001\u5FAA\u5E8F\u6E10\u8FDB\uFF1B\u62A4\u9633\u9632\u5BD2\u4E3A\u672C\u3002",
          say: "\u7ACB\u51AC\u8865\u51AC\uFF0C\u8865\u5634\u7A7A\u3002"
        },
        {
          name: "\u5C0F\u96EA",
          ...
          intro: "\u5929\u5730\u95ED\u585E\u3001\u5BD2\u610F\u6E10\u6DF1\uFF0C\u5317\u65B9\u59CB\u964D\u96EA\u3002\u6C14\u5019\u9634\u51B7\uFF0C\u6613\u751F\u90C1\u95F7\u3002",
          from: "\u9632\u5BD2\u4FDD\u6696\uFF0C\u5BA4\u5185\u52E4\u901A\u98CE\uFF1B\u591A\u6652\u592A\u9633\u4EE5\u52A9\u9633\u6C14\u3002",
          eat: "\u6E29\u6DA6\u4E3A\u5B9C\u3001\u6ECB\u9634\u6F5C\u9633\uFF1B\u5B9C\u6817\u5B50\u3001\u5C71\u836F\u3001\u767D\u841D\u535C\u3001\u9ED1\u829D\u9EBB\u3002",
          food: "\u5C71\u836F\u7F8A\u8089\u6C64\u2014\u2014\u6E29\u8865\u5065\u813E\uFF1B\u51B0\u7CD6\u841D\u535C\u6C34\u6DA6\u71E5\u5316\u75F0\u3002",
          move: "\u5BA4\u5185\u516B\u6BB5\u9526\u3001\u592A\u6781\u7B49\u6E29\u548C\u8FD0\u52A8\uFF0C\u7545\u8FBE\u6C14\u8840\u3002",
          mood: "\u7545\u60C5\u9632\u90C1\uFF0C\u591A\u89C1\u9633\u5149\u3001\u591A\u4E0E\u4EBA\u53D9\uFF0C\u9632\u60C5\u7EEA\u4F4E\u843D\u3002",
          care: "\u91CC\u70ED\u5916\u5BD2\u5BB9\u6613\u4E0A\u706B\uFF0C\u8865\u4E5F\u522B\u8865\u592A\u71E5\uFF1B\u591A\u987A\u987A\u5FC3\u60C5\u3001\u9632\u60C5\u7EEA\u4F4E\u843D\u66F4\u8981\u7D27\u3002",
          say: "\u5C0F\u96EA\u5C01\u5730\uFF0C\u5927\u96EA\u5C01\u6CB3\u3002"
        },
        {
          name: "\u5927\u96EA",
          e: "\u96EA\u76DB\u5929\u5BD2\uFF0C\u4E07\u7269\u6DF1\u85CF",
          hou: ["\u9E56\u9D20\u4E0D\u9E23", "\u864E\u59CB\u4EA4", "\u8354\u633A\u51FA"],
          intro: "\u964D\u96EA\u6E10\u76DB\uFF0C\u5929\u5BD2\u5730\u51BB\u3002\u9634\u6C14\u76DB\u6781\uFF0C\u517B\u751F\u91CD\u5728\u4FDD\u6696\u4E0E\u6E29\u8865\u3002",
          from: "\u62A4\u9633\u4FDD\u6696\u3001\u907F\u5BD2\u5C31\u6E29\uFF0C\u91CD\u5728\u5934\u3001\u80CC\u3001\u8DB3\u4E09\u5904\u3002",
          eat: "\u6E29\u8865\u5FA1\u5BD2\u3001\u6ECB\u80BE\uFF1B\u5B9C\u6838\u6843\u3001\u6842\u5706\u3001\u7F8A\u8089\u3001\u6817\u5B50\u3001\u9ED1\u8C46\u3002",
          food: "\u6842\u5706\u7EA2\u67A3\u67B8\u675E\u8336\u2014\u2014\u6E29\u8865\u6C14\u8840\uFF1B\u7F8A\u8089\u841D\u535C\u6C64\u6E29\u4E2D\u5FA1\u5BD2\u3002",
          move: "\u5BA4\u5185\u6E29\u548C\u8FD0\u52A8\u4E3A\u4E3B\uFF0C\u51FA\u6C57\u540E\u53CA\u65F6\u64E6\u5E72\u9632\u53D7\u51C9\u3002",
          mood: "\u5B89\u795E\u517B\u85CF\uFF0C\u5FC3\u5883\u5E73\u548C\uFF0C\u65E9\u7761\u4EE5\u517B\u7CBE\u84C4\u9510\u3002",
          care: "\u4E25\u5BD2\u62A4\u5FC3\u8111\u8840\u7BA1\uFF0C\u8D77\u5C45\u52FF\u9AA4\u51B7\u9AA4\u70ED\uFF1B\u6E29\u8865\u56E0\u4EBA\u800C\u5F02\u3002",
          say: "\u745E\u96EA\u5146\u4E30\u5E74\u3002"
        },
        {
          name: "\u51AC\u81F3",
          e: "\u9634\u6781\u9633\u751F\uFF0C\u6570\u4E5D\u59CB\u65E5",
          hou: ["\u86AF\u8693\u7ED3", "\u9E8B\u89D2\u89E3", "\u6C34\u6CC9\u52A8"],
          intro: "\u9634\u6C14\u6781\u76DB\u800C\u4E00\u9633\u59CB\u751F\uFF0C\u6570\u4E5D\u5BD2\u5929\u81EA\u6B64\u59CB\u3002\u517B\u751F\u91CD\u5728\u62A4\u521D\u751F\u4E4B\u9633\u3002",
          from: "\u65E9\u5367\u665A\u8D77\u3001\u62A4\u9633\u9632\u5BD2\uFF1B\u7761\u524D\u6E29\u6C34\u6CE1\u811A\u4EE5\u6696\u4E0B\u5143\u3002",
          eat: "\u6E29\u8865\u6ECB\u80BE\u3001\u5E73\u548C\u8FDB\u8865\uFF1B\u5B9C\u997A\u5B50\u3001\u6C64\u5706\u3001\u7F8A\u8089\u3001\u5F53\u5F52\u3001\u9ED1\u829D\u9EBB\u3002",
          food: "\u7F8A\u8089\u997A\u5B50\u2014\u2014\u6E29\u4E2D\u8865\u865A\u3001\u5E94\u8282\u5FA1\u5BD2\uFF1B\u5F53\u5F52\u7EA2\u67A3\u9E21\u6C64\u6E29\u8865\u6C14\u8840\u3002",
          move: "\u9759\u591A\u52A8\u5C11\uFF0C\u548C\u7F13\u5BFC\u5F15\u4EE5\u517B\u521D\u751F\u4E4B\u9633\u3002",
          mood: "\u5FC3\u9759\u4E0B\u6765\u3001\u5F80\u91CC\u6536\uFF0C\u522B\u6298\u817E\uFF0C\u5B88\u4F4F\u8FD9\u70B9\u521A\u56DE\u5934\u7684\u6696\u610F\uFF0C\u4FDD\u6301\u5B89\u5B81\u3002",
          care: "\u300C\u51AC\u81F3\u4E00\u9633\u751F\u300D\u8FDB\u8865\u6700\u4F73\uFF1B\u62A4\u9633\u4E3A\u5148\uFF0C\u6CE1\u811A\u6696\u80BE\u3002",
          say: "\u51AC\u81F3\u5927\u5982\u5E74\u3002"
        },
        {
          name: "\u5C0F\u5BD2",
          e: "\u5929\u5BD2\u5730\u51BB\uFF0C\u5BD2\u672A\u81F3\u6781",
          hou: ["\u96C1\u5317\u4E61", "\u9E4A\u59CB\u5DE2", "\u96C9\u59CB\u96CA"],
          intro: "\u8FDB\u5165\u4E00\u5E74\u6700\u51B7\u65F6\u6BB5,\u300C\u5C0F\u5BD2\u80DC\u5927\u5BD2\u300D\u3002\u517B\u80BE\u9632\u5BD2\uFF0C\u84C4\u517B\u5F85\u6625\u3002",
          from: "\u91CD\u4FDD\u6696\u3001\u614E\u8D77\u5C45\uFF0C\u5934\u8DB3\u5E76\u62A4\uFF0C\u7761\u524D\u6CE1\u811A\u52A9\u7720\u6696\u8EAB\u3002",
          eat: "\u6E29\u8865\u517B\u80BE\u3001\u76CA\u6C14\uFF1B\u5B9C\u5F53\u5F52\u3001\u7F8A\u8089\u3001\u9ED1\u8C46\u3001\u6838\u6843\u3001\u6842\u5706\u3002",
          food: "\u5F53\u5F52\u7EA2\u67A3\u7F8A\u8089\u6C64\u2014\u2014\u6E29\u8865\u6C14\u8840\u3001\u6696\u8EAB\u5FA1\u5BD2\uFF1B\u6838\u6843\u9ED1\u8C46\u7CA5\u8865\u80BE\u3002",
          move: "\u65E5\u51FA\u540E\u5BA4\u5916\u5FEB\u8D70\u6216\u5BA4\u5185\u5BFC\u5F15\uFF0C\u5FAE\u6C57\u4E3A\u5EA6\u3002",
          mood: "\u5B89\u517B\u7CBE\u795E\uFF0C\u84C4\u52BF\u5F85\u6625\uFF0C\u5FC3\u5883\u5E73\u548C\u52FF\u7126\u8E81\u3002",
          care: "\u6781\u5BD2\u62A4\u5FC3\u8111\u3001\u9632\u8DCC\u9632\u51BB\uFF1B\u8FDB\u8865\u6253\u5E95\uFF0C\u4E3A\u5F00\u6625\u751F\u53D1\u84C4\u529B\u3002",
          say: "\u5C0F\u5BD2\u5927\u5BD2\uFF0C\u51BB\u6210\u4E00\u56E2\u3002"
        },
        {
          name: "\u5927\u5BD2",
          e: "\u5BD2\u4E4B\u6781\uFF0C\u51AC\u4E4B\u5C3D\uFF0C\u6625\u5C06\u56DE",
          hou: ["\u9E21\u59CB\u4E73", "\u5F81\u9E1F\u5389\u75BE", "\u6C34\u6CFD\u8179\u575A"],
          intro: "\u4E00\u5E74\u6700\u540E\u4E00\u4E2A\u8282\u6C14\uFF0C\u5BD2\u5C3D\u6625\u56DE\u5728\u5373\u3002\u517B\u751F\u7531\u300C\u85CF\u300D\u6E10\u8F6C\u300C\u751F\u300D\u3002",
          from: "\u9632\u5BD2\u56FA\u672C\u3001\u9002\u5EA6\u6D3B\u52A8\uFF1B\u8D77\u5C45\u4ECD\u5B9C\u65E9\u5367\uFF0C\u6E10\u8FCE\u65E5\u5149\u3002",
          eat: "\u6E29\u6DA6\u517C\u8865\u3001\u7531\u8865\u8F6C\u758F\uFF1B\u5B9C\u7EA2\u67A3\u3001\u6842\u5706\u3001\u5C71\u836F\u3001\u767D\u841D\u535C\u3001\u751F\u59DC\u3002",
          food: "\u516B\u5B9D\u7CA5\u2014\u2014\u6E29\u6DA6\u6ECB\u8865\u3001\u8C03\u548C\u813E\u80C3\uFF1B\u7EA2\u67A3\u6842\u5706\u8336\u8865\u8840\u5B89\u795E\u3002",
          move: "\u8212\u5C55\u7B4B\u9AA8\u3001\u548C\u7F13\u8FD0\u52A8\uFF0C\u6E10\u589E\u6D3B\u52A8\u91CF\u4EE5\u8FCE\u751F\u53D1\u3002",
          mood: "\u5FC3\u653E\u5E73\u3001\u6162\u6162\u517B\u7740\uFF0C\u5FC3\u60C5\u8212\u5C55\u70B9\uFF0C\u76FC\u7740\u5F00\u6625\u3002",
          care: "\u51AC\u672B\u6E29\u8865\u5C11\u4E00\u70B9\uFF0C\u6DFB\u70B9\u751F\u59DC\u8471\u849C\u8FD9\u7C7B\u53D1\u6563\u7684\u5473\u9053\uFF0C\u7ED9\u5F00\u6625\u6253\u4E2A\u5E95\u3002",
          say: "\u5927\u5BD2\u5230\u9876\u70B9\uFF0C\u65E5\u540E\u5929\u6E10\u6696\u3002"
        }
      ];
      var WISDOM = [
      ...
      function seasonView(today) {
        const solar = Solar.fromYmd(today.year, today.month, today.day);
        const lunar = solar.getLunar();
        const cur = lunar.getPrevJieQi(true);
        const nxt = lunar.getNextJieQi(true);
        const curName = cur.getName();
        const nextSolar = nxt.getSolar();
        const t0 = Date.UTC(today.year, today.month - 1, today.day);
        const t1 = Date.UTC(nextSolar.getYear(), nextSolar.getMonth() - 1, nextSolar.getDay());
        const daysToNext = Math.max(0, Math.round((t1 - t0) / 864e5));
        const health = JIEQI.find((j) => j.name === curName) || null;
        const doy = Math.floor((t0 - Date.UTC(today.year, 0, 0)) / 864e5);
        const wisdom = WISDOM[(doy % WISDOM.length + WISDOM.length) % WISDOM.length];
        const tbl = Solar.fromYmd(today.year, 1, 1).getLunar().getJieQiTable();
        const timeline = JIEQI.map((j) => {
          const s = tbl[j.name];
          return {
            name: j.name,
            e: j.e,
            date: s ? `${s.getMonth()}/${s.getDay()}` : "",
            cur: j.name === curName,
            hou: j.hou,
            intro: j.intro,
            from: j.from,
        ...
        return {
          jieqi: {
            ...
            // 如「螳螂生」
            nextName: nxt.getName(),
            nextDate: `${nextSolar.getMonth()}\u6708${nextSolar.getDay()}\u65E5`,
            daysToNext
          },
          health,
          wisdom,
    ...
    "engine/report.js"(exports, module) {
      ...
      var WX_INFO = {
        \u6728: {
          ...
          organ: "\u809D",
          trait: "\u6761\u8FBE\u5411\u4E0A\u3001\u6709\u8BA1\u5212\u3001\u7231\u6210\u957F",
          place: "\u6709\u7EFF\u690D\u3001\u901A\u98CE\u3001\u671D\u4E1C\u7684\u660E\u4EAE\u7A7A\u95F4",
          activity: "\u4F38\u5C55\u8EAB\u4F53\u3001\u4EB2\u8FD1\u8349\u6728\u3001\u89C4\u5212\u65B0\u4E8B\u3001\u5B66\u65B0\u4E1C\u897F",
          material: "\u6728\u8D28 \xB7 \u7FE1\u7FE0 \xB7 \u7EFF\u677E\u77F3 \xB7 \u4E1C\u9675\u7389",
          food: "\u9752\u7EFF\u852C\u98DF\u3001\u82BD\u83DC\u3001\u9002\u5EA6\u9178\u5473",
          care: "\u52B3\u9038\u7ED3\u5408\u3001\u522B\u957F\u671F\u6EE1\u8D1F\u8377\uFF1B\u60C5\u7EEA\u90C1\u7ED3\u65F6\uFF0C\u591A\u51FA\u53BB\u8D70\u8D70\u3001\u4EB2\u8FD1\u8349\u6728\u3002"
        },
        \u706B: {
          keyword: "\u5149\u70ED \xB7 \u8868\u8FBE",
          color: WX_COLOR["\u706B"],
          ...
          time: "\u6B63\u5348",
          organ: "\u5FC3",
          trait: "\u70ED\u60C5\u5916\u653E\u3001\u7167\u4EAE\u65C1\u4EBA\u3001\u85CF\u4E0D\u4F4F\u60C5\u7EEA",
          place: "\u660E\u4EAE\u3001\u5411\u9633\u3001\u6709\u6696\u5149\u7684\u7A7A\u95F4",
          activity: "\u793E\u4EA4\u3001\u8868\u8FBE\u3001\u5C55\u793A\u81EA\u5DF1\u3001\u4E0E\u4EBA\u76F8\u805A",
          material: "\u7EA2\u739B\u7459 \xB7 \u77F3\u69B4\u77F3 \xB7 \u7EA2\u7EB9\u77F3 \xB7 \u6731\u7802",
          food: "\u7EA2\u8272\u98DF\u7269\u3001\u6E29\u70ED\u996E\u3001\u5C11\u8BB8\u82E6\u5473\u517B\u5FC3",
          care: "\u7CBE\u529B\u8017\u5F97\u5FEB\uFF0C\u522B\u4E00\u6B21\u7528\u6EE1\uFF1B\u7761\u524D\u8C03\u6697\u706F\u5149\uFF0C\u8BA9\u8EAB\u5FC3\u9759\u4E0B\u6765\u3002"
        },
        \u571F: {
          keyword: "\u627F\u8F7D \xB7 \u5B89\u7A33",
          color: WX_COLOR["\u571F"],
          ...
          organ: "\u813E\u80C3",
          trait: "\u539A\u9053\u53EF\u9760\u3001\u80FD\u625B\u4E8B\u3001\u6162\u70ED\u8E0F\u5B9E",
          place: "\u65B9\u6B63\u3001\u5B89\u7A33\u3001\u8D28\u6734\u3001\u6696\u8272\u8C03\u7684\u7A7A\u95F4",
          activity: "\u5B89\u987F\u751F\u6D3B\u3001\u6574\u7406\u6536\u7EB3\u3001\u8E0F\u5B9E\u79EF\u7D2F\u3001\u7167\u987E\u4EBA",
          material: "\u9EC4\u6C34\u6676 \xB7 \u871C\u8721 \xB7 \u7425\u73C0 \xB7 \u9676\u571F",
          food: "\u9EC4\u8272\u6839\u830E\u3001\u4E94\u8C37\u3001\u7518\u5473\u5065\u813E",
          care: "\u522B\u628A\u4E8B\u90FD\u63FD\u5728\u8EAB\u4E0A\uFF0C\u60C5\u7EEA\u53CA\u65F6\u758F\u89E3\uFF1B\u996E\u98DF\u89C4\u5F8B\u3001\u6E05\u6DE1\u4E3A\u5B9C\u3002"
        },
        \u91D1: {
          keyword: "\u6536\u655B \xB7 \u51B3\u65AD",
          color: WX_COLOR["\u91D1"],
          ...
          organ: "\u80BA",
          trait: "\u6E05\u695A\u5229\u843D\u3001\u8BB2\u539F\u5219\u3001\u4F1A\u505A\u51CF\u6CD5",
          place: "\u6574\u6D01\u3001\u7559\u767D\u3001\u6709\u91D1\u5C5E\u4E0E\u6D45\u8272\u8D28\u611F\u7684\u7A7A\u95F4",
          activity: "\u6574\u7406\u51B3\u65AD\u3001\u65AD\u820D\u79BB\u3001\u7ACB\u89C4\u77E9\u3001\u628A\u4E8B\u6536\u5C3E",
          material: "\u94F6\u9970 \xB7 \u767D\u6C34\u6676 \xB7 \u73CD\u73E0 \xB7 \u6708\u5149\u77F3",
          food: "\u767D\u8272\u98DF\u7269\u3001\u68A8\u4E0E\u767E\u5408\u3001\u5C11\u8BB8\u8F9B\u5473\u5BA3\u80BA",
          care: "\u60C5\u7EEA\u5B9C\u8212\u7545\uFF0C\u79CB\u71E5\u591A\u6DA6\u80BA\uFF1B\u5FC3\u60C5\u4F4E\u843D\u65F6\u4E3B\u52A8\u627E\u4EBA\u8BF4\u8BF4\uFF0C\u522B\u72EC\u81EA\u538B\u7740\u3002"
        },
        \u6C34: {
          keyword: "\u6C89\u9759 \xB7 \u667A\u6167",
          color: WX_COLOR["\u6C34"],
          ...
          time: "\u591C\u665A",
          organ: "\u80BE",
          trait: "\u806A\u660E\u7075\u6D3B\u3001\u60F3\u5F97\u8FDC\u3001\u9700\u8981\u72EC\u5904\u5145\u7535",
          place: "\u5B89\u9759\u3001\u8FD1\u6C34\u3001\u6DF1\u8272\u8C03\u3001\u53EF\u72EC\u5904\u7684\u7A7A\u95F4",
          activity: "\u84C4\u517B\u4F11\u6574\u3001\u6DF1\u5EA6\u601D\u8003\u3001\u72EC\u5904\u9605\u8BFB\u3001\u65E9\u4E9B\u4F11\u606F",
          material: "\u6D77\u84DD\u5B9D \xB7 \u9ED1\u66DC\u77F3 \xB7 \u9752\u91D1\u77F3 \xB7 \u84DD\u6676\u77F3",
          food: "\u9ED1\u8272\u98DF\u7269\u3001\u6E29\u8865\u3001\u5C11\u8BB8\u54B8\u5473\u6ECB\u80BE",
          care: "\u601D\u8651\u591A\u3001\u6613\u8017\u795E\uFF0C\u7761\u7720\u548C\u4FDD\u6696\u8981\u8DDF\u4E0A\uFF1B\u5165\u51AC\u66F4\u8981\u517B\u8DB3\u7CBE\u795E\u3002"
        }
      };
      var GOD_LIFE = {
        \u6BD4: {
          ...
          avoid: ["\u5408\u4F19\u5206\u8D26\u8FC7\u5206\u8BA1\u8F83", "\u4E8B\u4E8B\u4E89\u5F3A\u597D\u80DC", "\u66FF\u4EBA\u627F\u62C5\u4E0D\u8BE5\u62C5\u7684\u8D23\u4EFB", "\u4E3A\u989C\u9762\u800C\u52C9\u5F3A\u652F\u6491"]
        },
        \u5370: {
          name: "\u6ECB\u517B\u4E4B\u529B",
          field: "\u5B66\u4E60\u4E0E\u8D35\u4EBA",
          ...
          avoid: ["\u4E8B\u4E8B\u4F9D\u8D56\u4ED6\u4EBA", "\u4E00\u4E8B\u4E45\u62D6\u4E0D\u51B3", "\u7A7A\u60F3\u5185\u8017", "\u72B9\u8C6B\u4E0D\u51B3\u3001\u9519\u5931\u65F6\u673A"]
        },
        \u98DF: {
          name: "\u8868\u8FBE\u4E4B\u529B",
          field: "\u521B\u4F5C\u4E0E\u793E\u4EA4",
          ...
          avoid: ["\u51FA\u8A00\u56FE\u5FEB\u3001\u5F97\u7F6A\u4ED6\u4EBA", "\u8D2A\u73A9\u5206\u5FC3\u3001\u803D\u8BEF\u6B63\u4E8B", "\u4E00\u65F6\u5174\u8D77\u3001\u534A\u9014\u800C\u5E9F", "\u60C5\u7EEA\u51B2\u52A8\u3001\u5931\u8A00\u8868\u6001"]
        },
        \u8D22: {
          name: "\u638C\u63A7\u4E4B\u529B",
          field: "\u6B63\u4E8B\u4E0E\u94B1\u8D22",
          ...
          avoid: ["\u51B2\u52A8\u6D88\u8D39", "\u8D2A\u591A\u3001\u94FA\u5F20\u8FC7\u5EA6", "\u501F\u8D37\u62C5\u4FDD\u4E0D\u53EF\u8F7B\u8BB8", "\u88AB\u4E00\u65F6\u673A\u4F1A\u51B2\u660F\u5934\u8111"]
        },
        \u5B98: {
          name: "\u79E9\u5E8F\u4E4B\u529B",
          field: "\u4E8B\u4E1A\u4E0E\u8D23\u4EFB",
      ...
      var IMPRESSION = {
        \u7532: { short: "\u723D\u6717\u3001\u6709\u51B2\u52B2", surface: "\u723D\u6717\u3001\u8981\u5F3A\uFF0C\u8BA4\u51C6\u7684\u65B9\u5411\u4F1A\u575A\u6301\u5230\u5E95" },
        \u4E59: { short: "\u968F\u548C\u3001\u80FD\u53D8\u901A", surface: "\u968F\u548C\u3001\u597D\u76F8\u5904\uFF0C\u5185\u5728\u5F88\u6709\u97E7\u6027" },
        \u4E19: { short: "\u70ED\u60C5\u3001\u85CF\u4E0D\u4F4F\u8BDD", surface: "\u70ED\u60C5\u3001\u7231\u70ED\u95F9\uFF0C\u4EBA\u7F18\u597D" },
        \u4E01: { short: "\u7EC6\u817B\u3001\u6696\u4EBA", surface: "\u6E29\u548C\u3001\u4EB2\u5207\uFF0C\u5185\u91CC\u6709\u4E00\u80A1\u5B89\u9759\u7684\u97E7\u52B2" },
        \u620A: { short: "\u6566\u539A\u3001\u9760\u5F97\u4F4F", surface: "\u6566\u539A\u3001\u53EF\u9760\uFF0C\u8BA9\u4EBA\u89C9\u5F97\u8E0F\u5B9E" },
        \u5DF1: { short: "\u6E29\u548C\u597D\u76F8\u5904", surface: "\u9762\u5584\u3001\u813E\u6C14\u597D\uFF0C\u613F\u610F\u4E3A\u522B\u4EBA\u64CD\u5FC3\u5F20\u7F57" },
        \u5E9A: { short: "\u5E72\u8106\u3001\u8BB2\u4E49\u6C14", surface: "\u505A\u4E8B\u5229\u843D\u3001\u679C\u65AD\uFF0C\u8BA4\u5B9A\u7684\u65B9\u5411\u4F1A\u575A\u6301\uFF0C\u4E5F\u8BB2\u60C5\u4E49" },
        \u8F9B: { short: "\u8BB2\u7A76\u3001\u6709\u5206\u5BF8", surface: "\u65AF\u6587\u3001\u8BB2\u7A76\uFF0C\u5BF9\u54C1\u8D28\u8981\u6C42\u9AD8\u3001\u4E0D\u5C06\u5C31" },
        \u58EC: { short: "\u673A\u7075\u3001\u70B9\u5B50\u591A", surface: "\u673A\u7075\u3001\u53CD\u5E94\u5FEB\uFF0C\u4E0D\u559C\u6B22\u88AB\u62D8\u675F" },
      ...
      var EXPRESS = {
        \u7532: "\u8BA4\u5B9A\u7684\u4E8B\u4E0D\u5BB9\u6613\u6539\u53D8\uFF0C\u8BF4\u8BDD\u4E5F\u6BD4\u8F83\u76F4\u63A5\uFF0C",
        \u4E59: "\u8868\u9762\u5E94\u5BF9\u5F97\u4F53\uFF0C\u771F\u6B63\u7684\u5FC3\u4E8B\u7559\u7ED9\u81EA\u5DF1\u6D88\u5316\uFF0C",
        \u4E19: "\u60C5\u7EEA\u6765\u5F97\u5FEB\u53BB\u5F97\u4E5F\u5FEB\uFF0C\u4E0D\u592A\u85CF\u5F97\u4F4F\uFF0C",
        \u4E01: "\u5F88\u5728\u610F\u522B\u4EBA\u7684\u611F\u53D7\uFF0C\u81EA\u5DF1\u7684\u5FC3\u4E8B\u5374\u4E0D\u592A\u8BF4\uFF0C",
        \u620A: "\u518D\u5927\u7684\u60C5\u7EEA\u4E5F\u538B\u5F97\u4F4F\uFF0C\u4E0D\u8F7B\u6613\u8868\u9732\uFF0C",
        \u5DF1: "\u5E38\u628A\u522B\u4EBA\u7684\u96BE\u5904\u653E\u5728\u5FC3\u4E0A\uFF0C\u81EA\u5DF1\u7684\u59D4\u5C48\u5374\u4E0D\u592A\u8BF4\u51FA\u53E3\uFF0C",
        \u5E9A: "\u60C5\u7EEA\u4E0D\u592A\u85CF\u5F97\u4F4F\uFF0C",
        \u8F9B: "\u53EA\u5BF9\u5408\u5F97\u6765\u7684\u4EBA\u4EA4\u5FC3\uFF0C\u4E0D\u5408\u610F\u7684\u4E0D\u592A\u613F\u610F\u5E94\u4ED8\uFF0C",
        \u58EC: "\u5FC3\u91CC\u4E00\u6709\u60C5\u7EEA\uFF0C\u5F88\u5FEB\u5C31\u8868\u73B0\u51FA\u6765\uFF0C",
        \u7678: "\u4E60\u60EF\u628A\u4E8B\u5F80\u5FC3\u91CC\u653E\uFF0C\u5374\u4E0D\u8F7B\u6613\u8BF4\u51FA\u6765\uFF0C"
      };
      var POL_INNER = {
        \u5F3A: "\u91CD\u8981\u7684\u4E8B\u503E\u5411\u81EA\u5DF1\u62FF\u4E3B\u610F\u3002",
        \u4E2D: "\u9047\u5230\u91CD\u5927\u51B3\u5B9A\u65F6\u5BB9\u6613\u72B9\u8C6B\uFF0C\u4E34\u5230\u62CD\u677F\u5E38\u4E0B\u4E0D\u4E86\u51B3\u5FC3\u3002",
        \u5F31: "\u66F4\u9700\u8981\u5408\u9002\u7684\u73AF\u5883\u548C\u5408\u9002\u7684\u4EBA\u652F\u6301\uFF0C\u4F4D\u7F6E\u7AD9\u5BF9\u4E86\u624D\u66F4\u5BB9\u6613\u53D1\u6325\u3002"
      };
      var DRIVE_HINT = {
        \u5370: "\u4F60\u60F3\u8981\u7684\u662F\u4E00\u4EFD\u5B89\u7A33\uFF0C\u4EE5\u53CA\u88AB\u4EBA\u9700\u8981\u7684\u5F52\u5C5E\u611F\u3002",
        \u98DF: "\u4F60\u60F3\u8981\u7684\u662F\u6D3B\u5F97\u81EA\u5728\uFF0C\u624B\u91CC\u6709\u4E00\u4EF6\u771F\u6B63\u4E0A\u5FC3\u7684\u4E8B\u3002",
        \u8D22: "\u4F60\u60F3\u8981\u7684\u662F\u628A\u76EE\u6807\u8E0F\u5B9E\u5730\u843D\u5230\u5B9E\u5904\u3002",
      ...
      var TENSION = {
        ...
        \u98DF: {
          \u5370: "\u4F46\u4F60\u4E5F\u9700\u8981\u5B89\u5168\u611F\uFF0C\u70ED\u95F9\u662F\u5BF9\u5916\u7684\uFF0C\u72EC\u5904\u624D\u662F\u7559\u7ED9\u81EA\u5DF1\u7684\u3002",
          \u8D22: "\u4F46\u4F60\u4E5F\u5728\u610F\u4ED8\u51FA\u80FD\u5426\u6709\u56DE\u62A5\uFF0C\u4E00\u8FB9\u60F3\u653E\u624B\u53BB\u505A\uFF0C\u4E00\u8FB9\u53C8\u76D8\u7B97\u503C\u4E0D\u503C\u5F97\u3002",
          \u5B98: "\u4F46\u4F60\u4E5F\u6015\u8BA9\u4EBA\u5931\u671B\uFF0C\u4E00\u8FB9\u60F3\u6323\u8131\u7EA6\u675F\uFF0C\u4E00\u8FB9\u53C8\u628A\u81EA\u5DF1\u62C9\u56DE\u8BE5\u6709\u7684\u6837\u5B50\u3002"
        },
        \u8D22: {
          \u5370: "\u4F46\u4F60\u518D\u7406\u6027\u4E5F\u8FC7\u4E0D\u4E86\u611F\u60C5\u8FD9\u4E00\u5173\uFF0C\u4E00\u5FC3\u8F6F\u5C31\u8BA9\u6B65\uFF0C\u4E8B\u540E\u53C8\u540E\u6094\u3002",
          \u98DF: "\u4F46\u4F60\u4E5F\u6709\u60F3\u81EA\u7531\u53D1\u6325\u7684\u4E00\u9762\uFF0C\u771F\u6B63\u8BA9\u4F60\u6709\u52A8\u529B\u7684\uFF0C\u662F\u80FD\u653E\u5F00\u624B\u3001\u6709\u610F\u601D\u7684\u90A3\u90E8\u5206\u3002",
          \u5B98: "\u4F46\u4F60\u8981\u7684\u4E0D\u53EA\u662F\u62FF\u5230\u7ED3\u679C\uFF0C\u8FD8\u6709\u505A\u5F97\u4F53\u9762\u3001\u88AB\u4EBA\u8BA4\u53EF\u3002"
        },
        \u5B98: {
          \u5370: "\u4F46\u4F60\u625B\u4E8B\u7684\u540C\u65F6\uFF0C\u4E5F\u5E0C\u671B\u88AB\u7406\u89E3\u3001\u88AB\u7167\u987E\uFF0C\u5076\u5C14\u4E5F\u60F3\u8BA9\u81EA\u5DF1\u677E\u4E00\u53E3\u6C14\u3002",
          \u98DF: "\u4F46\u4F60\u5FC3\u91CC\u4E5F\u6709\u4E00\u4E2A\u60F3\u968F\u6027\u3001\u60F3\u653E\u677E\u7684\u81EA\u5DF1\uFF0C\u5E38\u88AB\u538B\u7740\u3002",
          \u8D22: "\u4F46\u4F60\u9664\u4E86\u80AF\u625B\uFF0C\u4E5F\u61C2\u5F97\u600E\u4E48\u628A\u4E8B\u63A8\u52A8\u6210\u529F\u3001\u62FF\u5230\u7ED3\u679C\u3002"
        }
      };
      var LEAN = { \u5370: "\u6C42\u7A33\u3001\u91CD\u611F\u60C5\u7684\u4E00\u9762", \u98DF: "\u7231\u8868\u8FBE\u3001\u8FFD\u6C42\u81EA\u5728\u7684\u4E00\u9762", \u8D22: "\u52A1\u5B9E\u3001\u80FD\u843D\u5730\u7684\u4E00\u9762", \u5B98: "\u80AF\u62C5\u5F53\u3001\u8D1F\u8D23\u7684\u4E00\u9762" };
      function balancedDrive(top, second) {
        return `\u4F60\u7684\u51E0\u79CD\u7279\u8D28\u6BD4\u8F83\u5747\u8861\uFF0C\u5185\u5FC3\u5E38\u6709\u62C9\u626F\uFF1A\u60F3\u8981\u5B89\u7A33\uFF0C\u53C8\u60F3\u5F80\u524D\u95EF\uFF1B\u6015\u4E00\u6210\u4E0D\u53D8\uFF0C\u53C8\u6015\u6B65\u5B50\u592A\u5927\u3002\u76F8\u8F83\u4E4B\u4E0B\uFF0C\u4F60\u7565\u504F${LEAN[top] || "\u80FD\u625B\u4E8B\u7684\u4E00\u9762"}\uFF0C\u53C8\u5E26\u51E0\u5206${LEAN[second] || "\u7075\u6D3B\u7684\u4E00\u9762"}\uFF0C\u56E0\u6B64\u5404\u79CD\u573A\u5408\u90FD\u5E94\u4ED8\u5F97\u6765\uFF0C\u9002\u5E94\u529B\u662F\u4F60\u7684\u957F\u5904\u3002`;
      }
      var SEASON_EMO = {
      ...
      var GOD_LOVE = {
        ...
        \u5B98: "\u611F\u60C5\u91CC\u4F60\u8BA4\u771F\u3001\u8D1F\u8D23\uFF0C\u8BA4\u5B9A\u4E86\u5C31\u60F3\u6709\u4E2A\u4EA4\u4EE3\uFF0C\u53EF\u9760\u662F\u4F60\u7684\u5E95\u8272\uFF1B\u53EA\u662F\u5BB9\u6613\u628A\u300C\u5E94\u8BE5\u300D\u770B\u5F97\u592A\u91CD\u3001\u8981\u6C42\u504F\u9AD8\u3002",
      ...
      var GOD_LOVE_SINGLE = {
        ...
        \u5B98: "\u4F60\u5BF9\u611F\u60C5\u614E\u91CD\uFF0C\u4E5F\u5BB9\u6613\u7528\u300C\u5E94\u8BE5\u300D\u53BB\u8861\u91CF\u5BF9\u65B9\uFF1B\u522B\u6025\u7740\u5957\u6807\u51C6\uFF0C\u5148\u5141\u8BB8\u81EA\u5DF1\u8F7B\u677E\u5730\u559C\u6B22\u4E00\u4E2A\u4EBA\u3002",
      ...
      var GOD_LOVE_PARTNER = {
        ...
        \u5B98: "\u522B\u628A\u300C\u5E94\u8BE5\u300D\u770B\u5F97\u592A\u91CD\u3001\u8981\u6C42\u592A\u9AD8\uFF1B\u5728\u611F\u60C5\u91CC\uFF0C\u653E\u677E\u6BD4\u5904\u5904\u5230\u4F4D\u66F4\u8BA9\u4EBA\u5B89\u5FC3\u3002",
        \u5747\u8861: "\u522B\u628A\u5728\u610F\u90FD\u81EA\u5DF1\u6536\u7740\uFF0C\u591A\u8BF4\u5FC3\u91CC\u8BDD\uFF0C\u4E5F\u7ED9\u5BF9\u65B9\u7167\u987E\u4F60\u7684\u673A\u4F1A\uFF0C\u5173\u7CFB\u624D\u4F1A\u8D8A\u8D70\u8D8A\u8FD1\u3002"
      };
      var TAOHUA_STAR = { \u7533: "\u9149", \u5B50: "\u9149", \u8FB0: "\u9149", \u5BC5: "\u536F", \u5348: "\u536F", \u620C: "\u536F", \u5DF3: "\u5348", \u9149: "\u5348", \u4E11: "\u5348", \u4EA5: "\u5B50", \u536F: "\u5B50", \u672A: "\u5B50" };
      function taohuaDesc(zhis, ctx) {
        const star = TAOHUA_STAR[zhis[0]];
        const at = [0, 1, 2, 3].filter((i) => zhis[i] === star);
        const n = at.length;
        const ex = !!(ctx && ctx.expressive);
        const key = at.includes(2) ? "\u65E5" : at.includes(1) ? "\u6708" : at.includes(3) ? "\u65F6" : "\u5E74";
        const STRONG = {
          \u65E5: [
            "\u4F60\u8EAB\u4E0A\u6709\u79CD\u8BA9\u4EBA\u653E\u677E\u7684\u6C14\u573A\uFF0C\u719F\u8D77\u6765\u4E4B\u540E\u5C24\u5176\u660E\u663E\uFF0C\u4EB2\u8FD1\u7684\u4EBA\u90FD\u613F\u610F\u8DDF\u4F60\u8BF4\u5FC3\u91CC\u8BDD\u3002",
            "\u4F60\u5728\u4EB2\u8FD1\u7684\u4EBA\u91CC\u6700\u6709\u5B58\u5728\u611F\uFF0C\u522B\u4EBA\u9047\u4E8B\u7B2C\u4E00\u4E2A\u60F3\u627E\u7684\u5F80\u5F80\u662F\u4F60\u3002"
          ],
          \u6708: [
            "\u4F60\u5728\u4EBA\u7FA4\u91CC\u663E\u773C\uFF0C\u573A\u9762\u4E0A\u7684\u4E8B\u4F60\u4E00\u7AD9\u51FA\u6765\u6C14\u6C1B\u5C31\u987A\uFF0C\u8BA4\u8BC6\u4EBA\u5BF9\u4F60\u4ECE\u6765\u4E0D\u96BE\u3002",
            "\u540C\u8F88\u91CC\u4F60\u662F\u88AB\u8BB0\u4F4F\u7684\u90A3\u4E00\u4E2A\uFF0C\u5171\u4E8B\u8FC7\u7684\u4EBA\u8FC7\u540E\u8FD8\u8BA4\u5F97\u4F60\u3002"
          ],
          \u65F6: [
            "\u4F60\u5728\u81EA\u5DF1\u7684\u5C0F\u5708\u5B50\u91CC\u5F88\u6709\u53F7\u53EC\u529B\uFF0C\u804A\u5F97\u6765\u7684\u4EBA\u613F\u610F\u957F\u671F\u8DDF\u7740\u4F60\u3002",
            "\u4F60\u7684\u9B45\u529B\u4E0D\u5728\u4EBA\u591A\u7684\u573A\u5408\uFF0C\u800C\u5728\u51E0\u4E2A\u4EBA\u7684\u5708\u5B50\u91CC\uFF0C\u5F85\u4E45\u4E86\u66F4\u663E\u3002"
          ],
          \u5E74: [
            "\u4F60\u81EA\u5C0F\u5C31\u8BA8\u4EBA\u559C\u6B22\uFF0C\u957F\u8F88\u7F18\u3001\u65E7\u53CB\u7F18\u90FD\u4E0D\u9519\uFF0C\u8001\u5173\u7CFB\u4E00\u76F4\u7559\u5F97\u4F4F\u3002",
            "\u4F60\u8EAB\u4E0A\u6709\u80A1\u8BA9\u4EBA\u613F\u610F\u4EB2\u8FD1\u7684\u52B2\uFF0C\u8BA4\u8BC6\u591A\u5E74\u7684\u4EBA\u8FD8\u613F\u610F\u5E38\u6765\u5F80\u3002"
          ]
        };
        const MILD = {
          \u65E5: [
            "\u4F60\u5BB9\u6613\u548C\u4EBA\u6295\u7F18\uFF0C\u5C24\u5176\u662F\u8D70\u8FD1\u4E4B\u540E\uFF0C\u76F8\u5904\u8D77\u6765\u8BA9\u4EBA\u8212\u670D\u3002",
            "\u4F60\u4E0D\u5F20\u626C\uFF0C\u4F46\u76F8\u5904\u4E45\u4E86\u522B\u4EBA\u4F1A\u4E3B\u52A8\u9760\u8FD1\u4F60\u3002"
          ],
          \u6708: [
            "\u4F60\u7684\u4EB2\u548C\u529B\u4E0D\u9519\uFF0C\u5171\u4E8B\u3001\u6765\u5F80\u4E2D\u5BB9\u6613\u9047\u5230\u804A\u5F97\u6765\u7684\u4EBA\u3002",
            "\u4F60\u5728\u573A\u9762\u4E0A\u4E0D\u5403\u4E8F\uFF0C\u9047\u5230\u5BF9\u8DEF\u7684\u4EBA\u4E5F\u5BB9\u6613\u8D70\u8FD1\u3002"
          ],
          \u65F6: [
            "\u4F60\u7684\u4EB2\u548C\u529B\u4E0D\u9519\uFF0C\u5728\u5C0F\u8303\u56F4\u91CC\u66F4\u653E\u5F97\u5F00\uFF0C\u719F\u4EBA\u9762\u524D\u662F\u53E6\u4E00\u4E2A\u4EBA\u3002",
            "\u4F60\u4E0D\u7231\u70ED\u95F9\uFF0C\u4F46\u5BF9\u4E0A\u773C\u7684\u4EBA\u4E00\u804A\u5C31\u80FD\u804A\u5230\u4E00\u5757\u3002"
          ],
          \u5E74: [
            "\u4F60\u7684\u4EB2\u548C\u529B\u4E0D\u9519\uFF0C\u8001\u4EA4\u60C5\u7EF4\u6301\u5F97\u597D\uFF0C\u8D70\u6563\u7684\u4EBA\u4E5F\u5BB9\u6613\u518D\u63A5\u4E0A\u3002",
            "\u4F60\u4E0E\u4EBA\u76F8\u5904\u6709\u5206\u5BF8\uFF0C\u65E7\u5173\u7CFB\u4E0A\u5F97\u7684\u5206\u6BD4\u65B0\u5173\u7CFB\u591A\u3002"
          ]
        };
        const SLOW = [
        ...
        if (ex) {
          ...
          const EX = {
            \u5370: ["\u4F60\u5F85\u4EBA\u539A\u9053\u3001\u6709\u8010\u5FC3\uFF0C\u522B\u4EBA\u613F\u610F\u628A\u4E8B\u6258\u4ED8\u7ED9\u4F60\uFF0C\u719F\u4E86\u4E4B\u540E\u5173\u7CFB\u5F88\u7A33\u3002", "\u4F60\u4E0E\u4EBA\u76F8\u5904\u8BB2\u5206\u5BF8\uFF0C\u4E0D\u4E3B\u52A8\u51D1\u70ED\u95F9\uFF0C\u4F46\u5BF9\u65B9\u9700\u8981\u65F6\u4F60\u603B\u5728\u3002"],
            \u98DF: ["\u4F60\u4F1A\u804A\u4E5F\u4F1A\u9017\uFF0C\u573A\u9762\u4E0A\u4E0D\u51B7\u573A\uFF0C\u8BA4\u8BC6\u4EBA\u5BF9\u4F60\u4E0D\u96BE\u3002", "\u4F60\u8BDD\u4E0D\u7B97\u591A\uFF0C\u4F46\u4E00\u5F00\u53E3\u5C31\u63A5\u5F97\u4F4F\uFF0C\u719F\u4EBA\u5708\u91CC\u5F88\u53D7\u6B22\u8FCE\u3002"],
            \u4F24: ["\u4F60\u8BF4\u8BDD\u6709\u610F\u601D\u3001\u6709\u950B\u8292\uFF0C\u5BB9\u6613\u88AB\u8BB0\u4F4F\uFF0C\u559C\u6B22\u4F60\u7684\u4EBA\u5F88\u559C\u6B22\u3002", "\u4F60\u4E0D\u523B\u610F\u5408\u7FA4\uFF0C\u89C2\u70B9\u9C9C\u660E\uFF0C\u5BF9\u4E0A\u773C\u7684\u4EBA\u53CD\u800C\u9ECF\u5F97\u7D27\u3002"],
            \u8D22: ["\u4F60\u4F1A\u6765\u4E8B\u3001\u62CE\u5F97\u6E05\uFF0C\u4EBA\u60C5\u5F80\u6765\u5904\u7406\u5F97\u6F02\u4EAE\uFF0C\u8DEF\u5B50\u6BD4\u4E00\u822C\u4EBA\u5BBD\u3002", "\u4F60\u4EA4\u4EBA\u91CD\u5B9E\u5728\u3001\u4E0D\u73A9\u865A\u7684\uFF0C\u76F8\u5904\u4E45\u4E86\u522B\u4EBA\u613F\u610F\u8DDF\u4F60\u529E\u4E8B\u3002"],
            \u5B98: ["\u4F60\u4E3E\u6B62\u5F97\u4F53\u3001\u8BA9\u4EBA\u653E\u5FC3\uFF0C\u573A\u9762\u4E0A\u5BB9\u6613\u88AB\u4FE1\u4EFB\u3002", "\u4F60\u4E0E\u4EBA\u4FDD\u6301\u5206\u5BF8\uFF0C\u719F\u5F97\u6162\uFF0C\u4F46\u4E00\u65E6\u8BA4\u4E0B\u5C31\u9760\u5F97\u4F4F\u3002"],
      ...
      var ADVICE_MOOD_SINGLE = {
        ...
        \u98DF: ["\u522B\u53EA\u51ED\u4E00\u65F6\u5FC3\u52A8\uFF0C\u591A\u770B\u770B\u5BF9\u65B9\u5728\u5E73\u6DE1\u65F6\u5019\u7684\u6837\u5B50", "\u628A\u65B0\u9C9C\u611F\u7528\u5728\u6DF1\u5165\u4E86\u89E3\u4E00\u4E2A\u4EBA\u4E0A\uFF0C\u800C\u4E0D\u662F\u4E0D\u65AD\u6362\u4EBA"],
        \u8D22: ["\u522B\u628A\u62E9\u5076\u5F53\u6210\u7B5B\u6761\u4EF6\uFF0C\u5148\u8BA9\u4EBA\u559C\u6B22\u4E0A\u4F60\u8FD9\u4E2A\u4EBA", "\u7EA6\u4F1A\u65F6\u4E13\u5FC3\u76F8\u5904\uFF0C\u522B\u6025\u7740\u8C08\u672A\u6765\u89C4\u5212\u548C\u5F97\u5931"],
        \u5B98: ["\u522B\u4E00\u4E0A\u6765\u5C31\u7528\u957F\u671F\u6807\u51C6\u5BA1\u89C6\u5BF9\u65B9\uFF0C\u5148\u4EAB\u53D7\u76F8\u5904\u672C\u8EAB", "\u653E\u4E0B\u300C\u5FC5\u987B\u5408\u9002\u300D\u7684\u5305\u88B1\uFF0C\u611F\u89C9\u5BF9\u4E86\u4E5F\u5F88\u91CD\u8981"],
        \u5747\u8861: ["\u522B\u603B\u8868\u73B0\u5F97\u4EC0\u4E48\u90FD\u597D\uFF0C\u9002\u5EA6\u793A\u5F31\u53CD\u800C\u8BA9\u4EBA\u60F3\u9760\u8FD1", "\u6709\u597D\u611F\u5C31\u4E3B\u52A8\u8868\u8FBE\uFF0C\u522B\u603B\u7B49\u5BF9\u65B9\u5148\u5F00\u53E3"]
      };
      var ADVICE_MOOD_PARTNER = {
        \u5370: ["\u5B9A\u671F\u8BF4\u51FA\u81EA\u5DF1\u7684\u9700\u8981\u548C\u611F\u53D7\uFF0C\u522B\u9ED8\u8BA4\u81EA\u5DF1\u5C31\u8BE5\u662F\u4ED8\u51FA\u7684\u4E00\u65B9", "\u8BA9\u5BF9\u65B9\u4E5F\u6709\u673A\u4F1A\u4E3A\u4F60\u505A\u70B9\u4EC0\u4E48\uFF0C\u88AB\u9700\u8981\u4E5F\u662F\u4E00\u79CD\u4EB2\u5BC6"],
        \u98DF: ["\u628A\u5FC3\u91CC\u8BDD\u76F4\u63A5\u8BB2\u7ED9\u5BF9\u65B9\u542C\uFF0C\u522B\u7528\u73A9\u7B11\u7ED5\u8FC7\u53BB", "\u628A\u8FFD\u65B0\u9C9C\u7684\u52B2\u5934\uFF0C\u7528\u5728\u7ED9\u540C\u4E00\u4E2A\u4EBA\u5236\u9020\u60CA\u559C\u4E0A"],
        \u8D22: ["\u966A\u4F34\u65F6\u5C31\u4E13\u5FC3\u966A\u7740\uFF0C\u628A\u624B\u5934\u7684\u4E8B\u5148\u653E\u4E00\u653E", "\u591A\u95EE\u95EE\u5BF9\u65B9\u7684\u5FC3\u60C5\uFF0C\u800C\u4E0D\u53EA\u662F\u89E3\u51B3\u5BF9\u65B9\u7684\u95EE\u9898"],
        \u5B98: ["\u591A\u7ED9\u80AF\u5B9A\u3001\u5C11\u6311\u6BDB\u75C5\uFF0C\u5BF9\u65B9\u4E0D\u662F\u4F60\u7684\u9879\u76EE", "\u628A\u5728\u610F\u76F4\u63A5\u8BF4\u51FA\u6765\uFF0C\u522B\u7AEF\u7740\u300C\u6211\u6CA1\u4E8B\u300D"],
        \u5747\u8861: ["\u628A\u5FC3\u91CC\u7684\u5728\u610F\u548C\u987E\u8651\u76F4\u63A5\u8BF4\u51FA\u6765\uFF0C\u522B\u81EA\u5DF1\u6D88\u5316", "\u9700\u8981\u65F6\u5927\u65B9\u6C42\u52A9\uFF0C\u8BA9\u5BF9\u65B9\u6709\u673A\u4F1A\u642D\u628A\u624B"]
      };
      var GOD_LOVE_ACT = {
        \u5370: { dos: ["\u5B9A\u671F\u8BF4\u51FA\u81EA\u5DF1\u7684\u9700\u8981\u548C\u611F\u53D7", "\u8BA9\u5BF9\u65B9\u4E5F\u6709\u673A\u4F1A\u4E3A\u4F60\u4ED8\u51FA"], avoid: ["\u4E60\u60EF\u6027\u5FCD\u8BA9\uFF0C\u6709\u59D4\u5C48\u4E5F\u4E0D\u8BB2"] },
        \u98DF: { dos: ["\u628A\u5FC3\u91CC\u8BDD\u76F4\u63A5\u8BB2\u7ED9\u5BF9\u65B9\u542C", "\u628A\u65B0\u9C9C\u611F\u7528\u5728\u540C\u4E00\u4E2A\u4EBA\u8EAB\u4E0A"], avoid: ["\u4E00\u9047\u5E73\u6DE1\u5C31\u60F3\u62BD\u8EAB"] },
        \u8D22: { dos: ["\u966A\u4F34\u65F6\u5C31\u4E13\u5FC3\u966A\u7740\uFF0C\u628A\u4E8B\u5148\u653E\u4E00\u653E", "\u4E3B\u52A8\u95EE\u95EE\u5BF9\u65B9\u7684\u5FC3\u60C5\uFF0C\u800C\u4E0D\u53EA\u662F\u9700\u6C42"], avoid: ["\u7528\u89E3\u51B3\u95EE\u9898\u7684\u65B9\u5F0F\u56DE\u5E94\u60C5\u7EEA"] },
        \u5B98: { dos: ["\u591A\u7ED9\u80AF\u5B9A\uFF0C\u5C11\u6311\u6BDB\u75C5", "\u628A\u5728\u610F\u76F4\u63A5\u8BF4\u51FA\u6765\uFF0C\u522B\u7AEF\u7740"], avoid: ["\u7528\u300C\u6807\u51C6\u300D\u8981\u6C42\u5BF9\u65B9\u7684\u4E00\u4E3E\u4E00\u52A8"] },
        \u5747\u8861: { dos: ["\u628A\u5FC3\u91CC\u7684\u5728\u610F\u548C\u987E\u8651\u76F4\u63A5\u8BF4\u51FA\u6765", "\u9700\u8981\u65F6\u5927\u65B9\u5F00\u53E3\u6C42\u52A9\u3001\u8BA9\u5BF9\u65B9\u642D\u628A\u624B"], avoid: ["\u4EC0\u4E48\u90FD\u81EA\u5DF1\u6D88\u5316\u3001\u62A5\u559C\u4E0D\u62A5\u5FE7"] }
      };
      var GOD_WORK = {
      ...
      var SPOUSE_LINE = {
        \u5973: {
          ...
          \u85CF: { \u559C: "\u4F60\u8981\u7684\u662F\u8E0F\u5B9E\u7684\u5173\u7CFB\uFF0C\u7F18\u5206\u6765\u5F97\u4E0D\u5F20\u626C\uFF0C\u591A\u5728\u719F\u4EBA\u5708\u91CC\u3002", \u5FCC: "\u4F60\u5728\u611F\u60C5\u91CC\u5BB9\u6613\u987A\u7740\u5BF9\u65B9\u8D70\uFF0C\u4E45\u4E86\u89C9\u5F97\u7D2F\u3002", \u5E73: "\u4F60\u4E0D\u6025\u4E8E\u5B9A\u4E0B\u6765\uFF0C\u611F\u60C5\u591A\u662F\u6162\u6162\u8D70\u8FD1\u3002" },
          \u65E0: { \u559C: "\u4F60\u4E0D\u592A\u6309\u4E16\u4FD7\u6807\u51C6\u6311\u4EBA\uFF0C\u5408\u5F97\u6765\u6BD4\u6761\u4EF6\u66F4\u91CD\u8981\u3002", \u5FCC: "\u4F60\u4E0D\u613F\u88AB\u5173\u7CFB\u675F\u7F1A\uFF0C\u66F4\u770B\u91CD\u81EA\u5DF1\u7684\u8282\u594F\u3002", \u5E73: "\u4F60\u5BF9\u611F\u60C5\u6CA1\u6709\u56FA\u5B9A\u6A21\u677F\uFF0C\u9047\u5230\u8C01\u5C31\u662F\u8C01\u3002" }
        },
        \u7537: {
          \u663E: { \u559C: "\u611F\u60C5\u91CC\u4F60\u8981\u7684\u662F\u80FD\u4E00\u8D77\u628A\u65E5\u5B50\u8FC7\u597D\u7684\u4EBA\uFF0C\u8FD9\u6837\u7684\u4EBA\u4E5F\u5BB9\u6613\u8D70\u8FD1\u4F60\u3002", \u5FCC: "\u4F60\u5BB9\u6613\u88AB\u5438\u5F15\u5F97\u5FEB\uFF0C\u4E5F\u5BB9\u6613\u4E3A\u611F\u60C5\u64CD\u5FC3\u7834\u8D39\u3002", \u5E73: "\u4F60\u5728\u611F\u60C5\u91CC\u52A1\u5B9E\uFF0C\u770B\u91CD\u76F8\u5904\u662F\u5426\u8212\u670D\u3002" },
          \u85CF: { \u559C: "\u7F18\u5206\u4E0D\u5F20\u626C\uFF0C\u591A\u5728\u65E5\u5E38\u6765\u5F80\u91CC\u6162\u6162\u6210\u3002", \u5FCC: "\u4F60\u5BF9\u611F\u60C5\u7684\u4ED8\u51FA\u5E38\u8D85\u8FC7\u56DE\u62A5\uFF0C\u5BB9\u6613\u7D2F\u3002", \u5E73: "\u4F60\u4E0D\u6025\u7740\u5B9A\u4E0B\u6765\uFF0C\u611F\u60C5\u591A\u662F\u6C34\u5230\u6E20\u6210\u3002" },
          \u65E0: { \u559C: "\u4F60\u4E0D\u6309\u6761\u4EF6\u6311\u4EBA\uFF0C\u6295\u7F18\u6700\u8981\u7D27\u3002", \u5FCC: "\u4F60\u628A\u7CBE\u529B\u591A\u653E\u5728\u81EA\u5DF1\u7684\u4E8B\u4E0A\uFF0C\u611F\u60C5\u6392\u5728\u540E\u9762\u3002", \u5E73: "\u4F60\u5BF9\u611F\u60C5\u6CA1\u6709\u56FA\u5B9A\u6A21\u677F\uFF0C\u9047\u5230\u8C01\u5C31\u662F\u8C01\u3002" }
        }
      };
      ...
      function buildPersona(mj, chart) {
        ...
        let expressLine = daySuppressed && !mj.isYinHeavyWeak ? "\u5FC3\u91CC\u7684\u4E8B\u591A\u662F\u81EA\u5DF1\u6D88\u5316\uFF0C\u4E0D\u592A\u5F80\u5916\u644A\uFF0C" : innerType ? EXPRESS_INNER[dayGan] : EXPRESS[dayGan] || YINYANG_TURN[yinyang];
        const EXPR_TRIM = {
          "\u8868\u9762\u5E94\u5BF9\u5F97\u4F53\uFF0C\u771F\u6B63\u7684\u5FC3\u4E8B\u7559\u7ED9\u81EA\u5DF1\u6D88\u5316\uFF0C": ["\u5185", "\u8868\u9762\u5E94\u5BF9\u5F97\u4F53\uFF0C"],
          "\u5F88\u5728\u610F\u522B\u4EBA\u7684\u611F\u53D7\uFF0C\u81EA\u5DF1\u7684\u5FC3\u4E8B\u5374\u4E0D\u592A\u8BF4\uFF0C": ["\u5185", "\u5F88\u5728\u610F\u522B\u4EBA\u7684\u611F\u53D7\uFF0C"],
          "\u5E38\u628A\u522B\u4EBA\u7684\u96BE\u5904\u653E\u5728\u5FC3\u4E0A\uFF0C\u81EA\u5DF1\u7684\u59D4\u5C48\u5374\u4E0D\u592A\u8BF4\u51FA\u53E3\uFF0C": ["\u5185", "\u5E38\u628A\u522B\u4EBA\u7684\u96BE\u5904\u653E\u5728\u5FC3\u4E0A\uFF0C"],
          "\u5FC3\u4E8B\u4E0D\u8F7B\u6613\u8868\u9732\uFF0C\u81EA\u5DF1\u5FC3\u91CC\u6709\u5206\u5BF8\uFF0C": ["\u5185", "\u81EA\u5DF1\u5FC3\u91CC\u6709\u5206\u5BF8\uFF0C"],
          "\u518D\u5927\u7684\u60C5\u7EEA\u4E5F\u538B\u5F97\u4F4F\uFF0C\u4E0D\u8F7B\u6613\u8868\u9732\uFF0C": ["\u5185", ""],
          "\u4E60\u60EF\u628A\u4E8B\u5F80\u5FC3\u91CC\u653E\uFF0C\u5374\u4E0D\u8F7B\u6613\u8BF4\u51FA\u6765\uFF0C": ["\u5185", ""],
          "\u5FC3\u91CC\u7684\u4E8B\u591A\u662F\u81EA\u5DF1\u6D88\u5316\uFF0C\u4E0D\u592A\u5F80\u5916\u644A\uFF0C": ["\u5185", ""],
          "\u5FC3\u4E8B\u591A\u81EA\u5DF1\u6D88\u5316\uFF0C": ["\u5185", ""],
        ...
        const _socialEarly = P.social;
        const { expressive, guanYa } = P;
        ...
        const MONTH_ROOT = {
          \u5370: "\u4F60\u7684\u4E8B\u4E1A\u6839\u57FA\u5728\u4E13\u4E1A\u548C\u8D44\u5386\uFF0C\u8D8A\u505A\u8D8A\u503C\u94B1\u7684\u662F\u79EF\u7D2F\u3002",
          \u98DF: "\u4F60\u7684\u4E8B\u4E1A\u6839\u57FA\u5728\u624B\u827A\u548C\u8868\u8FBE\uFF0C\u4F5C\u54C1\u6BD4\u5934\u8854\u66F4\u80FD\u7ACB\u4F4F\u3002",
          \u8D22: "\u4F60\u7684\u4E8B\u4E1A\u6839\u57FA\u5728\u7ECF\u8425\u548C\u7ED3\u679C\uFF0C\u80FD\u7B97\u6E05\u8D26\u3001\u62FF\u5F97\u51FA\u6210\u7EE9\u7684\u4F4D\u7F6E\u6700\u7A33\u3002",
          \u5B98: "\u4F60\u7684\u4E8B\u4E1A\u6839\u57FA\u5728\u4F53\u5236\u548C\u804C\u4F4D\uFF0C\u6309\u89C4\u5219\u8D70\u7684\u5730\u65B9\u4F60\u4E0A\u5347\u6700\u5FEB\u3002",
          \u6BD4: "\u4F60\u7684\u4E8B\u4E1A\u6839\u57FA\u5728\u540C\u4F34\u548C\u81EA\u7ACB\uFF0C\u5408\u4F19\u6216\u72EC\u7ACB\u505A\u90FD\u6BD4\u7ED9\u4EBA\u6253\u5DE5\u987A\u3002"
        };
        const monthGod = tenGodType(dayWx, ZHI_WX[mj.monthZhi]);
        const rootLine = monthGod !== dominant && MONTH_ROOT[monthGod] || "";
        const YIMA = { \u7533: "\u5BC5", \u5B50: "\u5BC5", \u8FB0: "\u5BC5", \u5BC5: "\u7533", \u5348: "\u7533", \u620C: "\u7533", \u5DF3: "\u4EA5", \u9149: "\u4EA5", \u4E11: "\u4EA5", \u4EA5: "\u5DF3", \u536F: "\u5DF3", \u672A: "\u5DF3" };
        const hasYiMa = (chart.zhis || []).some((z, i) => i !== 0 && z === YIMA[chart.zhis[0]]);
        const yiMaLine = hasYiMa ? "\u4F60\u9002\u5408\u6D41\u52A8\u3001\u5916\u52E4\u6216\u5F02\u5730\u7684\u5DE5\u4F5C\uFF0C\u6362\u5730\u65B9\u53CD\u800C\u66F4\u505A\u5F97\u5F00\u3002" : "";
        const work = `${workBase}${rootLine}${POL_WORK[pol] || ""}${yiMaLine}`;
        let closing;
        if (balanced) {
      ...
      function natalInternalRelations(chart) {
        const P = natalPillars(chart);
        const out = [];
      ...
      var PAIR_TENSION = {
        \u5E74\u6708: { t: "\u4F60\u5F88\u65E9\u5C31\u5B66\u4F1A\u4E86\u9760\u81EA\u5DF1", s: "\u65E9\u5E74\u5BB6\u91CC\u7684\u52A9\u529B\u4E0D\u591A\uFF0C\u4F60\u7684\u8DEF\u9760\u81EA\u5DF1\u8D70\u51FA\u6765\u3002\u8FD9\u8BA9\u4F60\u6BD4\u540C\u9F84\u4EBA\u66F4\u65E9\u72EC\u7ACB\u3001\u66F4\u625B\u5F97\u4F4F\u4E8B\uFF0C\u53EA\u662F\u4E5F\u5BB9\u6613\u628A\u81EA\u5DF1\u903C\u5F97\u592A\u7D27\uFF0C\u5FD8\u4E86\u4F11\u606F\u3002" },
        \u5E74\u65E5: { t: "\u539F\u751F\u5BB6\u5EAD\uFF0C\u5BF9\u4F60\u6709\u8F83\u6DF1\u7684\u5F71\u54CD", s: "\u4F60\u548C\u5BB6\u91CC\uFF0C\u591A\u5C11\u6709\u8FC7\u6CA1\u771F\u6B63\u8BF4\u5F00\u7684\u7ED3\uFF0C\u5B83\u4F1A\u6084\u6084\u5F71\u54CD\u4F60\u5982\u4F55\u9760\u8FD1\u4E00\u4E2A\u4EBA\uFF1A\u65E2\u6E34\u671B\u88AB\u597D\u597D\u5BF9\u5F85\uFF0C\u53C8\u672C\u80FD\u5730\u7559\u4E00\u5206\u4F59\u5730\u3002" },
      ...
      function buildDialectics(mj, chart) {
        ...
        if (!picked.length) {
          const FB = {
            \u8EAB\u5F3A: { t: "\u4F60\u7684\u5E95\u6C14\uFF0C\u662F\u81EA\u5DF1\u7ED9\u7684", s: "\u4F60\u5E95\u5B50\u8DB3\u3001\u80FD\u81EA\u7ACB\uFF0C\u8BA4\u51C6\u7684\u4E8B\u625B\u5F97\u8D77\u4E5F\u63A8\u5F97\u52A8\uFF1B\u5927\u5904\u7740\u624B\uFF0C\u7559\u4E09\u5206\u4F59\u529B\u3002" },
            \u504F\u5F3A: { t: "\u97E7\u6027\uFF0C\u662F\u4F60\u6700\u7A33\u7684\u672C\u94B1", s: "\u4F60\u72EC\u7ACB\u6709\u97E7\u6027\uFF0C\u538B\u529B\u4E4B\u4E0B\u66F4\u89C1\u6210\u8272\uFF1B\u7A33\u6B65\u63A8\u8FDB\uFF0C\u4E0D\u5FC5\u4E8B\u4E8B\u7EF7\u7D27\u3002" },
            \u4E2D\u548C: { t: "\u80FD\u653B\u80FD\u5B88\uFF0C\u662F\u4F60\u7684\u4ECE\u5BB9", s: "\u4F60\u5404\u9762\u5747\u8861\u3001\u8FDB\u9000\u6709\u5EA6\uFF0C\u987A\u5883\u80FD\u4E0A\u3001\u9006\u5883\u80FD\u7A33\uFF0C\u6309\u81EA\u5DF1\u7684\u8282\u594F\u5373\u53EF\u3002" },
            \u504F\u5F31: { t: "\u4F60\u7684\u987A\uFF0C\u591A\u5728\u4EBA\u548C", s: "\u4F60\u5584\u501F\u4EBA\u529B\u3001\u5F97\u9053\u591A\u52A9\uFF0C\u6709\u4EBA\u642D\u4F19\u65F6\u6700\u89C1\u53D1\u6325\uFF0C\u7ED3\u4F34\u6210\u4E8B\u6700\u987A\u3002" },
            \u8EAB\u5F31: { t: "\u5584\u7528\u5916\u529B\uFF0C\u662F\u4F60\u7684\u667A\u6167", s: "\u4F60\u61C2\u5F97\u501F\u52BF\u501F\u529B\u3001\u805A\u62E2\u4EBA\u548C\uFF1B\u517B\u8DB3\u7CBE\u795E\uFF0C\u518D\u56FE\u8FDB\u53D6\u3002" },
            \u4ECE\u5F31: { t: "\u501F\u52BF\u800C\u884C\uFF0C\u662F\u4F60\u7684\u5929\u8D4B", s: "\u4F60\u8BC6\u52BF\u3001\u987A\u52BF\uFF0C\u8DDF\u5BF9\u65B9\u5411\u4FBF\u4E8B\u534A\u529F\u500D\uFF0C\u62E9\u52BF\u800C\u4ECE\u6700\u7A33\u3002" },
      ...
      var STRENGTH_LINE = {
        \u8EAB\u5F3A: {
          ...
          \u559C\u706B: "\u4F60\u5E95\u5B50\u8DB3\uFF0C\u5DEE\u4E00\u628A\u706B\uFF1A\u628A\u60F3\u6CD5\u7AEF\u51FA\u53BB\u89C1\u4EBA\u3001\u89C1\u5149\uFF0C\u6BD4\u95F7\u5934\u505A\u66F4\u5212\u7B97\u3002",
          \u559C\u571F: "\u4F60\u5E95\u5B50\u8DB3\uFF0C\u7F3A\u7684\u662F\u6536\u53E3\uFF1A\u644A\u5B50\u522B\u518D\u94FA\uFF0C\u628A\u624B\u4E0A\u7684\u6C89\u6DC0\u6210\u578B\u3002",
          "\u2014": "\u4F60\u5E95\u5B50\u8DB3\u3001\u80FD\u72EC\u5F53\u4E00\u9762\uFF0C\u505A\u4E8B\u63A8\u5F97\u52A8\uFF1B\u4E0D\u5FC5\u731B\u51B2\uFF0C\u7559\u51FA\u4F59\u529B\u3002"
        },
        \u504F\u5F3A: {
          isVentDamp: "\u4F60\u6709\u97E7\u6027\uFF0C\u53EA\u662F\u7ED9\u51FA\u53BB\u7684\u591A\u3001\u56DE\u6765\u7684\u5C11\uFF1B\u8BE5\u6536\u7684\u6536\u4E00\u6536\uFF0C\u522B\u53EA\u505A\u90A3\u4E2A\u6258\u5E95\u7684\u4EBA\u3002",
          \u559C\u91D1: "\u4F60\u505A\u4E8B\u72EC\u7ACB\u3001\u625B\u5F97\u4F4F\uFF1B\u5173\u952E\u5728\u6562\u62CD\u677F\uFF0C\u522B\u628A\u8BE5\u5B9A\u7684\u4E8B\u4E00\u62D6\u518D\u62D6\u3002",
          \u559C\u6728: "\u4F60\u505A\u4E8B\u72EC\u7ACB\u3001\u625B\u5F97\u4F4F\uFF1B\u591A\u5F80\u5916\u8D70\u8D70\u3001\u63A5\u70B9\u65B0\u4E1C\u897F\uFF0C\u522B\u628A\u81EA\u5DF1\u5173\u5728\u719F\u6089\u7684\u5708\u91CC\u3002",
          \u559C\u6C34: "\u4F60\u505A\u4E8B\u72EC\u7ACB\u3001\u625B\u5F97\u4F4F\uFF1B\u522B\u4E00\u6761\u8DEF\u8D70\u5230\u9ED1\uFF0C\u7559\u4E00\u70B9\u56DE\u65CB\u4F59\u5730\u3002",
          \u559C\u706B: "\u4F60\u505A\u4E8B\u72EC\u7ACB\u3001\u625B\u5F97\u4F4F\uFF1B\u628A\u6210\u679C\u4EAE\u51FA\u6765\uFF0C\u522B\u603B\u7B49\u522B\u4EBA\u53D1\u73B0\u3002",
          \u559C\u571F: "\u4F60\u505A\u4E8B\u72EC\u7ACB\u3001\u625B\u5F97\u4F4F\uFF1B\u628A\u624B\u4E0A\u7684\u4E8B\u4E00\u4EF6\u4EF6\u6536\u53E3\uFF0C\u6BD4\u518D\u5F00\u65B0\u644A\u5B50\u5B9E\u5728\u3002",
          "\u2014": "\u4F60\u505A\u4E8B\u72EC\u7ACB\u3001\u6709\u97E7\u6027\uFF0C\u625B\u5F97\u4F4F\u538B\u529B\uFF1B\u63A8\u8FDB\u65F6\u7559\u4E00\u624B\uFF0C\u522B\u628A\u81EA\u5DF1\u7EF7\u5F97\u592A\u7D27\u3002"
        },
        \u4E2D\u548C: {
          isVentDamp: "\u4F60\u80FD\u653B\u80FD\u5B88\uFF0C\u53EA\u662F\u64CD\u5FC3\u7684\u4E8B\u591A\u3001\u8017\u5F97\u4E5F\u5FEB\uFF1B\u628A\u7CBE\u529B\u5206\u6E05\u4E3B\u6B21\uFF0C\u522B\u5904\u5904\u4F7F\u529B\u3002",
          dayRootless: "\u4F60\u80FD\u653B\u80FD\u5B88\uFF0C\u4F46\u81EA\u5DF1\u8FD9\u5934\u6839\u57FA\u8FD8\u6D45\uFF1B\u5148\u628A\u4E00\u6837\u672C\u4E8B\u7EC3\u624E\u5B9E\uFF0C\u5E95\u6C14\u5C31\u7A33\u4E86\u3002",
          \u559C\u91D1: "\u4F60\u80FD\u653B\u80FD\u5B88\u3001\u9047\u4E8B\u6709\u5F39\u6027\uFF1B\u8BE5\u5B9A\u7684\u4E8B\u5B9A\u4E0B\u6765\uFF0C\u522B\u5728\u9009\u62E9\u91CC\u8017\u592A\u4E45\u3002",
          \u559C\u6728: "\u4F60\u80FD\u653B\u80FD\u5B88\u3001\u9047\u4E8B\u6709\u5F39\u6027\uFF1B\u8FD9\u4E24\u5E74\u9002\u5408\u5F80\u5916\u4F38\u4E00\u6B65\uFF0C\u522B\u5B88\u6210\u60EF\u4E86\u3002",
          \u559C\u6C34: "\u4F60\u80FD\u653B\u80FD\u5B88\u3001\u9047\u4E8B\u6709\u5F39\u6027\uFF1B\u591A\u542C\u3001\u591A\u5B66\uFF0C\u601D\u8DEF\u6D3B\u4E86\u8DEF\u5C31\u5BBD\u3002",
          \u559C\u706B: "\u4F60\u80FD\u653B\u80FD\u5B88\u3001\u9047\u4E8B\u6709\u5F39\u6027\uFF1B\u628A\u52B2\u7528\u5728\u80FD\u88AB\u770B\u89C1\u7684\u5730\u65B9\uFF0C\u6548\u679C\u66F4\u5FEB\u3002",
          \u559C\u571F: "\u4F60\u80FD\u653B\u80FD\u5B88\u3001\u9047\u4E8B\u6709\u5F39\u6027\uFF1B\u628A\u6839\u57FA\u548C\u79EF\u84C4\u505A\u539A\uFF0C\u8D70\u5F97\u66F4\u7A33\u3002",
          "\u2014": "\u4F60\u80FD\u653B\u80FD\u5B88\u3001\u6BD4\u8F83\u7A33\uFF0C\u9047\u4E8B\u6709\u5F39\u6027\uFF0C\u6309\u81EA\u5DF1\u7684\u8282\u594F\u6765\u3002"
        },
        \u504F\u5F31: {
          isGuanShaWeak: "\u5916\u9762\u7684\u8981\u6C42\u548C\u538B\u529B\u538B\u5F97\u7D27\uFF0C\u4F60\u7684\u4F59\u529B\u88AB\u6324\u5F97\u4E0D\u591A\uFF1B\u5148\u628A\u8BE5\u625B\u7684\u6311\u51FA\u6765\uFF0C\u5176\u4F59\u7684\u63A8\u6389\u4E0D\u4E22\u4EBA\u3002",
          dayRootless: "\u4F60\u81EA\u5DF1\u8FD9\u5934\u6839\u57FA\u504F\u8584\uFF0C\u9760\u73AF\u5883\u548C\u4EBA\u63A5\u4F4F\u4F1A\u66F4\u987A\uFF1B\u5148\u628A\u4E00\u95E8\u5403\u996D\u7684\u672C\u4E8B\u7EC3\u719F\u3002",
          isVentDamp: "\u4F60\u7ED9\u51FA\u53BB\u7684\u591A\u3001\u56DE\u6765\u7684\u5C11\uFF1B\u5148\u628A\u7CBE\u529B\u548C\u4EBA\u60C5\u7684\u51FA\u53E3\u6536\u4E00\u6536\uFF0C\u518D\u8C08\u5F80\u524D\u51B2\u3002",
          isYinHeavyWeak: "\u7167\u987E\u4F60\u3001\u66FF\u4F60\u5B89\u6392\u7684\u4EBA\u548C\u4E8B\u592A\u591A\uFF0C\u53CD\u800C\u628A\u4F60\u81EA\u5DF1\u7684\u52B2\u76D6\u4F4F\u4E86\uFF1B\u6709\u4E9B\u4E8B\u81EA\u5DF1\u62FF\u4E3B\u610F\uFF0C\u529B\u6C14\u624D\u957F\u5F97\u51FA\u6765\u3002",
          "\u2014": "\u4F60\u6709\u4EBA\u642D\u4F19\u3001\u6709\u4EBA\u5E2E\u886C\u65F6\u66F4\u987A\uFF1B\u5148\u628A\u624B\u5934\u7684\u6839\u57FA\u7A33\u4F4F\uFF0C\u518D\u6162\u6162\u53D1\u529B\u3002"
        },
        \u8EAB\u5F31: {
          isGuanShaWeak: "\u5916\u9762\u538B\u7740\u4F60\u7684\u4E1C\u897F\u4E0D\u5C11\uFF0C\u786C\u9876\u6700\u5403\u4E8F\uFF1B\u6311\u4E00\u4E24\u4EF6\u771F\u8981\u7D27\u7684\u625B\uFF0C\u5176\u4F59\u7684\u5F80\u540E\u653E\u3002",
          isYinHeavyWeak: "\u8EAB\u8FB9\u7167\u5E94\u4F60\u7684\u529B\u91CF\u592A\u539A\uFF0C\u53CD\u5012\u538B\u4F4F\u4E86\u4F60\u81EA\u5DF1\u7684\u52B2\uFF1B\u81EA\u5DF1\u505A\u4E3B\u7684\u4E8B\u591A\u4E00\u4EF6\uFF0C\u5E95\u6C14\u5C31\u591A\u4E00\u5206\u3002",
          isShaYinRescue: "\u62C5\u5B50\u91CD\uFF0C\u597D\u5728\u6709\u4EBA\u6491\u8170\u3001\u6709\u5E95\u5B50\u63A5\u7740\uFF1B\u522B\u4E00\u4E2A\u4EBA\u625B\uFF0C\u8BE5\u501F\u7684\u529B\u90FD\u501F\u4E0A\u3002",
          dayRootless: "\u4F60\u81EA\u5DF1\u8FD9\u5934\u6839\u57FA\u8584\uFF0C\u987A\u7740\u73AF\u5883\u8D70\u6BD4\u9006\u7740\u4F7F\u52B2\u7701\u529B\uFF1B\u5148\u627E\u4E00\u5904\u7AD9\u7A33\uFF0C\u518D\u8C08\u5F80\u4E0A\u3002",
          isVentDamp: "\u4F60\u7684\u7CBE\u529B\u603B\u5F80\u5916\u6DCC\uFF1A\u5E2E\u4EBA\u3001\u63A5\u4E8B\u3001\u64CD\u5FC3\uFF1B\u628A\u51FA\u53E3\u5173\u6389\u4E24\u4E2A\uFF0C\u4EBA\u5C31\u7F13\u8FC7\u6765\u4E86\u3002",
          "\u2014": "\u4F60\u66F4\u9002\u5408\u501F\u52A9\u4ED6\u4EBA\u7684\u529B\u91CF\u548C\u73AF\u5883\u7684\u652F\u6301\uFF1B\u5148\u628A\u8EAB\u8FB9\u7684\u4EBA\u548C\u8282\u594F\u5B89\u6392\u597D\uFF0C\u517B\u8DB3\u7CBE\u529B\u518D\u4E0A\u3002"
        },
        \u4ECE\u5F31: {
          isCong: "\u4F60\u4E0D\u9002\u5408\u6B63\u9762\u786C\u62FC\uFF0C\u987A\u7740\u5927\u52BF\u8D70\u6700\u7701\u529B\uFF1B\u501F\u522B\u4EBA\u7684\u52BF\u5934\uFF0C\u53CD\u800C\u66F4\u7A33\u3002",
          "\u2014": "\u4F60\u4E0D\u9002\u5408\u6B63\u9762\u786C\u62FC\uFF0C\u987A\u7740\u5927\u52BF\u8D70\u6700\u7701\u529B\uFF1B\u501F\u522B\u4EBA\u7684\u52BF\u5934\uFF0C\u53CD\u800C\u66F4\u7A33\u3002"
        },
        \u4ECE\u5F3A: {
          isZhuanWang: "\u4F60\u8FD9\u80A1\u52B2\u5F88\u7EAF\uFF0C\u987A\u7740\u5B83\u8D70\u6700\u987A\uFF1B\u522B\u4E3A\u4E86\u300C\u5747\u8861\u300D\u53BB\u505A\u8FDD\u80CC\u6027\u5B50\u7684\u4E8B\u3002",
          "\u2014": "\u4F60\u8FD9\u80A1\u52B2\u5F88\u7EAF\uFF0C\u987A\u7740\u5B83\u8D70\u6700\u987A\uFF1B\u522B\u4E3A\u4E86\u300C\u5747\u8861\u300D\u53BB\u505A\u8FDD\u80CC\u6027\u5B50\u7684\u4E8B\u3002"
        }
      };
      ...
      function buildNatal(mj, chart) {
        ...
        const strengthHedge = strengthHedgeOf(mj.strength, mj.bodyT);
        const xiW = mj.xiYongWeight || {};
        const xiYong = mj.xiYong.map((wx, i) => {
          const info = WX_INFO[wx];
          const t = tenGodType(dayWx, wx);
          const god = GOD_LIFE[t] || { name: "", good: "", caution: "" };
          const weight = xiW[wx] ?? 1;
          const isPrimary = i === 0;
          ...
          return {
            ...
            godName: god.name,
            godGood: god.good,
            dos: (god.doHi || []).slice(0, 3),
            // 具体可执行项:让「给你的建议」从一句话变成可照做的小清单
            dir: info.dir,
            season: info.season,
            time: info.time,
            organ: info.organ,
        ...
        const jiScored = mj.jiShen.map((wx) => ({
          wx,
          share: Math.max(0, (mj.weights || {})[wx] || 0) / wsumJi,
          depth: -((mj.favVec || {})[wx] ?? 0)
        }));
        jiScored.forEach((o) => {
          o.score = o.share + o.depth;
        });
        const topScore = Math.max(0, ...jiScored.map((o) => o.score));
        const jiShen = jiScored.map((o) => {
          const wx = o.wx, t = tenGodType(dayWx, wx);
          const god = GOD_LIFE[t] || { name: "", caution: "" };
          const act = JI_ACT[t];
          let caution;
          if (!act) {
            caution = god.caution;
          } else {
            const isTop = o.score === topScore && (o.share >= 0.18 || o.depth >= 0.5);
            caution = isTop ? `\u6700\u8981\u7559\u5FC3\uFF1A${act}` : act;
          }
          return { wx, godName: god.name, caution, color: WX_COLOR[wx] };
        });
        ...
        return {
          ...
          colorAdvice,
          xiColors,
          // 全部喜用色,按先后 [{wx,name,hex,weight,badge}];xiColor 仍=首选(分享卡/日历用)
          aspects,
          persona,
      ...
      function strengthHedgeOf(strength, bodyT) {
        ...
        if (strength === "\u4E2D\u548C") {
          if (at >= 0.28) {
            return t > 0 ? "\u4F60\u7565\u504F\u300C\u81EA\u7ED9\u300D\u4E00\u4FA7\uFF0C\u4F46\u4ECD\u5904\u5747\u8861\u5E26\u5185\uFF1B\u503E\u5411\u8F7B\u5FAE\uFF0C\u72EC\u7ACB\u63A8\u8FDB\u6216\u501F\u52A9\u5916\u529B\u7686\u5B9C\uFF0C\u53EF\u89C6\u60C5\u51B5\u7075\u6D3B\u53D6\u820D\u3002" : "\u4F60\u7565\u504F\u300C\u5B9C\u52A9\u529B\u300D\u4E00\u4FA7\uFF0C\u4F46\u4ECD\u5904\u5747\u8861\u5E26\u5185\uFF1B\u503E\u5411\u8F7B\u5FAE\uFF0C\u501F\u52A9\u5916\u529B\u6216\u72EC\u7ACB\u63A8\u8FDB\u7686\u5B9C\uFF0C\u53EF\u89C6\u60C5\u51B5\u7075\u6D3B\u53D6\u820D\u3002";
          }
          return "";
        }
        if ((strength === "\u504F\u5F3A" || strength === "\u504F\u5F31") && at < 0.48) {
          return "\u4F60\u63A5\u8FD1\u300C\u5747\u8861\u300D\u8FB9\u754C\uFF0C\u8FD9\u4E00\u503E\u5411\u8F83\u4E3A\u8F7B\u5FAE\uFF1B\u4EE5\u4E0B\u5EFA\u8BAE\u53EF\u4F5C\u4E3B\u8981\u53C2\u8003\uFF0C\u4E0D\u5FC5\u62D8\u6CE5\uFF0C\u53EF\u7ED3\u5408\u5B9E\u9645\u7075\u6D3B\u8C03\u6574\u3002";
        }
        return "";
      }
      var MONEY_BY_GOD = {
        ...
        "\u987A|M": {
          ...
          \u98DF: "\u4F60\u5BF9\u94B1\u4E0E\u673A\u4F1A\u654F\u9510\uFF0C\u6765\u94B1\u65B9\u5F0F\u7075\u6D3B\uFF1B\u628A\u96F6\u6563\u7684\u673A\u4F1A\u6536\u62E2\u6210\u4E00\u6761\u7EBF\u3002",
          \u4F24: "\u4F60\u5BF9\u94B1\u654F\u9510\uFF0C\u4E5F\u6562\u5F00\u53E3\u8C08\u4EF7\uFF1B\u8BDD\u8BF4\u6EE1\u4E4B\u524D\u5148\u7559\u4E00\u624B\u3002",
          \u5B98: "\u4F60\u5BF9\u94B1\u770B\u5F97\u7A33\uFF0C\u8FDB\u9000\u6709\u5EA6\uFF1B\u8BE5\u8C08\u7684\u4EF7\u5927\u65B9\u8C08\uFF0C\u4E0D\u5FC5\u66FF\u5BF9\u65B9\u7701\u3002",
          \u6BD4: "\u4F60\u5BF9\u94B1\u4E0D\u5C0F\u6C14\uFF0C\u670B\u53CB\u7684\u4E8B\u5E38\u63BA\u4E00\u811A\uFF1B\u91CF\u529B\u800C\u884C\uFF0C\u501F\u51FA\u524D\u5148\u60F3\u6E05\u695A\u3002"
        },
        "\u987A|W": {
          \u5370: "\u4F60\u8D22\u8DEF\u4E0D\u7A84\uFF0C\u591A\u5F97\u957F\u8F88\u8D35\u4EBA\u5E2E\u886C\uFF1B\u522B\u628A\u300C\u6709\u4EBA\u5E2E\u300D\u5F53\u6210\u5E38\u6001\uFF0C\u81EA\u5DF1\u4E5F\u8981\u6709\u4E00\u6761\u8DEF\u3002",
          \u98DF: "\u4F60\u9760\u672C\u4E8B\u6323\u94B1\u6700\u987A\uFF0C\u4F5C\u54C1\u3001\u624B\u827A\u90FD\u80FD\u53D8\u73B0\uFF1B\u522B\u6025\u7740\u94FA\u5927\uFF0C\u5148\u505A\u719F\u4E00\u95E8\u3002",
          \u4F24: "\u4F60\u9760\u4E00\u6280\u4E4B\u957F\u6765\u94B1\uFF0C\u8D8A\u4E13\u8D8A\u503C\u94B1\uFF1B\u522B\u88AB\u77ED\u5E73\u5FEB\u7684\u673A\u4F1A\u5E26\u504F\u3002",
          \u5B98: "\u4F60\u9002\u5408\u5728\u6709\u89C4\u77E9\u7684\u5730\u65B9\u6323\u94B1\uFF0C\u5E73\u53F0\u8D8A\u6B63\u8D8A\u987A\uFF1B\u522B\u5355\u5E72\u786C\u95EF\u3002",
          \u6BD4: "\u4F60\u5408\u4F19\u3001\u7ED3\u4F34\u65F6\u94B1\u8DEF\u66F4\u5BBD\uFF1B\u8D26\u76EE\u767D\u7EB8\u9ED1\u5B57\uFF0C\u6BD4\u8BB2\u4E49\u6C14\u66F4\u957F\u4E45\u3002"
        },
        "\u614E|S": {
          \u5370: "\u4F60\u624B\u9762\u5927\u65B9\u3001\u5FC3\u8F6F\u5FF5\u65E7\uFF0C\u94B1\u5E38\u82B1\u5728\u522B\u4EBA\u8EAB\u4E0A\uFF1B\u5148\u7ED9\u81EA\u5DF1\u7559\u4E00\u4EFD\u3002",
          \u98DF: "\u4F60\u82B1\u94B1\u968F\u6027\uFF0C\u559C\u6B22\u7684\u5C31\u60F3\u8981\uFF1B\u8BBE\u4E00\u4E2A\u6BCF\u6708\u7684\u4E0A\u9650\uFF0C\u5269\u4E0B\u7684\u81EA\u52A8\u5B58\u8D77\u6765\u3002",
          \u4F24: "\u4F60\u82B1\u94B1\u770B\u5FC3\u60C5\uFF0C\u51B2\u52A8\u65F6\u6700\u5BB9\u6613\u7834\u53E3\uFF1B\u5927\u989D\u9694\u4E00\u5929\u518D\u51B3\u5B9A\u3002",
          \u5B98: "\u4F60\u82B1\u94B1\u8BB2\u4F53\u9762\uFF0C\u6491\u573A\u9762\u7684\u5F00\u9500\u4E0D\u5C0F\uFF1B\u8BE5\u7701\u7684\u573A\u5408\u5927\u65B9\u7701\u3002",
          \u6BD4: "\u4F60\u94B1\u4E0A\u8BB2\u4E49\u6C14\uFF0C\u66FF\u4EBA\u57AB\u3001\u66FF\u4EBA\u62C5\u4FDD\u6700\u4F24\uFF1B\u8FD9\u4E24\u6837\u5148\u505C\u6389\u3002"
        },
        "\u614E|M": {
          \u5370: "\u4F60\u5FC3\u8F6F\u5FF5\u60C5\u3001\u4E50\u610F\u642D\u624B\uFF1B\u6309\u89C4\u77E9\u7406\u8D22\uFF0C\u5C11\u4F5C\u62C5\u4FDD\u3002",
          \u98DF: "\u4F60\u624B\u677E\u3001\u5BF9\u81EA\u5DF1\u597D\uFF0C\u94B1\u4E0D\u77E5\u4E0D\u89C9\u5C31\u8D70\u4E86\uFF1B\u8BB0\u4E09\u4E2A\u6708\u8D26\uFF0C\u6F0F\u5728\u54EA\u4E00\u773C\u5C31\u770B\u89C1\u3002",
          \u4F24: "\u4F60\u94B1\u8FDB\u5F97\u6765\u4E5F\u8D70\u5F97\u5FEB\uFF0C\u8D4C\u4E00\u628A\u7684\u5FF5\u5934\u8981\u538B\u4F4F\uFF1B\u672C\u91D1\u4E0D\u78B0\u3002",
          \u5B98: "\u4F60\u4E3A\u4E86\u4F53\u9762\u548C\u8D23\u4EFB\u82B1\u7684\u94B1\u4E0D\u5C11\uFF1B\u8BE5\u62D2\u7EDD\u7684\u9080\u7EA6\u5B66\u4F1A\u62D2\u7EDD\u3002",
          \u6BD4: "\u4F60\u94B1\u4E0A\u5BB9\u6613\u88AB\u4EBA\u60C5\u7275\u8D70\uFF1A\u501F\u51FA\u3001\u5408\u4F19\u3001\u57AB\u4ED8\uFF1B\u5148\u7ACB\u89C4\u77E9\u518D\u8C08\u611F\u60C5\u3002"
        },
        "\u614E|W": {
          \u5370: "\u4F60\u5B88\u4E0D\u4F4F\u94B1\uFF0C\u5927\u534A\u662F\u56E0\u4E3A\u5BF9\u4EBA\u5FC3\u8F6F\uFF1B\u5E2E\u4EBA\u6709\u5EA6\uFF0C\u5148\u987E\u81EA\u5DF1\u3002",
          \u98DF: "\u4F60\u94B1\u4E0A\u6CA1\u4EC0\u4E48\u7B97\u8BA1\uFF0C\u82B1\u5F97\u8212\u670D\u4E5F\u6F0F\u5F97\u5FEB\uFF1B\u5F3A\u5236\u50A8\u84C4\u6BD4\u7701\u7740\u82B1\u7BA1\u7528\u3002",
          \u4F24: "\u4F60\u94B1\u5BB9\u6613\u4E00\u9635\u4E00\u9635\u5730\u8D70\uFF0C\u6765\u8DEF\u4E0D\u6E05\u7684\u673A\u4F1A\u522B\u78B0\uFF1B\u5B88\u4F4F\u672C\u91D1\u6700\u5B9E\u5728\u3002",
          \u5B98: "\u4F60\u94B1\u82B1\u5728\u300C\u5E94\u8BE5\u300D\u4E0A\u7684\u592A\u591A\uFF1B\u6709\u4E9B\u573A\u9762\u4E0D\u6491\u4E5F\u6CA1\u4E8B\u3002",
          \u6BD4: "\u4F60\u94B1\u6700\u5BB9\u6613\u7834\u5728\u4EBA\u60C5\u4E0A\uFF1A\u501F\u51FA\u4E0E\u62C5\u4FDD\uFF0C\u4E00\u5F8B\u5148\u8FC7\u4E00\u665A\u3002"
        }
      };
      var STUDY_BY_GOD = {
        "\u987A|S": {
      ...
      function buildAspects(mj, dayWx, persona, expressive) {
        ...
        const xi = mj.xiYong || [];
        const ji = mj.jiShen || [];
        const has = (arr, wx) => arr.includes(wx);
        const tone = (wx) => has(xi, wx) ? "\u987A" : has(ji, wx) ? "\u614E" : "\u5E73";
        const strong = mj.strength === "\u8EAB\u5F3A" || mj.strength === "\u504F\u5F3A";
        const weak = mj.strength === "\u8EAB\u5F31" || mj.strength === "\u504F\u5F31";
        const take = (arr, n) => (arr || []).slice(0, n);
        const act = (wx, t) => {
          const g = GOD_LIFE[tenGodType(dayWx, wx)] || {};
          return {
            dos: t === "\u987A" ? take(g.doHi, 3) : t === "\u614E" ? take(g.rest, 3) : take(g.doMid, 3),
            avoid: take(g.avoid, 2)
          };
        };
        const yinWx = SHENG_ME[dayWx];
        const guanWx = KE_ME[dayWx];
        const caiWx = ME_KE[dayWx];
        const shiWx = ME_SHENG[dayWx];
        const sb = strong ? "S" : weak || mj.strength === "\u4ECE\u5F31" ? "W" : "M";
        const CORE = {
          study: {
            ...
            \u614E: {
              ...
              M: "\u4F60\u5B66\u4E60\u4E25\u8C28\u3001\u60F3\u5F97\u5468\u5168\uFF1B\u591A\u7EC3\u4E60\u3001\u5C11\u7A7A\u8BFB\u3002",
              W: "\u4F60\u5B66\u4E60\u7A33\u91CD\u3001\u4E60\u60EF\u5907\u8DB3\u518D\u52A8\uFF1B\u5B9A\u4E2A\u671F\u9650\u66F4\u5229\u63A8\u8FDB\u3002"
            },
            \u5E73: {
              S: "\u4F60\u5B66\u4E60\u9760\u79EF\u7D2F\u3001\u8010\u529B\u8DB3\uFF0C\u540E\u52B2\u957F\uFF0C\u8D35\u5728\u575A\u6301\u3002",
              M: "\u4F60\u5B66\u4E60\u7EC6\u6C34\u957F\u6D41\u3001\u7A33\u624E\u7A33\u6253\uFF0C\u56FA\u5B9A\u65F6\u6BB5\u63A8\u8FDB\u6700\u7A33\u3002",
              W: "\u4F60\u5B66\u4E60\u7A33\u6B65\u6E10\u8FDB\uFF0C\u7ED3\u4F34\u540C\u5B66\u66F4\u89C1\u6548\u7387\u3002"
            }
          },
          money: {
            ...
            \u614E: {
              ...
              S: "\u4F60\u624B\u9762\u5927\u65B9\u3001\u820D\u5F97\u82B1\uFF1B\u5927\u989D\u652F\u51FA\u7A0D\u52A0\u8282\u5236\u3002",
              M: "\u4F60\u91CD\u60C5\u4E49\u3001\u4E3A\u4EBA\u6177\u6168\uFF1B\u51CF\u5C11\u51B2\u52A8\u6D88\u8D39\u5373\u53EF\u3002",
              W: "\u4F60\u5FC3\u8F6F\u5FF5\u60C5\u3001\u4E50\u610F\u642D\u624B\uFF1B\u6309\u89C4\u77E9\u7406\u8D22\uFF0C\u5C11\u4F5C\u62C5\u4FDD\u3002"
            },
            \u5E73: {
              // 收支平稳:稳中有积
              S: "\u4F60\u6536\u652F\u5E73\u7A33\u3001\u81EA\u6709\u8FDB\u9879\uFF0C\u6512\u5F97\u4F4F\uFF1B\u8D22\u9760\u79EF\u7D2F\u3002",
              M: "\u4F60\u6536\u652F\u5E73\u7A33\u3001\u5FC3\u6001\u4ECE\u5BB9\uFF0C\u5148\u5B58\u540E\u82B1\u5373\u53EF\u3002",
              W: "\u4F60\u6536\u652F\u5E73\u7A33\u3001\u7A33\u4E2D\u6C42\u8FDB\uFF0C\u9760\u65F6\u95F4\u4E0E\u590D\u5229\u79EF\u7D2F\u3002"
            }
          }
        };
        const ADVICE = {
          ...
          money: {
            ...
            M: ["\u7528\u5148\u5B58\u540E\u82B1\u4EE3\u66FF\u5148\u82B1\u540E\u5B58\uFF1A\u5DE5\u8D44\u4E00\u5230\u624B\uFF0C\u5148\u5212\u8D70\u56FA\u5B9A\u4E00\u7B14\u5B58\u8D77\u6765\uFF0C\u96F7\u6253\u4E0D\u52A8\u3002", "\u8BA4\u771F\u8BB0\u4E09\u4E2A\u6708\u8D26\uFF0C\u4F60\u4F1A\u770B\u6E05\u94B1\u5230\u5E95\u6F0F\u5728\u54EA\u91CC\uFF1B\u5835\u4F4F\u90A3\u51E0\u4E2A\u6F0F\u6D1E\uFF0C\u5F80\u5F80\u6BD4\u591A\u6323\u4E00\u4E9B\u8FD8\u5B9E\u5728\u3002"],
            W: ["\u94B1\u4E0A\u4EE5\u7A33\u4E3A\u4E3B\uFF1A\u5B88\u597D\u672C\u91D1\u3001\u4E0D\u78B0\u770B\u4E0D\u61C2\u7684\u6295\u8D44\uFF0C\u4F60\u53CD\u800C\u66F4\u6512\u5F97\u4E0B\u6765\u3002", "\u5927\u989D\u652F\u51FA\u548C\u66FF\u4EBA\u62C5\u4FDD\uFF0C\u5148\u8FC7\u4E00\u665A\u518D\u51B3\u5B9A\uFF1B\u522B\u4EBA\u7684\u6025\uFF0C\u4E0D\u5FC5\u7528\u4F60\u7684\u94B1\u53BB\u63A5\u3002"]
          },
          career: {
          ...
          mood: {
            ...
            \u98DF: ["\u4F60\u7684\u6D6A\u6F2B\u548C\u8868\u8FBE\u662F\u5929\u8D4B\uFF0C\u4F46\u957F\u4E45\u9760\u7684\u4E0D\u662F\u4E00\u76F4\u4FDD\u6301\u70ED\u5EA6\uFF0C\u800C\u662F\u70ED\u60C5\u8FC7\u540E\u8FD8\u613F\u610F\u7559\u4E0B\u6765\uFF0C\u966A\u5BF9\u65B9\u8FC7\u5E73\u6DE1\u65E5\u5B50\u3002", "\u4F60\u6015\u95F7\u3001\u6015\u88AB\u675F\u7F1A\uFF0C\u4F46\u771F\u6B63\u7684\u81EA\u7531\u662F\u9047\u5230\u4E00\u4E2A\u8BA9\u4F60\u7518\u613F\u6536\u5FC3\u7684\u4EBA\uFF1B\u90A3\u4E0D\u662F\u5931\u53BB\u81EA\u7531\uFF0C\u800C\u662F\u627E\u5230\u5F52\u5C5E\u3002"],
            \u8D22: ["\u4F60\u4F1A\u628A\u751F\u6D3B\u6253\u7406\u5F97\u59A5\u5E16\uFF0C\u662F\u5F88\u8E0F\u5B9E\u7684\u4F34\u4FA3\uFF1B\u4F46\u611F\u60C5\u4E0D\u53EA\u8981\u88AB\u7ECF\u8425\u597D\uFF0C\u4E5F\u8981\u88AB\u611F\u53D7\u5230\uFF0C\u7559\u4E00\u4E9B\u4E0D\u8C08\u6B63\u4E8B\u7684\u65F6\u95F4\u3002", "\u4F60\u4E60\u60EF\u7528\u300C\u505A\u4E86\u591A\u5C11\u300D\u8BC1\u660E\u7231\uFF0C\u4F46\u5BF9\u65B9\u66F4\u60F3\u542C\u4F60\u300C\u8BF4\u4E86\u4EC0\u4E48\u300D\uFF1B\u4E00\u53E5\u8D70\u5FC3\u7684\u8BDD\uFF0C\u6709\u65F6\u80DC\u8FC7\u5341\u4EF6\u5B9E\u4E8B\u3002"],
            \u5B98: ["\u4F60\u8BA4\u771F\u3001\u53EF\u9760\uFF0C\u4F46\u5BF9\u5F7C\u6B64\u8981\u6C42\u592A\u9AD8\u4F1A\u8BA9\u4EBA\u5598\u4E0D\u8FC7\u6C14\uFF1B\u5728\u611F\u60C5\u91CC\uFF0C\u653E\u677E\u6BD4\u5904\u5904\u5230\u4F4D\u66F4\u8BA9\u4EBA\u5B89\u5FC3\u3002", "\u4F60\u628A\u300C\u8D1F\u8D23\u300D\u770B\u5F97\u5F88\u91CD\uFF0C\u4F46\u6700\u52A8\u4EBA\u7684\u5F80\u5F80\u4E0D\u662F\u4F60\u591A\u53EF\u9760\uFF0C\u800C\u662F\u4F60\u5076\u5C14\u5378\u4E0B\u9632\u5907\u3001\u9732\u51FA\u771F\u6027\u60C5\u7684\u90A3\u4E00\u523B\u3002"],
            \u5747\u8861: ["\u4F60\u4EC0\u4E48\u90FD\u987E\u5F97\u5230\uFF0C\u5374\u5E38\u5FD8\u4E86\u300C\u88AB\u7167\u987E\u300D\u4E5F\u662F\u4E00\u79CD\u4EB2\u5BC6\uFF1B\u5076\u5C14\u793A\u5F31\uFF0C\u662F\u7ED9\u5BF9\u65B9\u7559\u51FA\u7167\u987E\u4F60\u7684\u7A7A\u95F4\u3002", "\u522B\u7528\u300C\u6211\u6CA1\u4E8B\u300D\u7EF4\u6301\u4F53\u9762\uFF0C\u771F\u6B63\u7684\u9760\u8FD1\uFF0C\u59CB\u4E8E\u4F60\u613F\u610F\u8BA9\u5BF9\u65B9\u770B\u89C1\u4F60\u7684\u4E0D\u5BB9\u6613\u3002"]
          }
        };
        const H_ADV = {
          \u6728: ["\u5341\u4E00\u70B9\u524D\u7761\uFF0C\u4E45\u5750\u6BCF\u5C0F\u65F6\u8D77\u8EAB\u8D70\u52A8\u3002", "\u5C11\u751F\u95F7\u6C14\uFF0C\u60C5\u7EEA\u6709\u51FA\u53E3\u6BD4\u538B\u7740\u597D\u3002"],
          \u706B: ["\u7761\u524D\u4E00\u5C0F\u65F6\u79BB\u5F00\u5C4F\u5E55\uFF0C\u7ED9\u5FC3\u795E\u7559\u7F13\u51B2\u3002", "\u7D27\u7EF7\u7684\u65E5\u5B50\u5B89\u6392\u4E00\u6BB5\u653E\u677E\uFF0C\u522B\u8FDE\u8F74\u8F6C\u3002"],
          \u571F: ["\u4E09\u9910\u5B9A\u65F6\uFF0C\u5C11\u751F\u51B7\uFF0C\u665A\u996D\u4E03\u5206\u9971\u3002", "\u5FC3\u4E8B\u522B\u79EF\u7740\uFF0C\u8BF4\u51FA\u6765\u6216\u5199\u4E0B\u6765\u3002"],
          \u91D1: ["\u591A\u559D\u6E29\u6C34\uFF0C\u5E72\u71E5\u5B63\u8282\u5BA4\u5185\u52A0\u6E7F\u3002", "\u6BCF\u5929\u51FA\u95E8\u900F\u6C14\uFF0C\u5C11\u5F85\u5728\u95F7\u7684\u73AF\u5883\u3002"],
          \u6C34: ["\u4FDD\u6696\uFF0C\u5C24\u5176\u8170\u8179\u4E0E\u811A\u3002", "\u7D2F\u4E86\u5C31\u505C\uFF0C\u522B\u71AC\u5230\u900F\u652F\u518D\u8865\u3002"]
        };
        const H_ADV_BASE = { \u6728: "\u56FA\u5B9A\u8FD0\u52A8\u65F6\u6BB5\uFF0C\u52A8\u8D77\u6765\u6700\u517B\u4F60\u3002", \u706B: "\u5348\u540E\u5C0F\u61A9\u5341\u5206\u949F\uFF0C\u80DC\u8FC7\u665A\u4E0A\u8865\u89C9\u3002", \u571F: "\u996D\u540E\u6563\u6B65\u5341\u5206\u949F\uFF0C\u813E\u80C3\u6700\u53D7\u7528\u3002", \u91D1: "\u6BCF\u5929\u5F00\u7A97\u901A\u98CE\uFF0C\u6DF1\u547C\u5438\u51E0\u6B21\u3002", \u6C34: "\u7761\u524D\u6CE1\u811A\uFF0C\u7761\u5F97\u6C89\u3002" };
        const list = [];
        ...
        const loveBase = pe.love || "\u611F\u60C5\u91CC\u4F60\u5206\u5F97\u6E05\u8F7B\u91CD\u3001\u4E5F\u987E\u5F97\u5468\u5230\uFF0C\u60C5\u7EEA\u548C\u73B0\u5B9E\u90FD\u7167\u5E94\u5F97\u4E0A\uFF0C\u76F8\u5904\u8BA9\u4EBA\u5B89\u5FC3\u3002";
        const vetoInward = !!expressive && (dominant === "\u5370" || dominant === "\u5747\u8861");
        list.push({
          key: "mood",
          title: "\u60C5\u611F\u65B9\u9762",
          tone: emoTone,
          dos: vetoInward ? [] : loveAct.dos.slice(),
          avoid: vetoInward ? [] : loveAct.avoid.slice(),
          // 感情按「单身/有伴侣」分叉:UI 据用户所选状态展示对应版本;未选=中性核心。桃花为纯描述。
          text: loveBase,
          textSingle: vetoInward ? loveBase : loveBase + (GOD_LOVE_SINGLE[dominant] || ""),
          textPartner: vetoInward ? loveBase : loveBase + (GOD_LOVE_PARTNER[dominant] || ""),
          taohua: pe.taohua || "",
          advice: vetoInward ? [] : (ADVICE.mood[dominant] || ADVICE.mood["\u5747\u8861"]).slice(),
          adviceSingle: vetoInward ? [] : (ADVICE_MOOD_SINGLE[dominant] || ADVICE_MOOD_SINGLE["\u5747\u8861"]).slice(),
          advicePartner: vetoInward ? [] : (ADVICE_MOOD_PARTNER[dominant] || ADVICE_MOOD_PARTNER["\u5747\u8861"]).slice()
        });
        const HEALTH_AVOID = { \u6728: "\u4E45\u5750\u4E0D\u52A8\u3001\u957F\u671F\u6EE1\u8D1F\u8377", \u706B: "\u71AC\u591C\u3001\u8FC7\u5EA6\u900F\u652F\u7CBE\u529B", \u571F: "\u601D\u8651\u8FC7\u91CD\u3001\u996E\u98DF\u65E0\u8282", \u91D1: "\u72EC\u81EA\u538B\u6291\u3001\u79CB\u71E5\u4F24\u80BA", \u6C34: "\u601D\u8651\u8017\u795E\u3001\u7761\u7720\u4E0D\u8DB3" };
        const ORG = (wx) => (WX_INFO[wx] || {}).organ || "\u8EAB\u4F53";
        const FOOD = (wx) => (WX_INFO[wx] || {}).food || "";
        const TIP = {
        ...
        const W = mj.weights || {};
        const isWeak = /弱/.test(mj.strength || "");
        const isJiW = (wx) => (mj.jiShen || []).includes(wx);
        const heavyW = (wx) => (W[wx] || 0) >= 1.6;
        const overWx = WX5.slice().sort((a, b) => (W[b] || 0) - (W[a] || 0))[0];
        ...
        list.push({
          ...
          dos: hDos,
          avoid: hAvoid,
          advice: careList.length ? [...H_ADV[careList[0]] || [], ...careList[1] ? (H_ADV[careList[1]] || []).slice(0, 1) : []] : [H_ADV_BASE[dayWx] || "\u4F5C\u606F\u89C4\u5F8B\uFF0C\u7761\u8DB3\u4E3A\u5148\u3002"]
        });
        const fav = mj.favVec || {};
        const favScore = (wx) => Math.max(28, Math.min(94, Math.round(62 + (fav[wx] || 0) * 34)));
        const ws = WX5.map((wx) => mj.weights ? Math.max(0, mj.weights[wx] || 0) : 0);
        const wsum = ws.reduce((a, b) => a + b, 0) || 1;
        const frac = ws.map((w) => w / wsum);
      ...
      function buildYearMonths(mj, chart, year, curMonth, monthAvgs) {
        ...
        const dyn = dynamicXiYong(mj, chart, year);
        const dy = dyn.dy;
        const months = [];
        for (let m = 1; m <= 12; m++) {
          const avg = monthAvgs[m - 1];
          const lun = Solar.fromYmd(year, m, 15).getLunar();
          const mZhi = lun.getMonthZhi();
          const mGan = lun.getMonthGan();
          const mWx = ZHI_WX[mZhi];
          const t = tenGodFull ? FULL_TO_TYPE[tenGodFull(chart.dayGan, mGan)] : tenGodType(dayWx, mWx);
          const god = GOD_LIFE[t] || { name: "", good: "", caution: "" };
          const events = pillarRelations(mGan, mZhi, natal, dy ? { gan: dy.gan, zhi: dy.zhi } : null);
          const { eDelta, severe, tags } = overlayRelations(events, dyn, natal, dy);
          const mFavW = favWx(dyn, mWx) + eDelta * 0.5;
          const relation = mFavW >= 0.5 ? "\u559C" : mFavW <= -0.4 ? "\u5FCC" : "\u5E73";
          months.push({
            month: m,
            avg,
            mZhi,
            ...
            domains: deriveDomains(dayWx, t, GAN_WX[mGan], tags, dyn, avg),
            _tags: tags,
            _severe: severe
          });
        }
        ...
        const sortedAvg = [...months].map((x) => x.avg).sort((a, b) => b - a);
        return {
          year,
          curMonth,
          months,
          yearVerdict: yearVerdict(monthAvgs),
          // 全年辩证判断
          highMonths: pickByLevel(months, "avg", "month", "\u9AD8", 4),
          lowMonths: pickByLevel(months, "avg", "month", "\u4F4E", 3),
          range: { min: sortedAvg[sortedAvg.length - 1], max: sortedAvg[0] }
        };
      }
      function monthVerdict(level, rel) {
        if (level === "\u9AD8") {
          return rel === "\u559C" ? "\u8FD9\u4E2A\u6708\u80FD\u91CF\u504F\u9AD8\uFF0C\u91CD\u8981\u7684\u4E8B\u9002\u5408\u5B89\u6392\u5728\u8FD9\u65F6\u529E\uFF0C\u4F46\u522B\u4E00\u6B21\u7528\u5C3D\u3002" : "\u8FD9\u4E2A\u6708\u4F60\u81EA\u5DF1\u7684\u80FD\u91CF\u504F\u9AD8\uFF0C\u60F3\u63A8\u8FDB\u7684\u4E8B\u6392\u5728\u8FD9\u6BB5\u65F6\u95F4\uFF0C\u6BD4\u4F4E\u8C37\u671F\u66F4\u7ECF\u5F97\u8D77\u53CD\u590D\u3002";
        }
        if (level === "\u4F4E") {
          return rel === "\u5FCC" ? "\u8FD9\u4E2A\u6708\u80FD\u91CF\u504F\u4F4E\uFF0C\u4E0D\u662F\u505C\u4E0B\uFF0C\u800C\u662F\u5B9C\u6536\u655B\u3002\u5148\u8C03\u517B\u6062\u590D\uFF0C\u522B\u6025\u7740\u5F00\u65B0\u5C40\u9762\u3002" : "\u8FD9\u4E2A\u6708\u5B9C\u4F11\u6574\u3002\u653E\u6162\u4E0D\u662F\u843D\u540E\uFF0C\u800C\u662F\u4E3A\u4E0B\u4E00\u9636\u6BB5\u79EF\u84C4\u7CBE\u529B\u3002";
        }
      ...
      function natalPillars(chart) {
        ...
        const arr = [
          { gan: p.year[0], zhi: p.year[1], pos: "\u5E74" },
      ...
      var GOD_DOMAIN = {
        ...
        \u5370: { key: "growth", label: "\u5B66\u4E60\u4E0E\u8D35\u4EBA" },
        \u98DF: { key: "express", label: "\u8868\u8FBE\u521B\u4F5C" },
        \u8D22: { key: "money", label: "\u94B1\u8D22" },
        \u5B98: { key: "career", label: "\u4E8B\u4E1A" }
      };
      var DOM_KIND_W = {
        \u5929\u514B\u5730\u51B2: 1.2,
        \u5C81\u8FD0\u5E76\u4E34: 1.1,
      ...
      function deriveDomains(dayWx, godType, ganWx, tags, dyn, energy) {
        ...
        let xingHai = false;
        for (const t of tags || []) {
          const kw = DOM_KIND_W[t.kind] ?? 0.5;
          add(POS_DOMAIN[t.baseTarget], t.fav * Math.abs(t.weight || 1) * kw);
      ...
      var POS_LABEL = { \u5E74: "\u5E74\u652F", \u6708: "\u6708\u4EE4", \u65E5: "\u65E5\u652F", \u65F6: "\u65F6\u652F" };
      function overlayRelations(events, dyn, natal, dy) {
        const posWx = {};
        natal.forEach((p) => {
        ...
        for (const ev of events) {
          ...
          if (ev.kind === "\u4E09\u5408" || ev.kind === "\u4E09\u4F1A" || ev.kind === "\u534A\u5408") {
            fav = favWx(dyn, ev.huaWx);
            contrib = fav * ev.weight;
          } else if (ev.kind === "\u5408") {
            fav = ev.huaWx ? favWx(dyn, ev.huaWx) : 0;
            contrib = ev.huaWx ? fav * ev.weight : -0.25;
          } else if (ev.kind === "\u51B2" || ev.kind === "\u5929\u514B\u5730\u51B2") {
            const hitFav = favWx(dyn, posWx[baseTarget]);
            fav = -hitFav;
            contrib = fav * Math.abs(ev.weight) * 0.8;
          } else if (ev.kind === "\u5C81\u8FD0\u5E76\u4E34") {
            fav = dyFav >= 0 ? 0.4 : -0.6;
            contrib = fav;
          } else {
            fav = -1;
            contrib = ev.weight * 0.5;
          }
          eDelta += contrib;
          tags.push({ ...ev, fav, baseTarget, hitWx: ev.kind.includes("\u51B2") ? posWx[baseTarget] : null });
        }
        return { eDelta, severe, tags };
      }
      var GRADE_K = 0.9;
      var GRADE_FLAT = 2.6;
      function gradeLevels(items, key) {
        const vals = items.map((it) => it[key]);
        ...
        const hiCut = mean + sd * GRADE_K, loCut = mean - sd * GRADE_K;
        items.forEach((it) => {
          const v = it[key];
          it.level = v >= hiCut ? "\u9AD8" : v <= loCut ? "\u4F4E" : "\u5E73";
        });
      }
      function pickByLevel(items, valKey, idKey, level, n) {
        const hit = items.filter((x) => x.level === level);
        hit.sort((a, b) => level === "\u9AD8" ? b[valKey] - a[valKey] : a[valKey] - b[valKey]);
        return hit.slice(0, n).map((x) => x[idKey]).sort((a, b) => a - b);
      }
      var SCORE_WEIGHTS = {
        ganFav: 1,
        // 流年天干五行顺逆系数
      ...
      function setScoreWeights(p) {
        Object.assign(SCORE_WEIGHTS, p || {});
      }
      function scoreYear(mj, chart, natal, year, W) {
        W = W || SCORE_WEIGHTS;
        const dayWx = GAN_WX[chart.dayGan];
        const lun = Solar.fromYmd(year, 6, 1).getLunar();
        const yGan = lun.getYearGan();
        const yZhi = lun.getYearZhi();
        const yGanWx = GAN_WX[yGan];
        const yZhiWx = ZHI_WX[yZhi];
        const dyn = dynamicXiYong(mj, chart, year);
        const favOf = (wx) => favWx(dyn, wx);
        const dy = dyn.dy;
        const yunFav = dy ? favOf(GAN_WX[dy.gan]) * W.yunGan + favOf(ZHI_WX[dy.zhi]) * W.yunZhi : 0;
        const events = pillarRelations(yGan, yZhi, natal, dy ? { gan: dy.gan, zhi: dy.zhi } : null);
        const { eDelta, severe, tags } = overlayRelations(events, dyn, natal, dy);
        const raw = favOf(yGanWx) * W.ganFav + favOf(yZhiWx) * W.zhiFav + yunFav + eDelta * W.relOverlay;
        const energy = Math.max(38, Math.min(92, Math.round(W.base + raw * W.scale)));
        const net = favOf(yGanWx) + favOf(yZhiWx) + eDelta * W.relNet;
        const relation = net >= 0.4 ? "\u559C" : net <= -0.4 ? "\u5FCC" : "\u5E73";
      ...
      function buildYears(mj, chart, startYear) {
        ...
        gradeLevels(years, "energy");
        years.forEach((yr) => {
          yr._dyn._relation = yr.relation;
          const g2 = liuNian2(mj, chart, yr.year, yr.ganZhi[0], yr.ganZhi[1], yr._dyn);
          yr.headline = g2.headline;
          yr.trait = g2.trait;
          yr.signals = g2.signals;
          yr.big = g2.big;
          yr.yi = g2.yi;
          yr.ji = g2.ji;
        ...
        const highYears = pickByLevel(years, "energy", "year", "\u9AD8", 4);
        const lowYears = pickByLevel(years, "energy", "year", "\u4F4E", 3);
        return {
          startYear,
          curYear: startYear,
          years,
          decadeVerdict: decadeVerdict(years.map((x) => x.energy)),
          highYears,
          lowYears
        };
      }
      ...
      var PICK_SPAN = 60;
      function buildPicker(mj, chart, today) {
        const scan = [];
        for (let i = 0; i < PICK_SPAN; i++) {
          const dt = new Date(today.year, today.month - 1, today.day + i);
          const y = dt.getFullYear(), mo = dt.getMonth() + 1, d = dt.getDate();
          const LR = liuri(mj, chart, { year: y, month: mo, day: d });
          scan.push({
            date: `${y}-${pad(mo)}-${pad(d)}`,
            md: `${mo}/${d}`,
            ...
            axis: LR.axis,
            tone: LR.tone,
            volatile: LR.volatile,
            favTypes: LR.favTypes || [],
            jiTypes: LR.jiTypes || [],
            idx: i
          });
        }
        ...
        function pick(strict, loose, reasonOf, n = 4) {
          let hits = scan.filter(strict);
          if (hits.length < 3) {
            const extra = scan.filter((x) => loose(x) && !hits.includes(x));
        ...
        if (everFav("\u5370") || everFav("\u5B98")) {
          progressive.push({
            ...
            desc: "\u5B9C\u601D\u8651\u6E05\u660E\u3001\u7B03\u5B9A\u4ECE\u5BB9\u7684\u65E5\u5B50",
            days: pick(
              (x) => x.energy >= 70 && !x.volatile && (x.favTypes.includes("\u5370") || x.favTypes.includes("\u5B98")),
        ...
        if (everFav("\u98DF") || everFav("\u5B98")) {
          progressive.push({
            ...
            desc: "\u5B9C\u8868\u8FBE\u6709\u529B\u3001\u4E34\u573A\u6E05\u9192\u7684\u65E5\u5B50",
            days: pick(
              (x) => x.energy >= 68 && !x.volatile && (x.favTypes.includes("\u98DF") || x.favTypes.includes("\u5B98")),
        ...
        const categories = [
          ...progressive,
          {
            key: "rest",
            icon: "\u25CD",
            title: "\u9759\u517B \xB7 \u590D\u76D8 \xB7 \u8C03\u6574",
            desc: "\u5B9C\u5185\u6536\u4F11\u6574\u3001\u653E\u7F13\u8282\u594F\u7684\u65E5\u5B50",
            days: (() => {
              const hits = scan.filter((x) => x.energy <= 54 || x.axis <= 38).sort((a, b) => a.energy - b.energy).slice(0, 4).sort((a, b) => a.idx - b.idx);
              return hits.map((x) => fmt(x, `\u80FD\u91CF${x.energy} \xB7 \u5B9C\u84C4\u517B\uFF0C\u4E0D\u5FC5\u52C9\u5F3A`));
            })()
          },
          {
            key: "hold",
            ...
            desc: "\u80FD\u91CF\u8D77\u4F0F\u3001\u7A33\u4E3A\u4E0A\u7684\u65E5\u5B50",
            days: (() => {
              const hits = scan.filter((x) => x.volatile || x.energy <= 44).slice(0, 5);
              return hits.map((x) => fmt(x, x.volatile ? "\u8FD9\u51E0\u5929\u8D77\u4F0F\u504F\u5927\uFF0C\u91CD\u8981\u51B3\u5B9A\u5F80\u540E\u653E" : `\u80FD\u91CF${x.energy} \xB7 \u504F\u4F4E\uFF0C\u5B9C\u5B88`));
            })()
          }
        ];
      ...
      function heroPersonaOf(mj) {
        ...
        ["\u6728", "\u706B", "\u571F", "\u91D1", "\u6C34"].forEach((x) => {
          gsum[tenGodType(dayWx, x)] += Math.max(0, w[x] || 0);
        });
        const total = gsum["\u6BD4"] + gsum["\u5370"] + gsum["\u98DF"] + gsum["\u8D22"] + gsum["\u5B98"] || 1;
        const pct = {};
        Object.keys(gsum).forEach((k) => {
      ...
      function buildReport(mj, chart, today, ctx) {
        ...
        return {
          ...
          // 进阶档:未来 3 年逐月(当年从本月起，其后两年整年)
          monthsAhead: monthAvgs3 ? monthAvgs3.map((o) => buildYearMonths(mj, chart, o.year, o.year === today.year ? today.month : 0, o.avgs)) : null
        };
      }
      module.exports = {
        buildReport,
  ...
  // engine/buildApp.js
  var require_buildApp = __commonJS({
    "engine/buildApp.js"(exports, module) {
      ...
      function pickTag(folk) {
        const main = folk.tags.find((t) => t.type !== "\u5FCC");
        if (main) {
          const cls = main.type === "\u8D66\u65E5" || main.level === 1 ? "hi" : "";
          return { name: main.name, cls, yi: sanitizeYi(main.yi, folk.wuRi), type: main.type, desc: main.desc || "" };
        }
        if (folk.wuRi) {
          const w = folk.tags.find((t) => t.type === "\u5FCC");
          return { name: "\u620A\u4E0D\u671D\u771F", cls: "plain", yi: "\u5FCC\u711A\u9999\u671D\u771F \xB7 \u53EF\u9759\u517B\u8BF5\u7ECF(\u4E0D\u711A\u9999)", type: "\u5FCC", desc: w ? w.desc : "" };
        }
        return null;
      }
      ...
      function buildApp(person, today) {
        ...
        function buildCard(d, idx) {
          const LR = liuri(mj, chart, d);
          const folk = folkOf(d.year, d.month, d.day);
          const date = new Date(d.year, d.month - 1, d.day);
          const solar = Solar.fromYmd(d.year, d.month, d.day);
          const nextJq = solar.getLunar().getNextJieQi(true);
          const tag = pickTag(folk);
          const navLabel = idx === 0 ? "\u4ECA\u5929" : idx === 1 ? "\u660E\u5929" : idx === 2 ? "\u540E\u5929" : `${d.month}/${d.day}`;
          return {
            navLabel,
            weekday: "\u5468" + WEEK[date.getDay()],
            dateText: `${d.month}\u6708${d.day}\u65E5`,
            ...
            detail: LR.detail,
            fortune: LR.fortune,
            plNote: LR.note || (LR.axis > 60 ? "\u72B6\u6001\u4E0A\u884C\uFF0C\u5B9C\u63A8\u8FDB\u6401\u7F6E\u51B3\u5B9A\u3001\u4E3B\u52A8\u5F00\u53E3\u3002" : LR.axis < 40 ? "\u52B2\u5934\u504F\u5F31\uFF0C\u5B9C\u677E\u5F26\u7F13\u529E\uFF0C\u5FCC\u8D76\u3002" : "\u52BF\u5934\u5E73\u7F13\uFF0C\u9010\u4EF6\u63A8\u8FDB\u3002"),
            xiColor: mj.xiColor,
            xiColorNote: `\u7A7F\u6234\u6216\u968F\u8EAB\u4E00\u70B9${mj.xiColor.name}\uFF0C\u5B89\u795E\u805A\u6C14\u3001\u5229\u6C9F\u901A`,
            yi: LR.yi,
            huan: LR.huan,
            folkLine: tag ? { name: tag.name, yi: tag.yi, desc: tag.desc } : null,
        ...
        const rhythm = {
          ...
          highDays: highList,
          goodThreshold: GOOD,
          yearMonths: yr.months.map((m) => m.avg),
          bestMonth: yr.bestMonth,
          bestMonths: [...yr.months].sort((a, b) => b.avg - a.avg).slice(0, 2).map((m) => m.month).sort((a, b) => a - b)
        };
        function yearEnergy(yGan, yZhi, Y) {
          ...
          if (dy) {
            add(GAN_WX[dy.gan], 0.5);
            ZHI_HIDE[dy.zhi].forEach((g, i) => add(GAN_WX[g], i === 0 ? 0.6 : i === 1 ? 0.25 : 0.1));
          }
          add(GAN_WX[yGan], 1);
          ZHI_HIDE[yZhi].forEach((g, i) => add(GAN_WX[g], i === 0 ? 1 : i === 1 ? 0.4 : 0.2));
          return Math.max(32, Math.min(100, Math.round(58 + raw * 6)));
        }
        const LIFE_SPAN = 100;
        const lifeItems = [];
        for (let age = 0; age < LIFE_SPAN; age++) {
          const Y = person.year + age;
          const gz = Solar.fromYmd(Y, 6, 1).getLunar().getYearInGanZhi();
          lifeItems.push({ age, year: Y, gz, e: yearEnergy(gz[0], gz[1], Y) });
        }
        const decades = [];
        const dyList = chart.daYun && chart.daYun.list || [];
        let bounds;
        if (dyList.length) {
          const starts = dyList.map((d) => d.startAge).filter((a) => a > 0 && a < LIFE_SPAN);
        ...
        for (let i = 0; i < bounds.length; i++) {
          ...
          decades.push({
            from,
            to,
            avg: Math.round(seg.reduce((s, x) => s + x.e, 0) / seg.length),
            gz: dy ? dy.ganZhi : ""
            // 内部留存，暂不对外显示
          });
        }
        const life = {
          ...
          span: LIFE_SPAN,
          curAge: Math.max(0, Math.min(LIFE_SPAN - 1, today.year - person.year)),
          items: lifeItems,
          decades
        };
        return {
          ...
          report: buildReport(mj, chart, today, {
            ...
            monthAvgs3: [0, 1, 2].map((i) => {
              const Y = today.year + i;
              const yrI = i === 0 ? yr : liunian(mj, chart, Y);
              return { year: Y, avgs: yrI.months.map((m) => m.avg) };
            })
          })
        };
      }
  ...
  var require_browser = __commonJS({
    "engine/browser.js"(exports, module) {
      ...
      function energyRange(person, startY, startM, startD, days) {
        let chart, mj;
        try {
          chart = paipan(person);
          mj = analyze(chart);
        ...
        for (let i = 0; i < days; i++) {
          ...
          let e = 0;
          try {
            e = liuri(mj, chart, { year: y, month: m, day: d }).energy;
          } catch (_) {
          }
          out.push({ year: y, month: m, day: d, energy: e, good: e >= 72 });
        }
        return out;
      }
      function lunarToSolar(year, month, day, isLeap) {
        const m = isLeap ? -Math.abs(month) : month;
      ...
      function lunarMonthDays(year, month, isLeap) {
        try {
          const lm = LunarMonth.fromYm(year, isLeap ? -Math.abs(month) : month);
