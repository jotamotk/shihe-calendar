    ...
    "engine/liuri.js"(exports, module) {
      ...
      var CUE = {
        \u8D22: {
          ...
          jiLo: { tag: "\u5B88\u94B1\u5305", kw: "\u5B88\u6210\u4E3A\u5148", line: "\u8FD9\u7C7B\u65E5\u5B50\u5BB9\u6613\u4E00\u65F6\u4E0A\u5934\u4E0B\u5355\u3002\u8981\u82B1\u5927\u94B1\u7684\u4E8B\uFF0C\u7ED9\u81EA\u5DF1\u538B\u4E24\u5929\u518D\u5B9A\u3002" }
        },
        \u5B98: {
          favHi: { tag: "\u5C31\u62CD\u677F", kw: "\u4ECE\u5BB9\u7B03\u5B9A", line: "\u8FD9\u7C7B\u65E5\u5B50\u4EBA\u76F8\u5BF9\u62CE\u5F97\u6E05\uFF0C\u9002\u5408\u8C08\u4E8B\u3001\u5B9A\u4E8B\u3002" },
  ...
  var require_report = __commonJS({
    "engine/report.js"(exports, module) {
        ...
        if (level === "\u9AD8") {
          if (relation === "\u559C") {
            return {
              ...
              trait: `\u8FD9\u6BB5\u80FD\u91CF\u5F88\u8DB3\uFF0C${field}\u4E0A\u7279\u522B\u987A\u3002${pickRot(doHi, s, 2).join("\u3001")}\uFF0C\u653E\u624B\u53BB\u505A\uFF0C\u8FD9\u9635\u5B50\u4F60\u81EA\u5DF1\u4E0D\u5BB9\u6613\u534A\u9014\u5361\u4F4F\u3002`,
          ...
          return {
            ...
            trait: `\u6574\u4F53\u504F\u65FA\uFF0C\u4E5F\u6CA1\u4EC0\u4E48\u62D6\u540E\u817F\u7684\u3002\u8D81\u52BF\u628A${field}\u4E0A\u6401\u7740\u7684\u4E8B\u5F80\u524D\u63A8\uFF0C\u8D81\u8FD9\u9635\u628A\u6401\u7740\u7684\u4E8B\u5F80\u524D\u63A8\u4E00\u6B65\uFF0C\u4E3B\u52A8\u6BD4\u7B49\u7740\u66F4\u7701\u52B2\u3002`,
            yi: uniq(pickRot(doHi, s, 3), 3),
            ji: ["\u72B9\u8C6B\u9519\u8FC7\u7A97\u53E3", "\u8D2A\u591A\u7528\u5C3D"]
          };
        }
      ...
      function monthVerdict(level, rel) {
        if (level === "\u9AD8") {
          return rel === "\u559C" ? "\u65FA\u6708\u522B\u7528\u5C3D\u2014\u2014\u8981\u7D27\u4E8B\u8D76\u8FD9\u65F6\u5019\u529E\uFF0C\u7559\u4E09\u5206\u4F59\u529B\u3002" : "\u8FD9\u6BB5\u4F60\u81EA\u5DF1\u7684\u8BFB\u6570\u504F\u9AD8\u3002\u60F3\u63A8\u7684\u4E8B\u6392\u5728\u8FD9\u9635\u5B50\uFF0C\u6BD4\u4F4E\u8C37\u671F\u66F4\u625B\u5F97\u4F4F\u53CD\u590D\u3002";
        }
        if (level === "\u4F4E") {
